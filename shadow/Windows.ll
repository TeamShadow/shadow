...
%"_Pshadow_Pio_CIOException_methods" = type { %"_Pshadow_Pio_CIOException"* (%"_Pshadow_Pio_CIOException"*)*, %"_Pshadow_Pio_CIOException"* (%"_Pshadow_Pio_CIOException"*, %"_Pshadow_Pstandard_CAddressMap"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CException"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CException"*)* }
...
%"_Pshadow_Pio_CFile_methods" = type { %"_Pshadow_Pio_CFile"* (%"_Pshadow_Pio_CFile"*)*, %"_Pshadow_Pio_CFile"* (%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pstandard_CAddressMap"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pio_CFile"*)*, void (%"_Pshadow_Pio_CFile"*)*, void (%"_Pshadow_Pio_CFile"*)*, %boolean (%"_Pshadow_Pio_CFile"*)*, void (%"_Pshadow_Pio_CFile"*, %boolean)*, %"_Pshadow_Pio_CPath"* (%"_Pshadow_Pio_CFile"*)*, %long (%"_Pshadow_Pio_CFile"*)*, void (%"_Pshadow_Pio_CFile"*, %long)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })*, %long (%"_Pshadow_Pio_CFile"*)*, void (%"_Pshadow_Pio_CFile"*, %long)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* }
%"_Pshadow_Pio_CFile" = type { %"_Pshadow_Pstandard_CClass"*, %"_Pshadow_Pio_CFile_methods"* , %long, %long, %"_Pshadow_Pio_CPath"* }
%"_Pshadow_Pio_CPath_methods" = type { %"_Pshadow_Pio_CPath"* (%"_Pshadow_Pio_CPath"*)*, %"_Pshadow_Pio_CPath"* (%"_Pshadow_Pio_CPath"*, %"_Pshadow_Pstandard_CAddressMap"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pio_CPath"*)*, %code (%"_Pshadow_Pio_CPath"*)* }
