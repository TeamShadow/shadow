...
_checkArray:
	...
	; array of interfaces
_loopTestInterface:
	%i1 = phi %ulong [ %offset, %_incrementArray ], [%incremented1, %_loopBodyInterface]
	%less1 = icmp ult %ulong %i1, %end
	br i1 %less1, label %_loopBodyInterface, label %_done
_loopBodyInterface:
	%elementRef1 = getelementptr i8, i8* %newArrayAsChar, %ulong %i1
	...
	%incremented1 = add %ulong %i1, %width
	br label %_loopTestInterface
	
	; array of arrays
_loopTestArray:
	%i2 = phi %ulong [ %offset, %_checkArray ], [%incremented2, %_loopBodyArray]
	%less2 = icmp ult %ulong %i2, %end
...
_loopBodyArray:
	...
	; array of objects
_loopTestObj:
	%i3 = phi %ulong [ %offset, %_checkArray ], [%incremented3, %_loopBodyObj]
	%less3 = icmp ult %ulong %i3, %end
	br i1 %less3, label %_loopBodyObj, label %_done
_loopBodyObj:
	%elementRef3 = getelementptr i8, i8* %newArrayAsChar, %ulong %i3
	...
	%incremented3 = add %ulong %i3, %width
