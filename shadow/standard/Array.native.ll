...
%"shadow:standard@Array:_methods" = type { %"shadow:standard@Array"* (%"shadow:standard@Array"*, %"shadow:standard@AddressMap"*)*, %"shadow:standard@Class"* (%"shadow:standard@Object"*)*, %"shadow:standard@String"* (%"shadow:standard@Array"*)*, %int (%"shadow:standard@Array"*)*, %"shadow:standard@Class"* (%"shadow:standard@Array"*)*, %"shadow:standard@Object"* (%"shadow:standard@Array"*, { %int*, [1 x %int] })*, void (%"shadow:standard@Array"*, { %int*, [1 x %int] }, %"shadow:standard@Object"*)*, %"shadow:standard@Object"* (%"shadow:standard@Array"*, %int)*, void (%"shadow:standard@Array"*, %int, %"shadow:standard@Object"*)*, { %"shadow:standard@Iterator:_methods"*, %"shadow:standard@Object"* } (%"shadow:standard@Array"*)*, { %int*, [1 x %int] } (%"shadow:standard@Array"*)*, %int (%"shadow:standard@Array"*)*, %"shadow:standard@Array"* (%"shadow:standard@Array"*, %int, %int)* }
%"shadow:standard@Array" = type { %"shadow:standard@Class"*, %"shadow:standard@Array:_methods"* , %"shadow:standard@Object"*, { %int*, [1 x %int] } }
%"shadow:standard@ArrayNullable:_methods" = type { %"shadow:standard@ArrayNullable"* (%"shadow:standard@ArrayNullable"*, %"shadow:standard@AddressMap"*)*, %"shadow:standard@Class"* (%"shadow:standard@Object"*)*, %"shadow:standard@String"* (%"shadow:standard@ArrayNullable"*)*, %int (%"shadow:standard@ArrayNullable"*)*, %"shadow:standard@Class"* (%"shadow:standard@ArrayNullable"*)*, %"shadow:standard@Object"* (%"shadow:standard@ArrayNullable"*, { %int*, [1 x %int] })*, void (%"shadow:standard@ArrayNullable"*, { %int*, [1 x %int] }, %"shadow:standard@Object"*)*, %"shadow:standard@Object"* (%"shadow:standard@ArrayNullable"*, %int)*, void (%"shadow:standard@ArrayNullable"*, %int, %"shadow:standard@Object"*)*, { %"shadow:standard@IteratorNullable:_methods"*, %"shadow:standard@Object"* } (%"shadow:standard@ArrayNullable"*)*, { %int*, [1 x %int] } (%"shadow:standard@ArrayNullable"*)*, %int (%"shadow:standard@ArrayNullable"*)*, %"shadow:standard@Array"* (%"shadow:standard@ArrayNullable"*, %int, %int)* }
%"shadow:standard@ArrayNullable" = type { %"shadow:standard@Class"*, %"shadow:standard@ArrayNullable:_methods"* , %"shadow:standard@Object"*, { %int*, [1 x %int] } }
%"shadow:standard@IteratorNullable:_methods" = type { %boolean (%"shadow:standard@Object"*)*, %"shadow:standard@Object"* (%"shadow:standard@Object"*)* }
...
@"shadow:standard@ArrayNullable:class" = external constant %"shadow:standard@Class"
@"shadow:standard@ArrayNullable:_methods" = external constant %"shadow:standard@ArrayNullable:_methods"

declare %"shadow:standard@Array"* @"shadow:standard@Array.create(int[],shadow:standard@Object)"(%"shadow:standard@Object"* returned, { %int*, [1 x %int] }, %"shadow:standard@Object"*)
declare %int @"shadow:standard@Array.size()"(%"shadow:standard@Array"*)
...
declare %"shadow:standard@GenericClass"* @"shadow:standard@ClassSet.getGenericArray(shadow:standard@String,shadow:standard@Object[],boolean)"(%"shadow:standard@ClassSet"*, %"shadow:standard@String"*, { %"shadow:standard@Object"**, [1 x %int] }, %boolean)
declare %"shadow:standard@String"* @"shadow:standard@Class.makeName(shadow:standard@String,shadow:standard@Object[],int,int)"(%"shadow:standard@Class"*, %"shadow:standard@String"*, { %"shadow:standard@Object"**, [1 x %int] }, %int, %int)

@_genericSet = external global %"shadow:standard@ClassSet"*

; aliases used by ArrayNullable
@"shadow:standard@ArrayNullable.create(int[])" = alias %"shadow:standard@Array"* (%"shadow:standard@Object"*, { %int*, [1 x %int] })* @"shadow:standard@Array.create(int[])"
@"shadow:standard@ArrayNullable.dimensions()" = alias %int (%"shadow:standard@Array"*)* @"shadow:standard@Array.dimensions()"
@"shadow:standard@ArrayNullable.subarray(int,int)" = alias %"shadow:standard@Array"* (%"shadow:standard@Array"*, %int, %int)* @"shadow:standard@Array.subarray(int,int)"
@"shadow:standard@ArrayNullable.index(int[],shadow:standard@Object)" = alias void (%"shadow:standard@Array"*, { %int*, [1 x %int] }, %"shadow:standard@Object"*)* @"shadow:standard@Array.index(int[],shadow:standard@Object)"
@"shadow:standard@ArrayNullable.index(int,shadow:standard@Object)" = alias void (%"shadow:standard@Array"*, %int, %"shadow:standard@Object"*)* @"shadow:standard@Array.index(int,shadow:standard@Object)"
@"shadow:standard@ArrayNullable.getBaseClass()" = alias %"shadow:standard@Class"* (%"shadow:standard@Array"*)* @"shadow:standard@Array.getBaseClass()"
...
define i32 @__computeIndex(%"shadow:standard@Array"*, { i32*, [1 x i32] }) alwaysinline {	
	...
	ret i32 %33
throw:
	%ex.obj = call %"shadow:standard@Object"* @"shadow:standard@Class.allocate()"(%"shadow:standard@Class"* @"shadow:standard@IndexOutOfBoundsException:class", %"shadow:standard@Object:_methods"* bitcast(%"shadow:standard@IndexOutOfBoundsException:_methods"* @"shadow:standard@IndexOutOfBoundsException:_methods" to %"shadow:standard@Object:_methods"*))
...
define %"shadow:standard@Array"* @"shadow:standard@Array.create(int[])"(%"shadow:standard@Object"* returned, { %int*, [1 x %int] }) {
    ...
    %6 = call %"shadow:standard@Object"* @"shadow:standard@Object.create()"(%"shadow:standard@Object"* %5)
    ...
    %26 = call %int @"shadow:standard@Array.size()"(%"shadow:standard@Array"* %17)
	%27 = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate(int)"(%"shadow:standard@Class"* %25, i32 %26)		
...
define %"shadow:standard@Class"* @"shadow:standard@Array.getBaseClass()"(%"shadow:standard@Array"*) {
    %this = alloca %"shadow:standard@Array"*
...
define %"shadow:standard@Object"* @"shadow:standard@Array.index(int)"(%"shadow:standard@Array"*, i32 ) {
	; get array data
...
_primitive:
	...
	%methodTable = bitcast %"shadow:standard@Object"* %3 to %"shadow:standard@Object:_methods"*
	%wrapper = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate()"(%"shadow:standard@Class"* %2, %"shadow:standard@Object:_methods"* %methodTable)
	...
	%width = call %int @"shadow:standard@Class.width()"(%"shadow:standard@Class"* %2)	
...
_null:
	%nullNameRef = getelementptr inbounds %"shadow:standard@Class", %"shadow:standard@Class"* @"shadow:standard@ArrayNullable:class" , i32 0, i32 2
	%nullName = load %"shadow:standard@String"*, %"shadow:standard@String"** %nullNameRef
	%nullMethods = bitcast %"shadow:standard@ArrayNullable:_methods"* @"shadow:standard@ArrayNullable:_methods" to %"shadow:standard@Object:_methods"*
	br label %_name	
_notNull:
	%notNullNameRef = getelementptr inbounds %"shadow:standard@Class", %"shadow:standard@Class"* @"shadow:standard@Array:class" , i32 0, i32 2
	%notNullName = load %"shadow:standard@String"*, %"shadow:standard@String"** %notNullNameRef
	%notNullMethods = bitcast %"shadow:standard@Array:_methods"* @"shadow:standard@Array:_methods" to %"shadow:standard@Object:_methods"*
	br label %_name
_name:
	%arrayName = phi %"shadow:standard@String"* [ %nullName, %_null ], [ %notNullName, %_notNull ]
	%methods = phi %"shadow:standard@Object:_methods"* [%nullMethods, %_null ], [ %notNullMethods, %_notNull ]
	
	%parametersArrayAsObj = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate(int)"(%"shadow:standard@Class"* @"shadow:standard@Object:class", i32 2)
	...
	%className = call %"shadow:standard@String"* @"shadow:standard@Class.makeName(shadow:standard@String,shadow:standard@Object[],int,int)"(%"shadow:standard@Class"* %2, %"shadow:standard@String"* %arrayName, { %"shadow:standard@Object"**, [1 x i32] } %parameters, %int 0, %int 2)
	%classSet = load %"shadow:standard@ClassSet"*, %"shadow:standard@ClassSet"** @_genericSet
	%arrayClass = call %"shadow:standard@GenericClass"* @"shadow:standard@ClassSet.getGenericArray(shadow:standard@String,shadow:standard@Object[],boolean)"(%"shadow:standard@ClassSet"* %classSet, %"shadow:standard@String"* %className, { %"shadow:standard@Object"**, [1 x i32] } %parameters, %boolean %4)
	%arrayClassAsClass = bitcast %"shadow:standard@GenericClass"* %arrayClass to %"shadow:standard@Class"*
	%arrayWrapper = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate()"(%"shadow:standard@Class"* %arrayClassAsClass, %"shadow:standard@Object:_methods"* %methods)
	...
	%dimensionsArrayAsObj = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate(int)"(%"shadow:standard@Class"* @"int:class", i32 %dimensions)
	
	; get element width (which is an array)
	%arrayWidth = call %int @"shadow:standard@Class.width()"(%"shadow:standard@Class"* %2)		
	...
	%initializedArray = call %"shadow:standard@Array"* @"shadow:standard@Array.create(int[],shadow:standard@Object)"(%"shadow:standard@Object"* %arrayWrapper, { %int*, [1 x %int] } %lengthsArray2, %"shadow:standard@Object"* %arrayDataAsObj)
...
define %"shadow:standard@Object"* @"shadow:standard@Array.index(int[])"(%"shadow:standard@Array"*, { i32*, [1 x i32] }) alwaysinline {
	%3 = call i32 @__computeIndex(%"shadow:standard@Array"* %0, { i32*, [1 x i32] } %1)	
	%4 = call %"shadow:standard@Object"* @"shadow:standard@Array.index(int)"(%"shadow:standard@Array"* %0, i32 %3)
	ret %"shadow:standard@Object"* %4
}

define void @"shadow:standard@Array.index(int,shadow:standard@Object)"(%"shadow:standard@Array"*, i32, %"shadow:standard@Object"*) {
	%classRef = getelementptr inbounds %"shadow:standard@Array", %"shadow:standard@Array"* %0, i32 0, i32 0
...
_primitive:
	%primitiveWidth = call %int @"shadow:standard@Class.width()"(%"shadow:standard@Class"* %3)
...
_array:	
	...
	%arrayWidth = call %int @"shadow:standard@Class.width()"(%"shadow:standard@Class"* %3)	
	%arrayOffset = mul i32 %1, %arrayWidth	
	%arrayAsBytes2 = bitcast %"shadow:standard@Object"** %0 to i8*
...
define void @"shadow:standard@Array.index(int[],shadow:standard@Object)"(%"shadow:standard@Array"*, { i32*, [1 x i32] }, %"shadow:standard@Object"*) alwaysinline {
	%4 = call i32 @__computeIndex(%"shadow:standard@Array"* %0, { i32*, [1 x i32] } %1)	
	call void @"shadow:standard@Array.index(int,shadow:standard@Object)"(%"shadow:standard@Array"* %0, i32 %4, %"shadow:standard@Object"* %2)
	ret void
}

define noalias %"shadow:standard@Array"* @"shadow:standard@Array.subarray(int,int)"(%"shadow:standard@Array"*, i32, i32) {
	; check sizes first
	%size = call %int @"shadow:standard@Array.size()"(%"shadow:standard@Array"* %0)
...
_firstLessThanSecond:
	...
	%objMethods = bitcast %"shadow:standard@Array:_methods"* %methods to %"shadow:standard@Object:_methods"*
	
	; allocate new array object
	%arrayObj = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate()"(%"shadow:standard@Class"* %class, %"shadow:standard@Object:_methods"* %objMethods)
	...
	%dimensionsAsObj = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate(int)"(%"shadow:standard@Class"* @"int:class", i32 1)
	...
	%newArray = call noalias %"shadow:standard@Object"* @"shadow:standard@Class.allocate(int)"(%"shadow:standard@Class"* %baseClass, i32 %difference)
	%newArrayAsChar = bitcast %"shadow:standard@Object"* %newArray to i8*
	
	; get type parameter width
	%width = call %int @"shadow:standard@Class.width()"(%"shadow:standard@Class"* %baseClass)			
	...
	%initializedArray = call %"shadow:standard@Array"* @"shadow:standard@Array.create(int[],shadow:standard@Object)"(%"shadow:standard@Object"* %arrayObj, { i32*, [1 x i32] } %dimensionsArray2, %"shadow:standard@Object"* %newArray)		
...
define %int @"shadow:standard@Array.dimensions()"(%"shadow:standard@Array"*) {
