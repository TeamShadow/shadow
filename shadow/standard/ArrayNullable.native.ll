...
define %"shadow:standard@Object"* @"shadow:standard@ArrayNullable.index(int[])"(%"shadow:standard@Array"*, { i32*, [1 x i32] }) alwaysinline {
	%3 = call i32 @__computeIndex(%"shadow:standard@Array"* %0, { i32*, [1 x i32] } %1)	
	%4 = call %"shadow:standard@Object"* @"shadow:standard@ArrayNullable.index(int)"(%"shadow:standard@Array"* %0, i32 %3)
...
define %"shadow:standard@Object"* @"shadow:standard@ArrayNullable.index(int)"(%"shadow:standard@Array"*, i32 ) {
	; get array data
