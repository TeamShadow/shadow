...
define i32 @main(i32, i8**) personality i32 (...)* @__shadow_personality_v0 {	
	...
	%genericSet = call %"shadow:standard@ClassSet"* @"shadow:standard@ClassSet.create(int)"(%"shadow:standard@Object"* %uninitializedGenericSet, %int %genericSize) ; compiler replaces %genericSize
	...
	%arraySet = call %"shadow:standard@ClassSet"* @"shadow:standard@ClassSet.create(int)"(%"shadow:standard@Object"* %uninitializedArraySet, %int %arraySize) ; compiler replaces %arraySize 
	store %"shadow:standard@ClassSet"* %arraySet, %"shadow:standard@ClassSet"** @_arraySet	
	invoke void @"shadow:test@Test.main()"(%"shadow:test@Test"* %initialized)
