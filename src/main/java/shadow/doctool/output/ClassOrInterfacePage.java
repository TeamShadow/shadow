...
public class ClassOrInterfacePage extends Page {
  ...
  private final HashSet<Type> linkableTypes;
  private final Path relativePath;
  public final String qualifiedName;

  // Method categories
  private final List<MethodSignature> constructors = new ArrayList<>();
  private final List<MethodSignature> destructors = new ArrayList<>();
  private final List<MethodSignature> methods = new ArrayList<>();
  private final List<MethodSignature> properties = new ArrayList<>();

  // Public and protected constants
  private final List<Context> visibleConstants = new ArrayList<>();
  ...
  public ClassOrInterfacePage(StandardTemplate master, Type type, Collection<Type> linkableTypes)
    ...
    this.type = type;
    this.linkableTypes = new HashSet<>(linkableTypes);
    this.relativePath =
        constructOutputPath()
  ...
  private void getVisibleMethods() {
    ...
    Comparator<MethodSignature> comparator =
        Comparator.comparing(MethodSignature::getSymbol)
            .thenComparing(method -> method.getParameterTypes().toString());

    constructors.sort(comparator);
    destructors.sort(comparator);
  ...
  private void getVisibleConstants() {
    ...
    visibleConstants.sort(Comparator.comparing(Context::toString));
  }
  ...
  private void writeInnerClassSection(HtmlWriter out) throws ShadowException {
  ...
  private void writeInheritanceSection(HtmlWriter out) throws ShadowException {
    List<Type> interfaceList = new ArrayList<>(type.getInterfaces());
