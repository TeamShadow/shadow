...
/**
 * A dummy value produced when an invalid or unsupported expression is interpreted. Should
 * propagate quietly as a result of any operation that involves it - only the initial
 * expression of concern should report an error (and possibly later compilation stages).
 */
