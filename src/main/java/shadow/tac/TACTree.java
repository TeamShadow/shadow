...
public class TACTree extends TACNode
{
	...
	private TACOperand operand; //value generated by the operations in the TACTree	
	...
	*/
	...
	public TACTree done()
	{
		...
		//push the operand into the parent tree		 
		if( operand != null && children[0] != null )
			children[0].setOperand(operand);
