...
import shadow.parser.SequenceNode;
...
import shadow.parser.javacc.ASTFreezeExpression;
...
import shadow.parser.javacc.ASTInlineMethodDefinition;
import shadow.parser.javacc.ASTInlineResults;
...
import shadow.parser.javacc.ASTRightSide;
...
import shadow.parser.javacc.ASTSequenceLeftSide;
import shadow.parser.javacc.ASTSequenceRightSide;
import shadow.parser.javacc.ASTSequenceVariable;
...
import shadow.parser.javacc.ASTThrowStatement;
...
public class StatementChecker extends BaseChecker
{
	...
	*/
    ...
    public Object visit(ASTSequenceAssignment node, Boolean secondVisit) throws ShadowException
	{
		...
		{
			addError(Error.INVALID_ASSIGNMENT, "Right hand side " + (rightType) + " cannot be assigned to left hand side " + leftSequence + " because their lengths do not match");
			return WalkType.POST_CHILDREN;
		}
