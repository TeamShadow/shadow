...
public class DirectedGraph<T> implements Iterable<T> {
  ...
  protected class GraphNode {
    ...
    public final Set<GraphNode> incoming = new HashSet<>();
    public final Set<GraphNode> outgoing = new HashSet<>();
  ...
  protected Map<T, GraphNode> nodes = new HashMap<>();
  ...
  public List<T> topologicalSort() throws CycleFoundException {
     ...
     */
    HashMap<GraphNode, Integer> inDegrees = new HashMap<>();
