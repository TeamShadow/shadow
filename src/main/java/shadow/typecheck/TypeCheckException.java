...
public class TypeCheckException extends ShadowException implements Comparable<TypeCheckException> {
	...
	public enum Error implements ShadowExceptionErrorKind {
		...
		REPEATED_ASSIGNMENT("Repeated assignment", "Attribute fields may only be assigned once per attribute invocation"),
		REPEATED_ATTRIBUTE("Repeated annotation", "Multiple instances of the same attribute type cannot be applied to the same method");
