...
public final class Modifiers
{
	...
	public static final int NULLABLE      	= 0x0200;
	public static final int GET				= 0x0400;
	public static final int SET				= 0x0800;
	...
	public boolean isStatic() { return (modifiers & STATIC) != 0; }
	...
	{	
		...
		if( isStatic() && !legal.isStatic()  )
			throw new ParseException(name + " cannot be marked static");
