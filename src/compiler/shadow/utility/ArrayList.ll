...
%"_Pshadow_Pstandard_CException" = type { %"_Pshadow_Pstandard_CException_Mclass"*, { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }, %"_Pshadow_Pstandard_CClass"*, %int, %int }
%"_Pshadow_Putility_CCanHash_Mclass" = type { %int (%"_Pshadow_Pstandard_CObject"*)* }
...
%"_P_CUnexpectedNullException" = type { %"_P_CUnexpectedNullException_Mclass"*, { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }, %"_Pshadow_Pstandard_CClass"*, %int, %int }
...
%"_Pshadow_Pstandard_CObject" = type { %"_Pshadow_Pstandard_CObject_Mclass"*, { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }, %"_Pshadow_Pstandard_CClass"*, %int, %int }
...
%"_Pshadow_Putility_CArrayList_IArrayListIterator" = type { %"_Pshadow_Putility_CArrayList_IArrayListIterator_Mclass"*, { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }, %"_Pshadow_Pstandard_CClass"*, %int, %int }
...
%"_Pshadow_Pstandard_CString_IStringIterator" = type { %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"*, { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }, %"_Pshadow_Pstandard_CClass"*, %int, %int }
...
%"_Pshadow_Pstandard_CIndexOutOfBoundsException" = type { %"_Pshadow_Pstandard_CIndexOutOfBoundsException_Mclass"*, { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }, %"_Pshadow_Pstandard_CClass"*, %int, %int }
...
@_class0 = private unnamed_addr constant { { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } (%"_Pshadow_Putility_CArrayList"*)* } { { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } (%"_Pshadow_Putility_CArrayList"*)* @"_Pshadow_Putility_CArrayList_Miterator" }
@_class1 = private unnamed_addr constant { %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)*, void (%"_Pshadow_Putility_CArrayList"*, %int, %"_Pshadow_Pstandard_CObject"*)* } { %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)* @"_Pshadow_Putility_CArrayList_Mindex_Pshadow_Pstandard_Cint", void (%"_Pshadow_Putility_CArrayList"*, %int, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Mindex_Pshadow_Pstandard_Cint_CV" }
@_class2 = private unnamed_addr constant { { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } (%"_Pshadow_Putility_CArrayList"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)*, void (%"_Pshadow_Putility_CArrayList"*, %int, %"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, void (%"_Pshadow_Putility_CArrayList"*)*, %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)*, %int (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, %int (%"_Pshadow_Putility_CArrayList"*)* } { { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } (%"_Pshadow_Putility_CArrayList"*)* @"_Pshadow_Putility_CArrayList_Miterator", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)* @"_Pshadow_Putility_CArrayList_Mindex_Pshadow_Pstandard_Cint", void (%"_Pshadow_Putility_CArrayList"*, %int, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Mindex_Pshadow_Pstandard_Cint_CV", %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Madd_CV", void (%"_Pshadow_Putility_CArrayList"*)* @"_Pshadow_Putility_CArrayList_Mclear", %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Mcontains_CV", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)* @"_Pshadow_Putility_CArrayList_Mdelete_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_MindexOf_CV", %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Mremove_CV", %int (%"_Pshadow_Putility_CArrayList"*)* @"_Pshadow_Putility_CArrayList_Msize" }
@_interfaceData = private unnamed_addr constant [3 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } (%"_Pshadow_Putility_CArrayList"*)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)*, void (%"_Pshadow_Putility_CArrayList"*, %int, %"_Pshadow_Pstandard_CObject"*)* }* @_class1 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } (%"_Pshadow_Putility_CArrayList"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)*, void (%"_Pshadow_Putility_CArrayList"*, %int, %"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, void (%"_Pshadow_Putility_CArrayList"*)*, %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)*, %int (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)*, %int (%"_Pshadow_Putility_CArrayList"*)* }* @_class2 to %"_Pshadow_Pstandard_CObject"*)]
@_interfaces = private unnamed_addr constant [3 x %"_Pshadow_Pstandard_CClass"*] [%"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CCanIterate_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CCanIndex_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Putility_CList_Mclass"]
@"_Pshadow_Putility_CArrayList_Mclass" = constant %"_Pshadow_Putility_CArrayList_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([3 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 3] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([3 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 3] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Putility_CArrayList"* getelementptr (%"_Pshadow_Putility_CArrayList"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Putility_CArrayList"** getelementptr (%"_Pshadow_Putility_CArrayList"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Putility_CArrayList"* (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CClass"*)* @"_Pshadow_Putility_CArrayList_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Madd_CV", void (%"_Pshadow_Putility_CArrayList"*)* @"_Pshadow_Putility_CArrayList_Mclear", %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Mcontains_CV", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)* @"_Pshadow_Putility_CArrayList_Mdelete_Pshadow_Pstandard_Cint", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CArrayList"*, %int)* @"_Pshadow_Putility_CArrayList_Mindex_Pshadow_Pstandard_Cint", void (%"_Pshadow_Putility_CArrayList"*, %int, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Mindex_Pshadow_Pstandard_Cint_CV", %int (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_MindexOf_CV", { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } (%"_Pshadow_Putility_CArrayList"*)* @"_Pshadow_Putility_CArrayList_Miterator", %boolean (%"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Putility_CArrayList_Mremove_CV", %int (%"_Pshadow_Putility_CArrayList"*)* @"_Pshadow_Putility_CArrayList_Msize" }
...
@"_Pshadow_Putility_CCanHash_Mclass" = external constant %"_Pshadow_Pstandard_CClass"
...
define { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } @"_Pshadow_Putility_CArrayList_Miterator"(%"_Pshadow_Putility_CArrayList"*) {
    %this = alloca %"_Pshadow_Putility_CArrayList"*
    store %"_Pshadow_Putility_CArrayList"* %0, %"_Pshadow_Putility_CArrayList"** %this
    ...
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_MinterfaceData_Pshadow_Pstandard_CClass"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Putility_CArrayList_IArrayListIterator_Mclass"* @"_Pshadow_Putility_CArrayList_IArrayListIterator_Mclass", i32 0, i32 0), %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CIterator_Mclass")
    %10 = bitcast %"_Pshadow_Pstandard_CObject"* %9 to %"_Pshadow_Pstandard_CIterator_Mclass"*
    %11 = insertvalue { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } undef, %"_Pshadow_Pstandard_CIterator_Mclass"* %10, 0
    %12 = bitcast %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %3 to %"_Pshadow_Pstandard_CObject"*
    %13 = insertvalue { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } %11, %"_Pshadow_Pstandard_CObject"* %12, 1
    ret { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } %13
}
...
_label2:
    ...
    br %boolean %28, label %_label6, label %_label7
_label7:
    %29 = load %"_Pshadow_Pstandard_CObject"** %25
    ret %"_Pshadow_Pstandard_CObject"* %29
    br label %_label5
_label6:
    %31 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_P_CUnexpectedNullException_Mclass"* @"_P_CUnexpectedNullException_Mclass", i32 0, i32 0))
    %32 = bitcast %"_Pshadow_Pstandard_CObject"* %31 to %"_P_CUnexpectedNullException"*
    %33 = call %"_P_CUnexpectedNullException"* @"_P_CUnexpectedNullException_Mcreate"(%"_P_CUnexpectedNullException"* %32)
    %34 = bitcast %"_P_CUnexpectedNullException"* %32 to %"_Pshadow_Pstandard_CException"*
    %35 = getelementptr %"_Pshadow_Pstandard_CException"* %34, i32 0, i32 0
    %36 = load %"_Pshadow_Pstandard_CException_Mclass"** %35
    %37 = getelementptr %"_Pshadow_Pstandard_CException_Mclass"* %36, i32 0, i32 9
    %38 = load void (%"_Pshadow_Pstandard_CException"*)** %37
    %39 = bitcast %"_P_CUnexpectedNullException"* %32 to %"_Pshadow_Pstandard_CException"*
    call void %38(%"_Pshadow_Pstandard_CException"* %39)
    br label %_label5
_label5:
...
_label27:
    ...
    %27 = bitcast %"_Pshadow_Pstandard_CObject"* %26 to %"_Pshadow_Pstandard_CObject"*
    %28 = icmp eq %"_Pshadow_Pstandard_CObject"* %27, null
    br %boolean %28, label %_label31, label %_label32
_label32:
    %29 = load %"_Pshadow_Pstandard_CObject"** %25
    store %"_Pshadow_Pstandard_CObject"* %29, %"_Pshadow_Pstandard_CObject"** %temp
    %30 = load %int* %index
    store %int %30, %int* %i
    br label %_label34
_label33:
    %31 = load %"_Pshadow_Putility_CArrayList"** %this
    %32 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %31, i32 0, i32 1
    %33 = load %int* %i
    %34 = add %int %33, 1
    %35 = load { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }* %32
    %36 = extractvalue { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } %35, 0
    %37 = getelementptr inbounds %"_Pshadow_Pstandard_CObject"** %36, %int %34
    %38 = load %"_Pshadow_Putility_CArrayList"** %this
    %39 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %38, i32 0, i32 1
    %40 = load { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }* %39
    %41 = load %int* %i
    %42 = extractvalue { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } %40, 0
    %43 = getelementptr inbounds %"_Pshadow_Pstandard_CObject"** %42, %int %41
    %44 = load %"_Pshadow_Pstandard_CObject"** %37
    store %"_Pshadow_Pstandard_CObject"* %44, %"_Pshadow_Pstandard_CObject"** %43
    %45 = load %int* %i
    %46 = add %int %45, 1
    store %int %46, %int* %i
    br label %_label34
_label34:
    %47 = load %"_Pshadow_Putility_CArrayList"** %this
    %48 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %47, i32 0, i32 4
    %49 = load %int* %48
    %50 = sub %int %49, 1
    %51 = load %int* %i
    %52 = icmp slt %int %51, %50
    br %boolean %52, label %_label33, label %_label35
_label35:
    %53 = load %"_Pshadow_Putility_CArrayList"** %this
    %54 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %53, i32 0, i32 4
    %55 = load %int* %54
    %56 = sub %int %55, 1
    store %int %56, %int* %54
    %57 = load %"_Pshadow_Putility_CArrayList"** %this
    %58 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %57, i32 0, i32 3
    %59 = load %int* %58
    %60 = add %int %59, 1
    store %int %60, %int* %58
    %61 = load %"_Pshadow_Pstandard_CObject"** %temp
    ret %"_Pshadow_Pstandard_CObject"* %61
    br label %_label30
_label31:
    %63 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_P_CUnexpectedNullException_Mclass"* @"_P_CUnexpectedNullException_Mclass", i32 0, i32 0))
    %64 = bitcast %"_Pshadow_Pstandard_CObject"* %63 to %"_P_CUnexpectedNullException"*
    %65 = call %"_P_CUnexpectedNullException"* @"_P_CUnexpectedNullException_Mcreate"(%"_P_CUnexpectedNullException"* %64)
    %66 = bitcast %"_P_CUnexpectedNullException"* %64 to %"_Pshadow_Pstandard_CException"*
    %67 = getelementptr %"_Pshadow_Pstandard_CException"* %66, i32 0, i32 0
    %68 = load %"_Pshadow_Pstandard_CException_Mclass"** %67
    %69 = getelementptr %"_Pshadow_Pstandard_CException_Mclass"* %68, i32 0, i32 9
    %70 = load void (%"_Pshadow_Pstandard_CException"*)** %69
    %71 = bitcast %"_P_CUnexpectedNullException"* %64 to %"_Pshadow_Pstandard_CException"*
    call void %70(%"_Pshadow_Pstandard_CException"* %71)
    br label %_label30
_label30:
    ret %"_Pshadow_Pstandard_CObject"* null
}
...
_label36:
    ...
    %10 = bitcast %"_Pshadow_Pstandard_CObject"* %9 to %"_Pshadow_Pstandard_CObject"*
    %11 = icmp eq %"_Pshadow_Pstandard_CObject"* %10, null
    br %boolean %11, label %_label42, label %_label43
_label42:
    %12 = load %"_Pshadow_Pstandard_CObject"** %value
    %13 = bitcast %"_Pshadow_Pstandard_CObject"* %12 to %"_Pshadow_Pstandard_CObject"*
    %14 = icmp eq %"_Pshadow_Pstandard_CObject"* %13, null
    store %boolean %14, %boolean* %_temp
    br label %_label44
_label43:
    %15 = load %"_Pshadow_Pstandard_CObject"** %8
    %16 = bitcast %"_Pshadow_Pstandard_CObject"* %15 to %"_Pshadow_Pstandard_CObject"*
    %17 = getelementptr %"_Pshadow_Pstandard_CObject"* %16, i32 0, i32 0
    %18 = load %"_Pshadow_Pstandard_CObject_Mclass"** %17
    %19 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %18, i32 0, i32 3
    %20 = load %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)** %19
    %21 = load %"_Pshadow_Pstandard_CObject"** %8
    %22 = bitcast %"_Pshadow_Pstandard_CObject"* %21 to %"_Pshadow_Pstandard_CObject"*
    %23 = load %"_Pshadow_Pstandard_CObject"** %value
    %24 = bitcast %"_Pshadow_Pstandard_CObject"* %23 to %"_Pshadow_Pstandard_CObject"*
    %25 = call %boolean %20(%"_Pshadow_Pstandard_CObject"* %22, %"_Pshadow_Pstandard_CObject"* %24)
    store %boolean %25, %boolean* %_temp
    br label %_label44
_label44:
    %26 = load %boolean* %_temp
    br %boolean %26, label %_label39, label %_label40
_label39:
    %27 = load %int* %i
    ret %int %27
    br label %_label41
...
_label37:
    %31 = load %"_Pshadow_Putility_CArrayList"** %this
    %32 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %31, i32 0, i32 1
    %33 = load { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }* %32
    %34 = load %int* %i
    %35 = load %"_Pshadow_Putility_CArrayList"** %this
    %36 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %35, i32 0, i32 2
    %37 = load %"_Pshadow_Pstandard_CClass"** %36
    %38 = extractvalue { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } %33, 1
    %39 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int 1)
    %40 = bitcast %"_Pshadow_Pstandard_CObject"* %39 to [1 x %int]*
    store [1 x %int] %38, [1 x %int]* %40
    %41 = getelementptr inbounds [1 x %int]* %40, i32 0, i32 0
    %42 = insertvalue { %int*, [1 x %int] } { %int* null, [1 x %int] [%int 1] }, %int* %41, 0
    %43 = extractvalue { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } %33, 0
    %44 = bitcast %"_Pshadow_Pstandard_CObject"** %43 to %"_Pshadow_Pstandard_CObject"*
    %45 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CArray_Mclass"* @"_Pshadow_Pstandard_CArray_Mclass", i32 0, i32 0))
    %46 = bitcast %"_Pshadow_Pstandard_CObject"* %45 to %"_Pshadow_Pstandard_CArray"*
    %47 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CArray"* %46, %"_Pshadow_Pstandard_CClass"* %37, { %int*, [1 x %int] } %42, %"_Pshadow_Pstandard_CObject"* %44)
    %48 = getelementptr %"_Pshadow_Pstandard_CArray"* %47, i32 0, i32 0
    %49 = load %"_Pshadow_Pstandard_CArray_Mclass"** %48
    %50 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %49, i32 0, i32 13
    %51 = load %int (%"_Pshadow_Pstandard_CArray"*)** %50
    %52 = load %"_Pshadow_Putility_CArrayList"** %this
    %53 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %52, i32 0, i32 2
    %54 = load %"_Pshadow_Pstandard_CClass"** %53
    %55 = extractvalue { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } %33, 1
    %56 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int 1)
    %57 = bitcast %"_Pshadow_Pstandard_CObject"* %56 to [1 x %int]*
    store [1 x %int] %55, [1 x %int]* %57
    %58 = getelementptr inbounds [1 x %int]* %57, i32 0, i32 0
    %59 = insertvalue { %int*, [1 x %int] } { %int* null, [1 x %int] [%int 1] }, %int* %58, 0
    %60 = extractvalue { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } %33, 0
    %61 = bitcast %"_Pshadow_Pstandard_CObject"** %60 to %"_Pshadow_Pstandard_CObject"*
    %62 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CArray_Mclass"* @"_Pshadow_Pstandard_CArray_Mclass", i32 0, i32 0))
    %63 = bitcast %"_Pshadow_Pstandard_CObject"* %62 to %"_Pshadow_Pstandard_CArray"*
    %64 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CArray"* %63, %"_Pshadow_Pstandard_CClass"* %54, { %int*, [1 x %int] } %59, %"_Pshadow_Pstandard_CObject"* %61)
    %65 = call %int %51(%"_Pshadow_Pstandard_CArray"* %64)
    %66 = icmp slt %int %34, %65
    br %boolean %66, label %_label36, label %_label38
_label38:
    %67 = sub %int 0, 1
    ret %int %67
}
