...
_label1:
    br label %_label2
_label2:
    store %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CObject"** %value
    ...
    %23 = load %"_Pshadow_Putility_CLinkedList_ILinkedListIterator"** %this
    %24 = getelementptr inbounds %"_Pshadow_Putility_CLinkedList_ILinkedListIterator"* %23, i32 0, i32 1
    %25 = load %"_Pshadow_Putility_CLinkedList_INode"** %24
    %26 = load %"_Pshadow_Putility_CLinkedList_ILinkedListIterator"** %this
    %27 = getelementptr inbounds %"_Pshadow_Putility_CLinkedList_ILinkedListIterator"* %26, i32 0, i32 1
    %28 = load %"_Pshadow_Putility_CLinkedList_INode"** %27
    %29 = getelementptr %"_Pshadow_Putility_CLinkedList_INode"* %25, i32 0, i32 0
    %30 = load %"_Pshadow_Putility_CLinkedList_INode_Mclass"** %29
    %31 = getelementptr %"_Pshadow_Putility_CLinkedList_INode_Mclass"* %30, i32 0, i32 13
    %32 = load %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Putility_CLinkedList_INode"*)** %31
    %33 = call %"_Pshadow_Pstandard_CObject"* %32(%"_Pshadow_Putility_CLinkedList_INode"* %25)
    %34 = getelementptr %"_Pshadow_Putility_CLinkedList_INode"* %28, i32 0, i32 0
    %35 = load %"_Pshadow_Putility_CLinkedList_INode_Mclass"** %34
    %36 = getelementptr %"_Pshadow_Putility_CLinkedList_INode_Mclass"* %35, i32 0, i32 10
    %37 = load %"_Pshadow_Putility_CLinkedList_INode"* (%"_Pshadow_Putility_CLinkedList_INode"*)** %36
    %38 = call %"_Pshadow_Putility_CLinkedList_INode"* %37(%"_Pshadow_Putility_CLinkedList_INode"* %28)
    %39 = insertvalue { %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Putility_CLinkedList_INode"* } undef, %"_Pshadow_Pstandard_CObject"* %33, 0
    %40 = insertvalue { %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Putility_CLinkedList_INode"* } %39, %"_Pshadow_Putility_CLinkedList_INode"* %38, 1
    %41 = extractvalue { %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Putility_CLinkedList_INode"* } %40, 0
    store %"_Pshadow_Pstandard_CObject"* %41, %"_Pshadow_Pstandard_CObject"** %value
    %42 = extractvalue { %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Putility_CLinkedList_INode"* } %40, 1
    store %"_Pshadow_Putility_CLinkedList_INode"* %42, %"_Pshadow_Putility_CLinkedList_INode"** %22
    %43 = load %"_Pshadow_Pstandard_CObject"** %value
    ret %"_Pshadow_Pstandard_CObject"* %43
}
