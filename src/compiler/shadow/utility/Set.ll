...
define void @"_CSet_Mclear"(%"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pstandard_CObject"* %0, %"_Pshadow_Pstandard_CObject"** %this
    ret void
}

define %boolean @"_CSet_Mremove_CE"(%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
...
define %boolean @"_CSet_Mcontains_CE"(%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
    %element = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pstandard_CObject"* %0, %"_Pshadow_Pstandard_CObject"** %this
    store %"_Pshadow_Pstandard_CObject"* %1, %"_Pshadow_Pstandard_CObject"** %element
...
define %boolean @"_CSet_Madd_CE"(%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
    %element = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pstandard_CObject"* %0, %"_Pshadow_Pstandard_CObject"** %this
    store %"_Pshadow_Pstandard_CObject"* %1, %"_Pshadow_Pstandard_CObject"** %element
...
define %int @"_CSet_Msize"(%"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pstandard_CObject"* %0, %"_Pshadow_Pstandard_CObject"** %this
    ret %int 0
}
