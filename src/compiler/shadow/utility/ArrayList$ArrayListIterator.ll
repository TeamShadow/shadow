; shadow.utility@ArrayList:ArrayListIterator<V>
...
_label0:
    ...
    %17 = bitcast %"_Pshadow_Pstandard_CIndexOutOfBoundsException"* %14 to %"_Pshadow_Pstandard_CException"*
    call void @"_Pshadow_Pstandard_CException_Mthrow__"(%"_Pshadow_Pstandard_CException"* %17)
    br label %_label2
_label1:
    br label %_label2
_label2:
    ...
    %23 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %22, i32 0, i32 4
    %24 = load { %"_Pshadow_Pstandard_CObject"**, [1 x %int] }* %21
    %25 = load %int* %23
    %26 = extractvalue { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } %24, 0
    %27 = getelementptr inbounds %"_Pshadow_Pstandard_CObject"** %26, %int %25
    %28 = load %"_Pshadow_Pstandard_CObject"** %27
    %29 = icmp ne %"_Pshadow_Pstandard_CObject"* %28, null
    br %boolean %29, label %_label5, label %_label4
_label5:
    %30 = load %"_Pshadow_Pstandard_CObject"** %27
    store %"_Pshadow_Pstandard_CObject"* %30, %"_Pshadow_Pstandard_CObject"** %temp
    %31 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %32 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %31, i32 0, i32 4
    %33 = load %int* %32
    %34 = add %int %33, 1
    store %int %34, %int* %32
    %35 = load %"_Pshadow_Pstandard_CObject"** %temp
    ret %"_Pshadow_Pstandard_CObject"* %35
    br label %_label3
_label4:
    %37 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_P_CUnexpectedNullException_Mclass"* @"_P_CUnexpectedNullException_Mclass", i32 0, i32 0))
    %38 = bitcast %"_Pshadow_Pstandard_CObject"* %37 to %"_P_CUnexpectedNullException"*
    %39 = call %"_P_CUnexpectedNullException"* @"_P_CUnexpectedNullException_Mcreate"(%"_P_CUnexpectedNullException"* %38)
    %40 = bitcast %"_P_CUnexpectedNullException"* %38 to %"_Pshadow_Pstandard_CException"*
    %41 = bitcast %"_P_CUnexpectedNullException"* %38 to %"_Pshadow_Pstandard_CException"*
    call void @"_Pshadow_Pstandard_CException_Mthrow__"(%"_Pshadow_Pstandard_CException"* %41)
    br label %_label3
_label3:
...
define %"_Pshadow_Putility_CArrayList_IArrayListIterator"* @"_Pshadow_Putility_CArrayList_IArrayListIterator_Mcreate"(%"_Pshadow_Putility_CArrayList_IArrayListIterator"*, %"_Pshadow_Putility_CArrayList"*, %"_Pshadow_Pstandard_CClass"*) {
    ...
    %4 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %0, i32 0, i32 0
    store %"_Pshadow_Putility_CArrayList_IArrayListIterator_Mclass"* @"_Pshadow_Putility_CArrayList_IArrayListIterator_Mclass", %"_Pshadow_Putility_CArrayList_IArrayListIterator_Mclass"** %4
    store %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %0, %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    ...
    %5 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %6 = bitcast %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %5 to %"_Pshadow_Pstandard_CObject"*
    %7 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %8 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %7, i32 0, i32 2
    %9 = load %"_Pshadow_Putility_CArrayList"** %outer
    store %"_Pshadow_Putility_CArrayList"* %9, %"_Pshadow_Putility_CArrayList"** %8
    %10 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %11 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %10, i32 0, i32 1
    %12 = load %"_Pshadow_Pstandard_CClass"** %V
    store %"_Pshadow_Pstandard_CClass"* %12, %"_Pshadow_Pstandard_CClass"** %11
    %13 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %14 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %13, i32 0, i32 4
    store %int 0, %int* %14
    %15 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %16 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %15, i32 0, i32 3
    %17 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %18 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %17, i32 0, i32 2
    %19 = load %"_Pshadow_Putility_CArrayList"** %18
    %20 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %19, i32 0, i32 3
    %21 = load %int* %20
    store %int %21, %int* %16
...
define void @"_Pshadow_Putility_CArrayList_IArrayListIterator_McheckForModifications"(%"_Pshadow_Putility_CArrayList_IArrayListIterator"*) {
    ...
    store %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %0, %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %2 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %3 = bitcast %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %5 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %4, i32 0, i32 3
    %6 = load %"_Pshadow_Putility_CArrayList_IArrayListIterator"** %this
    %7 = getelementptr inbounds %"_Pshadow_Putility_CArrayList_IArrayListIterator"* %6, i32 0, i32 2
    %8 = load %"_Pshadow_Putility_CArrayList"** %7
    %9 = getelementptr inbounds %"_Pshadow_Putility_CArrayList"* %8, i32 0, i32 3
    %10 = load %int* %5
    %11 = load %int* %9
    %12 = icmp eq %int %10, %11
    %13 = xor %boolean %12, true
    br %boolean %13, label %_label6, label %_label7
_label6:
    %14 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_P_CIllegalModificationException_Mclass"* @"_P_CIllegalModificationException_Mclass", i32 0, i32 0))
    %15 = bitcast %"_Pshadow_Pstandard_CObject"* %14 to %"_P_CIllegalModificationException"*
    %16 = call %"_P_CIllegalModificationException"* @"_P_CIllegalModificationException_Mcreate"(%"_P_CIllegalModificationException"* %15)
    %17 = bitcast %"_P_CIllegalModificationException"* %15 to %"_Pshadow_Pstandard_CException"*
    %18 = bitcast %"_P_CIllegalModificationException"* %15 to %"_Pshadow_Pstandard_CException"*
    call void @"_Pshadow_Pstandard_CException_Mthrow__"(%"_Pshadow_Pstandard_CException"* %18)
    br label %_label8
_label7:
    br label %_label8
_label8:
...
@_array0 = private unnamed_addr constant [45 x %ubyte] c"shadow.utility@ArrayList:ArrayListIterator<V>"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([45 x %ubyte]* @_array0, i32 0, i32 0), [1 x %int] [%int 45] }, %boolean true }
