...
define %"_P_CIllegalModificationException"* @"_P_CIllegalModificationException_Mcreate"(%"_P_CIllegalModificationException"*) {
    ...
    %2 = getelementptr inbounds %"_P_CIllegalModificationException"* %0, i32 0, i32 0
    store %"_P_CIllegalModificationException_Mclass"* @"_P_CIllegalModificationException_Mclass", %"_P_CIllegalModificationException_Mclass"** %2
    store %"_P_CIllegalModificationException"* %0, %"_P_CIllegalModificationException"** %this
    %3 = load %"_P_CIllegalModificationException"** %this
    %4 = bitcast %"_P_CIllegalModificationException"* %3 to %"_Pshadow_Pstandard_CException"*
...
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([36 x %ubyte]* @_array0, i32 0, i32 0), [1 x %int] [%int 36] }, %boolean true }
