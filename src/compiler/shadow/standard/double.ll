...
%"_Pshadow_Pstandard_CException" = type { %"_Pshadow_Pstandard_CException_Mclass"*, %double, %double }
...
%"_Pshadow_Pstandard_CString_IStringIterator" = type { %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"*, %double, %double }
...
%"_Pshadow_Pstandard_CObject" = type { %"_Pshadow_Pstandard_CObject_Mclass"*, %double, %double }

@_class0 = private unnamed_addr constant { %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* } { %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Madd_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mdivide_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mmodulus_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mmultiply_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Msubtract_Pshadow_Pstandard_Cdouble" }
@_class1 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cdouble"*, %double)* } { %int (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mcompare_Pshadow_Pstandard_Cdouble" }
@_interfaceData = private unnamed_addr constant [2 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)*, %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cdouble"*, %double)* }* @_class1 to %"_Pshadow_Pstandard_CObject"*)]
...
@"_Pshadow_Pstandard_Cdouble_Mclass" = constant %"_Pshadow_Pstandard_Cdouble_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 2] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 2] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cdouble"* getelementptr (%"_Pshadow_Pstandard_Cdouble"* null, i32 1) to i32), %int ptrtoint (%double* getelementptr (%double* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cdouble"* (%"_Pshadow_Pstandard_Cdouble"*)* @"_Pshadow_Pstandard_Cdouble_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Madd_Pshadow_Pstandard_Cdouble", %int (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mcompare_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mdivide_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mmodulus_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Mmultiply_Pshadow_Pstandard_Cdouble", %double (%"_Pshadow_Pstandard_Cdouble"*, %double)* @"_Pshadow_Pstandard_Cdouble_Msubtract_Pshadow_Pstandard_Cdouble" }
...
define %"_Pshadow_Pstandard_Cdouble"* @"_Pshadow_Pstandard_Cdouble_Mcreate"(%"_Pshadow_Pstandard_Cdouble"*) {
    %this = alloca %double
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cdouble"* %0, i32 0, i32 1
    %3 = load %double* %2
    store %double %3, %double* %this
    %4 = load %double* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cdouble_Mclass"* @"_Pshadow_Pstandard_Cdouble_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cdouble"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cdouble"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cdouble_Mclass"* @"_Pshadow_Pstandard_Cdouble_Mclass", %"_Pshadow_Pstandard_Cdouble_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cdouble"* %6, i32 0, i32 1
    store %double %4, %double* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cdouble"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cdouble_Mclass"* @"_Pshadow_Pstandard_Cdouble_Mclass", %"_Pshadow_Pstandard_Cdouble_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cdouble"* %0
}
...
@_array0 = private unnamed_addr constant [6 x %ubyte] c"double"
