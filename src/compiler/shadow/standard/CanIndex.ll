...
@"_Pshadow_Pstandard_CCanIndex_Mclass" = constant %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } zeroinitializer, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 1] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* null, %int 1, %int -1, %int ptrtoint ({ %"_Pshadow_Pstandard_CCanIndex_Mclass"*, %"_Pshadow_Pstandard_CObject"* }* getelementptr ({ %"_Pshadow_Pstandard_CCanIndex_Mclass"*, %"_Pshadow_Pstandard_CObject"* }* null, i32 1) to i32) }
...
@_array0 = private unnamed_addr constant [30 x %ubyte] c"shadow.standard@CanIndex<K, V>"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([30 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 30] }, %boolean true }
