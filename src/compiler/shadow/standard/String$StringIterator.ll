...
%"_Pshadow_Pstandard_CException" = type { %"_Pshadow_Pstandard_CException_Mclass"*, %"_Pshadow_Pstandard_CString"*, %int }
...
%"_Pshadow_Pstandard_CIllegalArgumentException" = type { %"_Pshadow_Pstandard_CIllegalArgumentException_Mclass"*, %"_Pshadow_Pstandard_CString"*, %int }
...
%"_Pshadow_Pstandard_CObject" = type { %"_Pshadow_Pstandard_CObject_Mclass"*, %"_Pshadow_Pstandard_CString"*, %int }
...
%"_Pshadow_Pstandard_CMutableString" = type { %"_Pshadow_Pstandard_CMutableString_Mclass"*, %"_Pshadow_Pstandard_CString"*, %int }

@_class0 = private unnamed_addr constant { %boolean (%"_Pshadow_Pstandard_CString_IStringIterator"*)*, %code (%"_Pshadow_Pstandard_CString_IStringIterator"*)* } { %boolean (%"_Pshadow_Pstandard_CString_IStringIterator"*)* @"_Pshadow_Pstandard_CString_IStringIterator_MhasNext", %code (%"_Pshadow_Pstandard_CString_IStringIterator"*)* @"_Pshadow_Pstandard_CString_IStringIterator_Mnext" }
@_interfaceData = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %boolean (%"_Pshadow_Pstandard_CString_IStringIterator"*)*, %code (%"_Pshadow_Pstandard_CString_IStringIterator"*)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*)]
