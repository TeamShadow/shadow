; shadow.standard@String:StringIterator
...
@"_Pshadow_Pstandard_CString_IStringIterator_Mclass" = constant %"_Pshadow_Pstandard_CString_IStringIterator_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Pstandard_CString_IStringIterator"* getelementptr (%"_Pshadow_Pstandard_CString_IStringIterator"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Pstandard_CString_IStringIterator"** getelementptr (%"_Pshadow_Pstandard_CString_IStringIterator"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_CString_IStringIterator"* (%"_Pshadow_Pstandard_CString_IStringIterator"*, %"_Pshadow_Pstandard_CString"*)* @"_Pshadow_Pstandard_CString_IStringIterator_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %boolean (%"_Pshadow_Pstandard_CString_IStringIterator"*)* @"_Pshadow_Pstandard_CString_IStringIterator_MhasNext", %code (%"_Pshadow_Pstandard_CString_IStringIterator"*)* @"_Pshadow_Pstandard_CString_IStringIterator_Mnext" }
...
define %boolean @"_Pshadow_Pstandard_CString_IStringIterator_MhasNext"(%"_Pshadow_Pstandard_CString_IStringIterator"*) {
    %this = alloca %"_Pshadow_Pstandard_CString_IStringIterator"*
    store %"_Pshadow_Pstandard_CString_IStringIterator"* %0, %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %2 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %2, i32 0, i32 2
    %4 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %5 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %4, i32 0, i32 1
    %6 = load %"_Pshadow_Pstandard_CString"** %5
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_CString"* %6, i32 0, i32 1
    %8 = load { %byte*, [1 x %int] }* %7
    %9 = load %int* %3
    %10 = extractvalue { %byte*, [1 x %int] } %8, 1
    ...
    %15 = extractvalue { %byte*, [1 x %int] } %8, 0
    %16 = bitcast %byte* %15 to %"_Pshadow_Pstandard_CObject"*
    ...
    %19 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CArray"* %18, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cbyte_Mclass"* @"_Pshadow_Pstandard_Cbyte_Mclass", i32 0, i32 0), { %int*, [1 x %int] } %14, %"_Pshadow_Pstandard_CObject"* %16)
    %20 = getelementptr %"_Pshadow_Pstandard_CArray"* %19, i32 0, i32 0
    %21 = load %"_Pshadow_Pstandard_CArray_Mclass"** %20
    %22 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %21, i32 0, i32 13
    %23 = load %int (%"_Pshadow_Pstandard_CArray"*)** %22
    %24 = extractvalue { %byte*, [1 x %int] } %8, 1
    ...
    %29 = extractvalue { %byte*, [1 x %int] } %8, 0
    ...
    %34 = call %int %23(%"_Pshadow_Pstandard_CArray"* %33)
    %35 = icmp slt %int %9, %34
    ret %boolean %35
}

define %code @"_Pshadow_Pstandard_CString_IStringIterator_Mnext"(%"_Pshadow_Pstandard_CString_IStringIterator"*) {
    %this = alloca %"_Pshadow_Pstandard_CString_IStringIterator"*
    %value = alloca %int
    %bytes = alloca %int
    %mask = alloca %byte
    store %"_Pshadow_Pstandard_CString_IStringIterator"* %0, %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %2 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %2, i32 0, i32 1
    %4 = load %"_Pshadow_Pstandard_CString"** %3
    %5 = getelementptr inbounds %"_Pshadow_Pstandard_CString"* %4, i32 0, i32 1
    %6 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %6, i32 0, i32 2
    %8 = load { %byte*, [1 x %int] }* %5
    %9 = load %int* %7
    %10 = extractvalue { %byte*, [1 x %int] } %8, 0
    %11 = getelementptr inbounds %byte* %10, %int %9
    %12 = load %byte* %11
    %13 = sext %byte %12 to %int
    store %int %13, %int* %value
    %14 = load %int* %value
...
_label0:
    ...
    %16 = shl %byte 1, 7
    %17 = ashr %byte %16, 1
    store %byte %17, %byte* %mask
    br label %_label4
_label3:
    %18 = load %int* %bytes
    %19 = add %int %18, 1
    store %int %19, %int* %bytes
    %20 = load %byte* %mask
    %21 = ashr %byte %20, 1
    store %byte %21, %byte* %mask
    br label %_label4
_label4:
    %22 = load %int* %value
    %23 = load %byte* %mask
    %24 = sext %byte %23 to %int
    %25 = icmp sge %int %22, %24
    br %boolean %25, label %_label3, label %_label5
_label5:
    %26 = load %byte* %mask
    %27 = xor %byte -1, %26
    %28 = load %int* %value
    %29 = sext %byte %27 to %int
    %30 = and %int %28, %29
    store %int %30, %int* %value
    br label %_label7
_label6:
    %31 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %32 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %31, i32 0, i32 2
    %33 = load %int* %32
    %34 = add %int %33, 1
    store %int %34, %int* %32
    %35 = load %int* %value
    %36 = shl %int %35, 6
    store %int %36, %int* %value
    %37 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %38 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %37, i32 0, i32 1
    %39 = load %"_Pshadow_Pstandard_CString"** %38
    %40 = getelementptr inbounds %"_Pshadow_Pstandard_CString"* %39, i32 0, i32 1
    %41 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %42 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %41, i32 0, i32 2
    %43 = load { %byte*, [1 x %int] }* %40
    %44 = load %int* %42
    %45 = extractvalue { %byte*, [1 x %int] } %43, 0
    %46 = getelementptr inbounds %byte* %45, %int %44
    %47 = load %byte* %46
    %48 = and %byte %47, 63
    %49 = load %int* %value
    %50 = sext %byte %48 to %int
    %51 = or %int %49, %50
    store %int %51, %int* %value
    %52 = load %int* %bytes
    %53 = sub %int %52, 1
    store %int %53, %int* %bytes
    br label %_label7
_label7:
    %54 = load %int* %bytes
    %55 = icmp sgt %int %54, 0
    br %boolean %55, label %_label6, label %_label8
_label8:
    br label %_label2
_label1:
    br label %_label2
_label2:
    %56 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %57 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %56, i32 0, i32 2
    %58 = load %int* %57
    %59 = add %int %58, 1
    store %int %59, %int* %57
    %60 = load %int* %value
    %61 = bitcast %int %60 to %code
    ret %code %61
}

define %"_Pshadow_Pstandard_CString_IStringIterator"* @"_Pshadow_Pstandard_CString_IStringIterator_Mcreate"(%"_Pshadow_Pstandard_CString_IStringIterator"*, %"_Pshadow_Pstandard_CString"*) {
    %this = alloca %"_Pshadow_Pstandard_CString_IStringIterator"*
    %outer = alloca %"_Pshadow_Pstandard_CString"*
    store %"_Pshadow_Pstandard_CString_IStringIterator"* %0, %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    store %"_Pshadow_Pstandard_CString"* %1, %"_Pshadow_Pstandard_CString"** %outer
    %3 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %4 = bitcast %"_Pshadow_Pstandard_CString_IStringIterator"* %3 to %"_Pshadow_Pstandard_CObject"*
    %5 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %4)
    %6 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"* @"_Pshadow_Pstandard_CString_IStringIterator_Mclass", %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"** %6
    %7 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %7, i32 0, i32 1
    %9 = load %"_Pshadow_Pstandard_CString"** %outer
    store %"_Pshadow_Pstandard_CString"* %9, %"_Pshadow_Pstandard_CString"** %8
    %10 = load %"_Pshadow_Pstandard_CString_IStringIterator"** %this
    %11 = getelementptr inbounds %"_Pshadow_Pstandard_CString_IStringIterator"* %10, i32 0, i32 2
    store %int 0, %int* %11
    ret %"_Pshadow_Pstandard_CString_IStringIterator"* %0
}
...
@_array0 = private unnamed_addr constant [37 x %ubyte] c"shadow.standard@String:StringIterator"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([37 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 37] }, %boolean true }
