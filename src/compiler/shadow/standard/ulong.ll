...
@_class0 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Culong"*, %ulong)* } { %int (%"_Pshadow_Pstandard_Culong"*, %ulong)* @"_Pshadow_Pstandard_Culong_Mcompare_Pshadow_Pstandard_Culong" }
@_interfaceData = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Culong"*, %ulong)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*)]
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Culong_MtoString"(%"_Pshadow_Pstandard_Culong"*) {
    ...
    %4 = load %ulong* %this
    %5 = load %ulong* %this
    %6 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Culong_Mclass"* @"_Pshadow_Pstandard_Culong_Mclass", i32 0, i32 0))
...
_label3:
    ...
    %17 = urem %ulong %15, %16
    %18 = load %ulong* %this
    %19 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Culong_Mclass"* @"_Pshadow_Pstandard_Culong_Mclass", i32 0, i32 0))
...
define %"_Pshadow_Pstandard_Culong"* @"_Pshadow_Pstandard_Culong_Mcreate"(%"_Pshadow_Pstandard_Culong"*) {
    ...
    store %ulong %3, %ulong* %this
    %4 = load %ulong* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Culong_Mclass"* @"_Pshadow_Pstandard_Culong_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Culong"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Culong"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Culong_Mclass"* @"_Pshadow_Pstandard_Culong_Mclass", %"_Pshadow_Pstandard_Culong_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Culong"* %6, i32 0, i32 1
    store %ulong %4, %ulong* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Culong"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Culong_Mclass"* @"_Pshadow_Pstandard_Culong_Mclass", %"_Pshadow_Pstandard_Culong_Mclass"** %10
