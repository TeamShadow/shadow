...
%"_Pshadow_Pstandard_Cfloat" = type { %"_Pshadow_Pstandard_Cfloat_Mclass"*, %float, %float }
...
declare %float @"_Pshadow_Pstandard_Cfloat_Msubtract_R_Pshadow_Pstandard_Cfloat"(%float, %float)

declare %int @"_Pshadow_Pstandard_Cfloat_Mcompare_R_Pshadow_Pstandard_Cfloat"(%float, %float)

declare %float @"_Pshadow_Pstandard_Cfloat_Mdivide_R_Pshadow_Pstandard_Cfloat"(%float, %float)

declare %float @"_Pshadow_Pstandard_Cfloat_Mmultiply_R_Pshadow_Pstandard_Cfloat"(%float, %float)

declare %float @"_Pshadow_Pstandard_Cfloat_Madd_R_Pshadow_Pstandard_Cfloat"(%float, %float)

define %float @"_Pshadow_Pstandard_Cfloat_Mcreate"(%float) {
    %this = alloca %float
    store %float %0, %float* %this
    %2 = load %float* %this
    ret %float %2
}

declare %float @"_Pshadow_Pstandard_Cfloat_Mmodulus_R_Pshadow_Pstandard_Cfloat"(%float, %float)
