...
define %"_Pshadow_Pstandard_CIllegalArgumentException"* @"_Pshadow_Pstandard_CIllegalArgumentException_Mcreate"(%"_Pshadow_Pstandard_CIllegalArgumentException"*) {
    ...
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_CIllegalArgumentException"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CIllegalArgumentException_Mclass"* @"_Pshadow_Pstandard_CIllegalArgumentException_Mclass", %"_Pshadow_Pstandard_CIllegalArgumentException_Mclass"** %2
...
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([40 x %ubyte]* @_array0, i32 0, i32 0), [1 x %int] [%int 40] }, %boolean true }
