; shadow.standard@IllegalArgumentException
...
@"_Pshadow_Pstandard_CIllegalArgumentException_Mclass" = constant %"_Pshadow_Pstandard_CIllegalArgumentException_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([0 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 0] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([0 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 0] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CException_Mclass"* @"_Pshadow_Pstandard_CException_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Pstandard_CIllegalArgumentException"* getelementptr (%"_Pshadow_Pstandard_CIllegalArgumentException"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Pstandard_CIllegalArgumentException"** getelementptr (%"_Pshadow_Pstandard_CIllegalArgumentException"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_CIllegalArgumentException"* (%"_Pshadow_Pstandard_CIllegalArgumentException"*)* @"_Pshadow_Pstandard_CIllegalArgumentException_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %"_Pshadow_Pstandard_CException"* (%"_Pshadow_Pstandard_CException"*, %"_Pshadow_Pstandard_CString"*)* @"_Pshadow_Pstandard_CException_Mcreate_Pshadow_Pstandard_CString", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CException"*)* @"_Pshadow_Pstandard_CException_Mmessage", void (%"_Pshadow_Pstandard_CException"*)* @"_Pshadow_Pstandard_CException_Mthrow__" }
...
define %"_Pshadow_Pstandard_CIllegalArgumentException"* @"_Pshadow_Pstandard_CIllegalArgumentException_Mcreate"(%"_Pshadow_Pstandard_CIllegalArgumentException"*) {
    %this = alloca %"_Pshadow_Pstandard_CIllegalArgumentException"*
    store %"_Pshadow_Pstandard_CIllegalArgumentException"* %0, %"_Pshadow_Pstandard_CIllegalArgumentException"** %this
    %2 = load %"_Pshadow_Pstandard_CIllegalArgumentException"** %this
    %3 = bitcast %"_Pshadow_Pstandard_CIllegalArgumentException"* %2 to %"_Pshadow_Pstandard_CException"*
    %4 = call %"_Pshadow_Pstandard_CException"* @"_Pshadow_Pstandard_CException_Mcreate"(%"_Pshadow_Pstandard_CException"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Pstandard_CIllegalArgumentException"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CIllegalArgumentException_Mclass"* @"_Pshadow_Pstandard_CIllegalArgumentException_Mclass", %"_Pshadow_Pstandard_CIllegalArgumentException_Mclass"** %5
    ret %"_Pshadow_Pstandard_CIllegalArgumentException"* %0
}
...
@_array0 = private unnamed_addr constant [40 x %ubyte] c"shadow.standard@IllegalArgumentException"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([40 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 40] }, %boolean true }
