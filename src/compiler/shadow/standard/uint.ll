...
@_class0 = private unnamed_addr constant { %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* } { %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Madd_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mdivide_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mmodulus_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mmultiply_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Msubtract_Pshadow_Pstandard_Cuint" }
@_class1 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cuint"*, %uint)* } { %int (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mcompare_Pshadow_Pstandard_Cuint" }
@_class2 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cuint"*)* } { %int (%"_Pshadow_Pstandard_Cuint"*)* @"_Pshadow_Pstandard_Cuint_Mhash" }
@_interfaceData = private unnamed_addr constant [3 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)*, %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cuint"*, %uint)* }* @_class1 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cuint"*)* }* @_class2 to %"_Pshadow_Pstandard_CObject"*)]
...
@"_Pshadow_Pstandard_Cuint_Mclass" = constant %"_Pshadow_Pstandard_Cuint_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([3 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 3] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([3 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 3] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cuint"* getelementptr (%"_Pshadow_Pstandard_Cuint"* null, i32 1) to i32), %int ptrtoint (%uint* getelementptr (%uint* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cuint"* (%"_Pshadow_Pstandard_Cuint"*)* @"_Pshadow_Pstandard_Cuint_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cuint"*)* @"_Pshadow_Pstandard_Cuint_MtoString", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Madd_Pshadow_Pstandard_Cuint", %int (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mcompare_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mdivide_Pshadow_Pstandard_Cuint", %int (%"_Pshadow_Pstandard_Cuint"*)* @"_Pshadow_Pstandard_Cuint_Mhash", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mmax_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mmin_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mmodulus_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Mmultiply_Pshadow_Pstandard_Cuint", %uint (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_Msubtract_Pshadow_Pstandard_Cuint", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cuint"*, %uint)* @"_Pshadow_Pstandard_Cuint_MtoString_Pshadow_Pstandard_Cuint" }
...
define %code @"_Pshadow_Pstandard_Cuint_Mdigit_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"*, %uint) {
    %this = alloca %uint
    %digit = alloca %uint
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 1
    %4 = load %uint* %3
    store %uint %4, %uint* %this
    store %uint %1, %uint* %digit
    %5 = load %uint* %digit
    %6 = icmp ult %uint %5, 10
    br %boolean %6, label %_label0, label %_label1
_label0:
    %7 = load %uint* %digit
    %8 = bitcast %code 48 to %uint
    %9 = add %uint %7, %8
    %10 = bitcast %uint %9 to %code
    ret %code %10
    br label %_label2
_label1:
    br label %_label2
_label2:
    %12 = load %uint* %digit
    %13 = sub %uint %12, 10
    %14 = bitcast %code 97 to %uint
    %15 = add %uint %13, %14
    %16 = bitcast %uint %15 to %code
    ret %code %16
}

define %uint @"_Pshadow_Pstandard_Cuint_Mmin_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"*, %uint) {
    %this = alloca %uint
    %other = alloca %uint
    %_temp = alloca %uint
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 1
...
_label3:
    %8 = load %uint* %this
    store %uint %8, %uint* %_temp
    br label %_label5
_label4:
    %9 = load %uint* %other
    store %uint %9, %uint* %_temp
    br label %_label5
_label5:
    %10 = load %uint* %_temp
    ret %uint %10
...
define %uint @"_Pshadow_Pstandard_Cuint_Mmax_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"*, %uint) {
    %this = alloca %uint
    %other = alloca %uint
    %_temp = alloca %uint
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 1
    ...
    %6 = load %uint* %other
    %7 = icmp ugt %uint %5, %6
    br %boolean %7, label %_label6, label %_label7
_label6:
    %8 = load %uint* %this
    store %uint %8, %uint* %_temp
    br label %_label8
...
define %int @"_Pshadow_Pstandard_Cuint_Mhash"(%"_Pshadow_Pstandard_Cuint"*) {
    %this = alloca %uint
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 1
    %3 = load %uint* %2
    store %uint %3, %uint* %this
    %4 = load %uint* %this
    %5 = bitcast %uint %4 to %int
    ret %int %5
}

declare %int @"_Pshadow_Pstandard_Cuint_Mcompare_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"*, %uint)

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cuint_MtoString"(%"_Pshadow_Pstandard_Cuint"*) {
    %this = alloca %uint
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 1
    %3 = load %uint* %2
    store %uint %3, %uint* %this
    %4 = load %uint* %this
    %5 = load %uint* %this
    %6 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", i32 0, i32 0))
    %7 = bitcast %"_Pshadow_Pstandard_CObject"*%6 to %"_Pshadow_Pstandard_Cuint"*
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"*%7, i32 0, i32 1
    store %uint %5, %uint* %8
    %9 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cuint_MtoString_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"* %7, %uint 10)
    ret %"_Pshadow_Pstandard_CString"* %9
}

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cuint_MtoString_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"*, %uint) {
    %this = alloca %uint
    %base = alloca %uint
...
_label9:
    ...
    %17 = urem %uint %15, %16
    %18 = load %uint* %this
    %19 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", i32 0, i32 0))
    %20 = bitcast %"_Pshadow_Pstandard_CObject"*%19 to %"_Pshadow_Pstandard_Cuint"*
    %21 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"*%20, i32 0, i32 1
    store %uint %18, %uint* %21
    %22 = call %code @"_Pshadow_Pstandard_Cuint_Mdigit_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"* %20, %uint %17)
    ...
    %30 = load %uint* %base
    %31 = udiv %uint %29, %30
    store %uint %31, %uint* %value
    br label %_label10
_label10:
    %32 = load %uint* %value
    %33 = icmp eq %uint %32, 0
    %34 = xor %boolean %33, true
    br %boolean %34, label %_label9, label %_label11
_label11:
    ...
    %38 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %37, i32 0, i32 14
    %39 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*)** %38
    %40 = load %"_Pshadow_Pstandard_CMutableString"** %string
    %41 = call %"_Pshadow_Pstandard_CMutableString"* %39(%"_Pshadow_Pstandard_CMutableString"* %40)
    %42 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %41, i32 0, i32 0
    %43 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %42
    %44 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %43, i32 0, i32 6
    %45 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CMutableString"*)** %44
    %46 = call %"_Pshadow_Pstandard_CString"* %45(%"_Pshadow_Pstandard_CMutableString"* %41)
...
define %"_Pshadow_Pstandard_Cuint"* @"_Pshadow_Pstandard_Cuint_Mcreate"(%"_Pshadow_Pstandard_Cuint"*) {
    %this = alloca %uint
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 1
    %3 = load %uint* %2
    store %uint %3, %uint* %this
    %4 = load %uint* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cuint"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", %"_Pshadow_Pstandard_Cuint_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %6, i32 0, i32 1
    store %uint %4, %uint* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", %"_Pshadow_Pstandard_Cuint_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cuint"* %0
}
