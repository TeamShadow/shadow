...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Ccode_MtoString"(%"_Pshadow_Pstandard_Ccode"*) {
    ...
    %15 = getelementptr %"_Pshadow_Pstandard_CString"* %13, i32 0, i32 0
    %16 = load %"_Pshadow_Pstandard_CString_Mclass"** %15
    %17 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %16, i32 0, i32 12
    %18 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, { %code*, [1 x %int] })** %17
    %19 = call %"_Pshadow_Pstandard_CString"* %18(%"_Pshadow_Pstandard_CString"* %13, { %code*, [1 x %int] } %14)
...
define %"_Pshadow_Pstandard_Ccode"* @"_Pshadow_Pstandard_Ccode_Mcreate"(%"_Pshadow_Pstandard_Ccode"*) {
    %this = alloca %code
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %2
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %0, i32 0, i32 1
    %4 = load %code* %3
    store %code %4, %code* %this
