...
@"_Pshadow_Pstandard_Clong_Mclass" = constant %"_Pshadow_Pstandard_Clong_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Clong"* getelementptr (%"_Pshadow_Pstandard_Clong"* null, i32 1) to i32), %int ptrtoint (%long* getelementptr (%long* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Clong"* (%"_Pshadow_Pstandard_Clong"*)* @"_Pshadow_Pstandard_Clong_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Clong"*)* @"_Pshadow_Pstandard_Clong_MtoString", %ulong (%"_Pshadow_Pstandard_Clong"*)* @"_Pshadow_Pstandard_Clong_Mabs", %long (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Madd_Pshadow_Pstandard_Clong", %int (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Mcompare_Pshadow_Pstandard_Clong", %long (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Mdivide_Pshadow_Pstandard_Clong", %int (%"_Pshadow_Pstandard_Clong"*)* @"_Pshadow_Pstandard_Clong_Mhash", %long (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Mmax_Pshadow_Pstandard_Clong", %long (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Mmin_Pshadow_Pstandard_Clong", %long (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Mmodulus_Pshadow_Pstandard_Clong", %long (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Mmultiply_Pshadow_Pstandard_Clong", %long (%"_Pshadow_Pstandard_Clong"*, %long)* @"_Pshadow_Pstandard_Clong_Msubtract_Pshadow_Pstandard_Clong", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Clong"*, %ulong)* @"_Pshadow_Pstandard_Clong_MtoString_Pshadow_Pstandard_Culong" }
...
define %long @"_Pshadow_Pstandard_Clong_Mmin_Pshadow_Pstandard_Clong"(%"_Pshadow_Pstandard_Clong"*, %long) {
    %this = alloca %long
    %other = alloca %long
    %_temp = alloca %long
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %0, i32 0, i32 1
    %4 = load %long* %3
    store %long %4, %long* %this
    store %long %1, %long* %other
    %5 = load %long* %this
    %6 = load %long* %other
    %7 = icmp slt %long %5, %6
...
_label0:
    %8 = load %long* %this
    store %long %8, %long* %_temp
    br label %_label2
_label1:
    %9 = load %long* %other
    store %long %9, %long* %_temp
    br label %_label2
_label2:
    %10 = load %long* %_temp
    ret %long %10
...
define %long @"_Pshadow_Pstandard_Clong_Mmax_Pshadow_Pstandard_Clong"(%"_Pshadow_Pstandard_Clong"*, %long) {
    %this = alloca %long
    %other = alloca %long
    %_temp = alloca %long
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %0, i32 0, i32 1
...
define %ulong @"_Pshadow_Pstandard_Clong_Mabs"(%"_Pshadow_Pstandard_Clong"*) {
    %this = alloca %long
    %_temp = alloca %long
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %0, i32 0, i32 1
    %3 = load %long* %2
    store %long %3, %long* %this
    %4 = load %long* %this
    %5 = icmp slt %long %4, 0
...
_label8:
    %9 = load %long* %_temp
    %10 = bitcast %long %9 to %ulong
    ret %ulong %10
}

define %int @"_Pshadow_Pstandard_Clong_Mhash"(%"_Pshadow_Pstandard_Clong"*) {
    %this = alloca %long
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %0, i32 0, i32 1
    %3 = load %long* %2
    store %long %3, %long* %this
    %4 = load %long* %this
    %5 = trunc %long %4 to %int
    ret %int %5
}

declare %int @"_Pshadow_Pstandard_Clong_Mcompare_Pshadow_Pstandard_Clong"(%"_Pshadow_Pstandard_Clong"*, %long)

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Clong_MtoString"(%"_Pshadow_Pstandard_Clong"*) {
    %this = alloca %long
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %0, i32 0, i32 1
    %3 = load %long* %2
    store %long %3, %long* %this
    %4 = load %long* %this
    %5 = load %long* %this
    %6 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Clong_Mclass"* @"_Pshadow_Pstandard_Clong_Mclass", i32 0, i32 0))
    %7 = bitcast %"_Pshadow_Pstandard_CObject"*%6 to %"_Pshadow_Pstandard_Clong"*
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"*%7, i32 0, i32 1
    store %long %5, %long* %8
    %9 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Clong_MtoString_Pshadow_Pstandard_Culong"(%"_Pshadow_Pstandard_Clong"* %7, %ulong 10)
    ret %"_Pshadow_Pstandard_CString"* %9
}

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Clong_MtoString_Pshadow_Pstandard_Culong"(%"_Pshadow_Pstandard_Clong"*, %ulong) {
    %this = alloca %long
    %base = alloca %ulong
    ...
    %5 = load %long* %this
    %6 = load %long* %this
    %7 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Clong_Mclass"* @"_Pshadow_Pstandard_Clong_Mclass", i32 0, i32 0))
    %8 = bitcast %"_Pshadow_Pstandard_CObject"*%7 to %"_Pshadow_Pstandard_Clong"*
    %9 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"*%8, i32 0, i32 1
    store %long %6, %long* %9
    %10 = call %ulong @"_Pshadow_Pstandard_Clong_Mabs"(%"_Pshadow_Pstandard_Clong"* %8)
    %11 = load %ulong* %base
    %12 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Culong_Mclass"* @"_Pshadow_Pstandard_Culong_Mclass", i32 0, i32 0))
    %13 = bitcast %"_Pshadow_Pstandard_CObject"*%12 to %"_Pshadow_Pstandard_Culong"*
    %14 = getelementptr inbounds %"_Pshadow_Pstandard_Culong"*%13, i32 0, i32 1
    store %ulong %10, %ulong* %14
    %15 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Culong_MtoString_Pshadow_Pstandard_Culong"(%"_Pshadow_Pstandard_Culong"* %13, %ulong %11)
    store %"_Pshadow_Pstandard_CString"* %15, %"_Pshadow_Pstandard_CString"** %string
    %16 = load %long* %this
    %17 = sext %int 0 to %long
    %18 = icmp sge %long %16, %17
...
_label10:
    ...
    %34 = icmp eq %"_Pshadow_Pstandard_CString"* %33, null
...
_label14:
    ...
    %45 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %32, %"_Pshadow_Pstandard_CString"* %44)
...
define %"_Pshadow_Pstandard_Clong"* @"_Pshadow_Pstandard_Clong_Mcreate"(%"_Pshadow_Pstandard_Clong"*) {
    %this = alloca %long
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %0, i32 0, i32 1
    %3 = load %long* %2
    store %long %3, %long* %this
    %4 = load %long* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Clong_Mclass"* @"_Pshadow_Pstandard_Clong_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Clong"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Clong_Mclass"* @"_Pshadow_Pstandard_Clong_Mclass", %"_Pshadow_Pstandard_Clong_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %6, i32 0, i32 1
    store %long %4, %long* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Clong"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Clong_Mclass"* @"_Pshadow_Pstandard_Clong_Mclass", %"_Pshadow_Pstandard_Clong_Mclass"** %10
    ret %"_Pshadow_Pstandard_Clong"* %0
}
...
@_array0 = private unnamed_addr constant [4 x %ubyte] c"long"
