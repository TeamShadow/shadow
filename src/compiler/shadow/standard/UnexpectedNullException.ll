; default@UnexpectedNullException
...
define %"_P_CUnexpectedNullException"* @"_P_CUnexpectedNullException_Mcreate"(%"_P_CUnexpectedNullException"*) {
    %this = alloca %"_P_CUnexpectedNullException"*
    store %"_P_CUnexpectedNullException"* %0, %"_P_CUnexpectedNullException"** %this
    %2 = load %"_P_CUnexpectedNullException"** %this
    %3 = bitcast %"_P_CUnexpectedNullException"* %2 to %"_Pshadow_Pstandard_CException"*
    %4 = call %"_Pshadow_Pstandard_CException"* @"_Pshadow_Pstandard_CException_Mcreate"(%"_Pshadow_Pstandard_CException"* %3)
    %5 = getelementptr inbounds %"_P_CUnexpectedNullException"* %0, i32 0, i32 0
    store %"_P_CUnexpectedNullException_Mclass"* @"_P_CUnexpectedNullException_Mclass", %"_P_CUnexpectedNullException_Mclass"** %5
    ret %"_P_CUnexpectedNullException"* %0
}
...
@_array0 = private unnamed_addr constant [31 x %ubyte] c"default@UnexpectedNullException"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([31 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 31] }, %boolean true }
