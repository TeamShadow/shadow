...
@"_Pshadow_Pstandard_Ccode_Mclass" = constant %"_Pshadow_Pstandard_Ccode_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([0 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 0] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([0 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 0] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Ccode"* getelementptr (%"_Pshadow_Pstandard_Ccode"* null, i32 1) to i32), %int ptrtoint (%code* getelementptr (%code* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Ccode"* (%"_Pshadow_Pstandard_Ccode"*)* @"_Pshadow_Pstandard_Ccode_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Ccode"*)* @"_Pshadow_Pstandard_Ccode_MtoString", %code (%"_Pshadow_Pstandard_Ccode"*)* @"_Pshadow_Pstandard_Ccode_MtoLowerCase", %code (%"_Pshadow_Pstandard_Ccode"*)* @"_Pshadow_Pstandard_Ccode_MtoUpperCase" }
...
define %code @"_Pshadow_Pstandard_Ccode_MtoUpperCase"(%"_Pshadow_Pstandard_Ccode"*) {
    %this = alloca %code
    %_temp = alloca %boolean
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %0, i32 0, i32 1
    %3 = load %code* %2
    store %code %3, %code* %this
    %4 = load %code* %this
    %5 = icmp sge %code %4, 97
    store %boolean %5, %boolean* %_temp
    br %boolean %5, label %_label4, label %_label3
_label4:
    %6 = load %code* %this
    %7 = icmp sle %code %6, 122
    store %boolean %7, %boolean* %_temp
    br label %_label3
_label3:
    %8 = load %boolean* %_temp
...
define %code @"_Pshadow_Pstandard_Ccode_MtoLowerCase"(%"_Pshadow_Pstandard_Ccode"*) {
    %this = alloca %code
    %_temp = alloca %boolean
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %0, i32 0, i32 1
    %3 = load %code* %2
    store %code %3, %code* %this
    %4 = load %code* %this
    %5 = icmp sge %code %4, 65
    store %boolean %5, %boolean* %_temp
    br %boolean %5, label %_label9, label %_label8
_label9:
    %6 = load %code* %this
    %7 = icmp sle %code %6, 90
    store %boolean %7, %boolean* %_temp
    br label %_label8
_label8:
    %8 = load %boolean* %_temp
    br %boolean %8, label %_label5, label %_label6
_label5:
    %9 = load %code* %this
    %10 = sub %code %9, 65
    %11 = add %code %10, 97
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Ccode_MtoString"(%"_Pshadow_Pstandard_Ccode"*) {
    %this = alloca %code
    %array = alloca { %code*, [1 x %int] }
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %0, i32 0, i32 1
    %3 = load %code* %2
    store %code %3, %code* %this
    %4 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0), %int 1)
    %5 = bitcast %"_Pshadow_Pstandard_CObject"* %4 to %code*
    %6 = insertvalue { %code*, [1 x %int] } undef, %code* %5, 0
    %7 = insertvalue { %code*, [1 x %int] } %6, %int 1, 1, 0
    store { %code*, [1 x %int] } %7, { %code*, [1 x %int] }* %array
    %8 = load { %code*, [1 x %int] }* %array
    %9 = extractvalue { %code*, [1 x %int] } %8, 0
    %10 = getelementptr inbounds %code* %9, %int 0
    %11 = load %code* %this
    store %code %11, %code* %10
    %12 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", i32 0, i32 0))
    %13 = bitcast %"_Pshadow_Pstandard_CObject"* %12 to %"_Pshadow_Pstandard_CString"*
    %14 = load { %code*, [1 x %int] }* %array
    %15 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mcreate_Pshadow_Pstandard_Ccode_A1"(%"_Pshadow_Pstandard_CString"* %13, { %code*, [1 x %int] } %14)
    ret %"_Pshadow_Pstandard_CString"* %13
}

define %"_Pshadow_Pstandard_Ccode"* @"_Pshadow_Pstandard_Ccode_Mcreate"(%"_Pshadow_Pstandard_Ccode"*) {
    %this = alloca %code
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %0, i32 0, i32 1
    %3 = load %code* %2
    store %code %3, %code* %this
    %4 = load %code* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Ccode"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %6, i32 0, i32 1
    store %code %4, %code* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %10
    ret %"_Pshadow_Pstandard_Ccode"* %0
}
...
@_array0 = private unnamed_addr constant [4 x %ubyte] c"code"
