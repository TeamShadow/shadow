...
declare %ulong @"_Pshadow_Pstandard_Culong_Msubtract_R_Pshadow_Pstandard_Culong"(%ulong, %ulong)

declare %int @"_Pshadow_Pstandard_Culong_Mcompare_R_Pshadow_Pstandard_Culong"(%ulong, %ulong)

declare %ulong @"_Pshadow_Pstandard_Culong_Mdivide_R_Pshadow_Pstandard_Culong"(%ulong, %ulong)

declare %ulong @"_Pshadow_Pstandard_Culong_Mmultiply_R_Pshadow_Pstandard_Culong"(%ulong, %ulong)

declare %ulong @"_Pshadow_Pstandard_Culong_Madd_R_Pshadow_Pstandard_Culong"(%ulong, %ulong)

define %ulong @"_Pshadow_Pstandard_Culong_Mcreate"(%ulong) {
    %this = alloca %ulong
    store %ulong %0, %ulong* %this
    %2 = load %ulong* %this
    ret %ulong %2
}

declare %ulong @"_Pshadow_Pstandard_Culong_Mmodulus_R_Pshadow_Pstandard_Culong"(%ulong, %ulong)
