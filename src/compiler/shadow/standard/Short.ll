...
@"_Pshadow_Pstandard_Cshort_Mclass" = global %"_Pshadow_Pstandard_Cshort_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 1, %int ptrtoint (%"_Pshadow_Pstandard_Cshort"* getelementptr (%"_Pshadow_Pstandard_Cshort"* null, i32 1) to i32), %int ptrtoint (%short* getelementptr (%short* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cshort"* (%"_Pshadow_Pstandard_Cshort"*)* @"_Pshadow_Pstandard_Cshort_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Madd_Pshadow_Pstandard_Cshort", %int (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mcompare_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mdivide_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mmodulus_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mmultiply_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Msubtract_Pshadow_Pstandard_Cshort" }
...
define %"_Pshadow_Pstandard_Cshort"* @"_Pshadow_Pstandard_Cshort_Mcreate"(%"_Pshadow_Pstandard_Cshort"*) {
    %this = alloca %short
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cshort"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cshort_Mclass"* @"_Pshadow_Pstandard_Cshort_Mclass", %"_Pshadow_Pstandard_Cshort_Mclass"** %2
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cshort"* %0, i32 0, i32 1
    %4 = load %short* %3
    store %short %4, %short* %this
...
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([5 x %ubyte]* @_array0, i32 0, i32 0), [1 x %int] [%int 5] } }
