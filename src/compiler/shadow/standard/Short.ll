...
declare %short @"_Pshadow_Pstandard_Cshort_Msubtract_R_Pshadow_Pstandard_Cshort"(%short, %short)

declare %int @"_Pshadow_Pstandard_Cshort_Mcompare_R_Pshadow_Pstandard_Cshort"(%short, %short)

declare %short @"_Pshadow_Pstandard_Cshort_Mdivide_R_Pshadow_Pstandard_Cshort"(%short, %short)

declare %short @"_Pshadow_Pstandard_Cshort_Mmultiply_R_Pshadow_Pstandard_Cshort"(%short, %short)

declare %short @"_Pshadow_Pstandard_Cshort_Madd_R_Pshadow_Pstandard_Cshort"(%short, %short)

define %short @"_Pshadow_Pstandard_Cshort_Mcreate"(%short) {
    %this = alloca %short
    store %short %0, %short* %this
    %2 = load %short* %this
    ret %short %2
}

declare %short @"_Pshadow_Pstandard_Cshort_Mmodulus_R_Pshadow_Pstandard_Cshort"(%short, %short)
