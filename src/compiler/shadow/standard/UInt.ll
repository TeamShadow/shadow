...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cuint_MtoString"(%"_Pshadow_Pstandard_Cuint"*) {
    ...
    %4 = load %uint* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"*%5 to %"_Pshadow_Pstandard_Cuint"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"*%6, i32 0, i32 1
    store %uint %4, %uint* %7
    %8 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cuint_MtoString_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"* %6, %uint 10)
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cuint_MtoString_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"*, %uint) {
    ...
    %7 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %6, i32 0, i32 0
    %8 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %7
    %9 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %8, i32 0, i32 2
    %10 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*)** %9
    %11 = call %"_Pshadow_Pstandard_CMutableString"* %10(%"_Pshadow_Pstandard_CMutableString"* %6)
    store %"_Pshadow_Pstandard_CMutableString"* %6, %"_Pshadow_Pstandard_CMutableString"** %string
    %12 = load %uint* %this
    store %uint %12, %uint* %value
    br label %_label9
_label9:
    %13 = load %uint* %value
    %14 = load %uint* %base
    %15 = urem %uint %13, %14
    %16 = load %uint* %this
    %17 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", i32 0, i32 0))
    %18 = bitcast %"_Pshadow_Pstandard_CObject"*%17 to %"_Pshadow_Pstandard_Cuint"*
    %19 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"*%18, i32 0, i32 1
    store %uint %16, %uint* %19
    %20 = call %code @"_Pshadow_Pstandard_Cuint_Mdigit_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"* %18, %uint %15)
    %21 = load %"_Pshadow_Pstandard_CMutableString"** %string
    %22 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %23 = bitcast %"_Pshadow_Pstandard_CObject"*%22 to %"_Pshadow_Pstandard_Ccode"*
    %24 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"*%23, i32 0, i32 1
    store %code %20, %code* %24
    %25 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %21, i32 0, i32 0
    ...
    %29 = call %"_Pshadow_Pstandard_CMutableString"* %28(%"_Pshadow_Pstandard_CMutableString"* %21, %"_Pshadow_Pstandard_CObject"* %22)
    %30 = load %uint* %value
    %31 = load %uint* %base
    %32 = udiv %uint %30, %31
    store %uint %32, %uint* %value
    br label %_label10
_label10:
    %33 = load %uint* %value
    %34 = icmp ne %uint %33, 0
...
_label11:
    ...
    %40 = call %"_Pshadow_Pstandard_CMutableString"* %39(%"_Pshadow_Pstandard_CMutableString"* %35)
...
define %"_Pshadow_Pstandard_Cuint"* @"_Pshadow_Pstandard_Cuint_Mcreate"(%"_Pshadow_Pstandard_Cuint"*) {
    %this = alloca %uint
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", %"_Pshadow_Pstandard_Cuint_Mclass"** %2
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"* %0, i32 0, i32 1
    %4 = load %uint* %3
    store %uint %4, %uint* %this
