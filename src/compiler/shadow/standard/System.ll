...
@"_Pshadow_Pstandard_CSystem_Mclass" = constant %"_Pshadow_Pstandard_CSystem_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Pstandard_CSystem"* getelementptr (%"_Pshadow_Pstandard_CSystem"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Pstandard_CSystem"** getelementptr (%"_Pshadow_Pstandard_CSystem"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_CSystem"* (%"_Pshadow_Pstandard_CSystem"*)* @"_Pshadow_Pstandard_CSystem_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %ulong (%"_Pshadow_Pstandard_CSystem"*)* @"_Pshadow_Pstandard_CSystem_MnanoTime" }
@"_Pshadow_Pstandard_CSystem_Minstance" = global %"_Pshadow_Pstandard_CSystem"* null
...
define %"_Pshadow_Pstandard_CSystem"* @"_Pshadow_Pstandard_CSystem_Mcreate"(%"_Pshadow_Pstandard_CSystem"*) {
    %this = alloca %"_Pshadow_Pstandard_CSystem"*
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_CSystem"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CSystem_Mclass"* @"_Pshadow_Pstandard_CSystem_Mclass", %"_Pshadow_Pstandard_CSystem_Mclass"** %2
    store %"_Pshadow_Pstandard_CSystem"* %0, %"_Pshadow_Pstandard_CSystem"** %this
    ret %"_Pshadow_Pstandard_CSystem"* %0
}
...
@_array0 = private unnamed_addr constant [22 x %ubyte] c"shadow.standard@System"
