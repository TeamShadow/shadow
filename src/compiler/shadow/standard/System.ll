...
define %"_Pshadow_Pstandard_CSystem"* @"_Pshadow_Pstandard_CSystem_Mcreate"(%"_Pshadow_Pstandard_CSystem"*) {
    ...
    %2 = load %"_Pshadow_Pstandard_CSystem"** %this
    %3 = bitcast %"_Pshadow_Pstandard_CSystem"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Pstandard_CSystem"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CSystem_Mclass"* @"_Pshadow_Pstandard_CSystem_Mclass", %"_Pshadow_Pstandard_CSystem_Mclass"** %5
