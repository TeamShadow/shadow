...
@"_Pshadow_Pstandard_CException_Mclass" = constant %"_Pshadow_Pstandard_CException_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Pstandard_CException"* getelementptr (%"_Pshadow_Pstandard_CException"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Pstandard_CException"** getelementptr (%"_Pshadow_Pstandard_CException"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_CException"* (%"_Pshadow_Pstandard_CException"*)* @"_Pshadow_Pstandard_CException_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %"_Pshadow_Pstandard_CException"* (%"_Pshadow_Pstandard_CException"*, %"_Pshadow_Pstandard_CString"*)* @"_Pshadow_Pstandard_CException_Mcreate_Pshadow_Pstandard_CString", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CException"*)* @"_Pshadow_Pstandard_CException_Mmessage", void (%"_Pshadow_Pstandard_CException"*)* @"_Pshadow_Pstandard_CException_Mthrow__" }
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CException_Mmessage"(%"_Pshadow_Pstandard_CException"*) {
    %this = alloca %"_Pshadow_Pstandard_CException"*
    store %"_Pshadow_Pstandard_CException"* %0, %"_Pshadow_Pstandard_CException"** %this
    %2 = load %"_Pshadow_Pstandard_CException"** %this
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_CException"* %2, i32 0, i32 1
    %4 = load %"_Pshadow_Pstandard_CString"** %3
    ret %"_Pshadow_Pstandard_CString"* %4
}

define %int @"_Pshadow_Pstandard_CException_Mterminate"(%"_Pshadow_Pstandard_CException"*) {
    %this = alloca %"_Pshadow_Pstandard_CException"*
...
_label1:
    ...
    %11 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %10, i32 0, i32 9
    %12 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CObject"*)** %11
    %13 = load %"_Pshadow_Pstandard_CException"** %this
    %14 = bitcast %"_Pshadow_Pstandard_CException"* %13 to %"_Pshadow_Pstandard_CObject"*
    ...
    %19 = load %"_Pshadow_Pstandard_CException"** %this
    %20 = bitcast %"_Pshadow_Pstandard_CException"* %19 to %"_Pshadow_Pstandard_CObject"*
    %21 = call %"_Pshadow_Pstandard_CClass"* %18(%"_Pshadow_Pstandard_CObject"* %20)
    %22 = load %"_Pshadow_Pio_CConsole"** %console
    %23 = bitcast %"_Pshadow_Pstandard_CClass"* %21 to %"_Pshadow_Pstandard_CObject"*
    %24 = call %"_Pshadow_Pio_CConsole"* %12(%"_Pshadow_Pio_CConsole"* %22, %"_Pshadow_Pstandard_CObject"* %23)
    ...
    %28 = load %"_Pshadow_Pstandard_CString"** %26
    %29 = call %boolean @"_Pshadow_Pstandard_CString_MisEmpty"(%"_Pshadow_Pstandard_CString"* %28)
    %30 = xor %boolean -1, %29
    br %boolean %30, label %_label2, label %_label3
_label2:
    ...
    %34 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %33, i32 0, i32 10
    %35 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CString"*)** %34
    %36 = load %"_Pshadow_Pio_CConsole"** %console
    %37 = call %"_Pshadow_Pio_CConsole"* %35(%"_Pshadow_Pio_CConsole"* %36, %"_Pshadow_Pstandard_CString"* @_string1)
    %38 = getelementptr %"_Pshadow_Pio_CConsole"* %37, i32 0, i32 0
    %39 = load %"_Pshadow_Pio_CConsole_Mclass"** %38
    %40 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %39, i32 0, i32 10
    %41 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CString"*)** %40
    %42 = load %"_Pshadow_Pstandard_CException"** %this
    %43 = getelementptr inbounds %"_Pshadow_Pstandard_CException"* %42, i32 0, i32 1
    %44 = load %"_Pshadow_Pstandard_CString"** %43
    %45 = call %"_Pshadow_Pio_CConsole"* %41(%"_Pshadow_Pio_CConsole"* %37, %"_Pshadow_Pstandard_CString"* %44)
    br label %_label4
_label3:
    br label %_label4
_label4:
    %46 = load %"_Pshadow_Pio_CConsole"** %console
    %47 = getelementptr %"_Pshadow_Pio_CConsole"* %46, i32 0, i32 0
    %48 = load %"_Pshadow_Pio_CConsole_Mclass"** %47
    %49 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %48, i32 0, i32 12
    %50 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %49
    %51 = load %"_Pshadow_Pio_CConsole"** %console
    %52 = call %"_Pshadow_Pio_CConsole"* %50(%"_Pshadow_Pio_CConsole"* %51)
    ret %int 1
}

declare void @"_Pshadow_Pstandard_CException_Mthrow__"(%"_Pshadow_Pstandard_CException"*)

define %"_Pshadow_Pstandard_CException"* @"_Pshadow_Pstandard_CException_Mcreate"(%"_Pshadow_Pstandard_CException"*) {
    %this = alloca %"_Pshadow_Pstandard_CException"*
    store %"_Pshadow_Pstandard_CException"* %0, %"_Pshadow_Pstandard_CException"** %this
    %2 = load %"_Pshadow_Pstandard_CException"** %this
    %3 = bitcast %"_Pshadow_Pstandard_CException"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Pstandard_CException"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CException_Mclass"* @"_Pshadow_Pstandard_CException_Mclass", %"_Pshadow_Pstandard_CException_Mclass"** %5
    %6 = load %"_Pshadow_Pstandard_CException"** %this
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_CException"* %6, i32 0, i32 1
    store %"_Pshadow_Pstandard_CString"* @_string2, %"_Pshadow_Pstandard_CString"** %7
    ret %"_Pshadow_Pstandard_CException"* %0
}

define %"_Pshadow_Pstandard_CException"* @"_Pshadow_Pstandard_CException_Mcreate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CException"*, %"_Pshadow_Pstandard_CString"*) {
    %this = alloca %"_Pshadow_Pstandard_CException"*
    %message = alloca %"_Pshadow_Pstandard_CString"*
    store %"_Pshadow_Pstandard_CException"* %0, %"_Pshadow_Pstandard_CException"** %this
    store %"_Pshadow_Pstandard_CString"* %1, %"_Pshadow_Pstandard_CString"** %message
    %3 = load %"_Pshadow_Pstandard_CException"** %this
    %4 = bitcast %"_Pshadow_Pstandard_CException"* %3 to %"_Pshadow_Pstandard_CObject"*
    %5 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %4)
    %6 = getelementptr inbounds %"_Pshadow_Pstandard_CException"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CException_Mclass"* @"_Pshadow_Pstandard_CException_Mclass", %"_Pshadow_Pstandard_CException_Mclass"** %6
    %7 = load %"_Pshadow_Pstandard_CException"** %this
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_CException"* %7, i32 0, i32 1
    store %"_Pshadow_Pstandard_CString"* @_string2, %"_Pshadow_Pstandard_CString"** %8
    %9 = load %"_Pshadow_Pstandard_CException"** %this
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_CException"* %9, i32 0, i32 1
    %11 = load %"_Pshadow_Pstandard_CString"** %message
    store %"_Pshadow_Pstandard_CString"* %11, %"_Pshadow_Pstandard_CString"** %10
    ret %"_Pshadow_Pstandard_CException"* %0
}
...
@_array0 = private unnamed_addr constant [25 x %ubyte] c"shadow.standard@Exception"
...
@_array2 = private unnamed_addr constant [0 x %ubyte] c""
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([0 x %byte]* @_array2, i32 0, i32 0), [1 x %int] [%int 0] }, %boolean true }
