; shadow.standard@AbstractClass native methods
...
%_Pshadow_Pstandard_CAbstractClass_Mclass = type opaque
%_Pshadow_Pstandard_CAbstractClass = type { %_Pshadow_Pstandard_CAbstractClass_Mclass*,  { %_Pshadow_Pstandard_CClass**, [1 x i32] }, %_Pshadow_Pstandard_CString*, %_Pshadow_Pstandard_CClass*, i32, i32, i32 }
...
%_Pshadow_Pstandard_CClass = type { %_Pshadow_Pstandard_CClass_Mclass*, i32, i32, { %_Pshadow_Pstandard_CObject**, [1 x i32] }, { %_Pshadow_Pstandard_CClass**, [1 x i32] }, %_Pshadow_Pstandard_CString*, %_Pshadow_Pstandard_CClass*  }
...
define noalias %_Pshadow_Pstandard_CObject* @_Pshadow_Pstandard_CAbstractClass_Mallocate(%_Pshadow_Pstandard_CAbstractClass*) {
	%2 = getelementptr inbounds %_Pshadow_Pstandard_CAbstractClass* %0, i32 0, i32 6
	%3 = load i32* %2
...
_label0:
	%7 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CAbstractClass_Mallocate"(%"_Pshadow_Pstandard_CAbstractClass"* getelementptr (%"_Pshadow_Pstandard_COutOfMemoryException_Mclass"* @"_Pshadow_Pstandard_COutOfMemoryException_Mclass", i32 0, i32 0))
...
define noalias %_Pshadow_Pstandard_CObject* @_Pshadow_Pstandard_CAbstractClass_Mallocate_Pshadow_Pstandard_Cint(%_Pshadow_Pstandard_CClass*, i32) {
	%3 = getelementptr inbounds %_Pshadow_Pstandard_CAbstractClass* %0, i32 0, i32 6
	%4 = load i32* %3
