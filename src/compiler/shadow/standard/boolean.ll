...
@"_Pshadow_Pstandard_Cboolean_Mclass" = constant %"_Pshadow_Pstandard_Cboolean_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([0 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 0] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([0 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 0] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cboolean"* getelementptr (%"_Pshadow_Pstandard_Cboolean"* null, i32 1) to i32), %int ptrtoint (%boolean* getelementptr (%boolean* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cboolean"* (%"_Pshadow_Pstandard_Cboolean"*)* @"_Pshadow_Pstandard_Cboolean_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cboolean"*)* @"_Pshadow_Pstandard_Cboolean_MtoString" }
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cboolean_MtoString"(%"_Pshadow_Pstandard_Cboolean"*) {
    %this = alloca %boolean
    %_temp = alloca %"_Pshadow_Pstandard_CString"*
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cboolean"* %0, i32 0, i32 1
    %3 = load %boolean* %2
    store %boolean %3, %boolean* %this
    %4 = load %boolean* %this
...
_label1:
    ...
    br label %_label2
_label2:
    %5 = load %"_Pshadow_Pstandard_CString"** %_temp
    ret %"_Pshadow_Pstandard_CString"* %5
}

define %"_Pshadow_Pstandard_Cboolean"* @"_Pshadow_Pstandard_Cboolean_Mcreate"(%"_Pshadow_Pstandard_Cboolean"*) {
    %this = alloca %boolean
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cboolean"* %0, i32 0, i32 1
    %3 = load %boolean* %2
    store %boolean %3, %boolean* %this
    %4 = load %boolean* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cboolean_Mclass"* @"_Pshadow_Pstandard_Cboolean_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cboolean"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cboolean"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cboolean_Mclass"* @"_Pshadow_Pstandard_Cboolean_Mclass", %"_Pshadow_Pstandard_Cboolean_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cboolean"* %6, i32 0, i32 1
    store %boolean %4, %boolean* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cboolean"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cboolean_Mclass"* @"_Pshadow_Pstandard_Cboolean_Mclass", %"_Pshadow_Pstandard_Cboolean_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cboolean"* %0
}
...
@_array0 = private unnamed_addr constant [7 x %ubyte] c"boolean"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([7 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 7] }, %boolean true }
...
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([5 x %byte]* @_array2, i32 0, i32 0), [1 x %int] [%int 5] }, %boolean true }
