...
define %"_Pshadow_Pstandard_Cboolean"* @"_Pshadow_Pstandard_Cboolean_Mcreate"(%"_Pshadow_Pstandard_Cboolean"*) {
    %this = alloca %boolean
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cboolean"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cboolean_Mclass"* @"_Pshadow_Pstandard_Cboolean_Mclass", %"_Pshadow_Pstandard_Cboolean_Mclass"** %2
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cboolean"* %0, i32 0, i32 1
    %4 = load %boolean* %3
    store %boolean %4, %boolean* %this
...
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([7 x %ubyte]* @_array0, i32 0, i32 0), [1 x %int] [%int 7] }, %boolean true }
...
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([5 x %ubyte]* @_array2, i32 0, i32 0), [1 x %int] [%int 5] }, %boolean true }
