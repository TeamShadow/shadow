...
@_class0 = private unnamed_addr constant { %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* } { %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Madd_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mdivide_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mmodulus_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mmultiply_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Msubtract_Pshadow_Pstandard_Cubyte" }
@_class1 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* } { %int (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mcompare_Pshadow_Pstandard_Cubyte" }
@_interfaceData = private unnamed_addr constant [2 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)*, %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* }* @_class1 to %"_Pshadow_Pstandard_CObject"*)]
...
@"_Pshadow_Pstandard_Cubyte_Mclass" = constant %"_Pshadow_Pstandard_Cubyte_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 2] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 2] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cubyte"* getelementptr (%"_Pshadow_Pstandard_Cubyte"* null, i32 1) to i32), %int ptrtoint (%ubyte* getelementptr (%ubyte* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cubyte"* (%"_Pshadow_Pstandard_Cubyte"*)* @"_Pshadow_Pstandard_Cubyte_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cubyte"*)* @"_Pshadow_Pstandard_Cubyte_MtoString", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Madd_Pshadow_Pstandard_Cubyte", %int (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mcompare_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mdivide_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mmodulus_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mmultiply_Pshadow_Pstandard_Cubyte", %ubyte (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Msubtract_Pshadow_Pstandard_Cubyte", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cubyte"*, %ubyte)* @"_Pshadow_Pstandard_Cubyte_MtoString_Pshadow_Pstandard_Cubyte" }
...
define %code @"_Pshadow_Pstandard_Cubyte_Mdigit_Pshadow_Pstandard_Cubyte"(%"_Pshadow_Pstandard_Cubyte"*, %ubyte) {
    %this = alloca %ubyte
    %digit = alloca %ubyte
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"* %0, i32 0, i32 1
    %4 = load %ubyte* %3
    store %ubyte %4, %ubyte* %this
    store %ubyte %1, %ubyte* %digit
    %5 = load %ubyte* %digit
    %6 = icmp ult %ubyte %5, 10
    br %boolean %6, label %_label0, label %_label1
_label0:
    %7 = load %ubyte* %digit
    %8 = sext %ubyte %7 to %int
    %9 = bitcast %code 48 to %int
    %10 = add %int %8, %9
    %11 = bitcast %int %10 to %code
    ret %code %11
    br label %_label2
_label1:
    br label %_label2
_label2:
    %13 = load %ubyte* %digit
    %14 = sext %ubyte %13 to %int
    %15 = sext %ubyte 10 to %int
    %16 = sub %int %14, %15
    %17 = bitcast %code 97 to %int
    %18 = add %int %16, %17
    %19 = bitcast %int %18 to %code
    ret %code %19
}
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cubyte_MtoString"(%"_Pshadow_Pstandard_Cubyte"*) {
    %this = alloca %ubyte
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"* %0, i32 0, i32 1
    %3 = load %ubyte* %2
    store %ubyte %3, %ubyte* %this
    %4 = load %ubyte* %this
    %5 = load %ubyte* %this
    %6 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0))
    %7 = bitcast %"_Pshadow_Pstandard_CObject"*%6 to %"_Pshadow_Pstandard_Cubyte"*
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"*%7, i32 0, i32 1
    store %ubyte %5, %ubyte* %8
    %9 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cubyte_MtoString_Pshadow_Pstandard_Cubyte"(%"_Pshadow_Pstandard_Cubyte"* %7, %ubyte 10)
    ret %"_Pshadow_Pstandard_CString"* %9
}

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cubyte_MtoString_Pshadow_Pstandard_Cubyte"(%"_Pshadow_Pstandard_Cubyte"*, %ubyte) {
    %this = alloca %ubyte
    %base = alloca %ubyte
...
_label3:
    ...
    %17 = urem %ubyte %15, %16
    %18 = load %ubyte* %this
    %19 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0))
    %20 = bitcast %"_Pshadow_Pstandard_CObject"*%19 to %"_Pshadow_Pstandard_Cubyte"*
    %21 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"*%20, i32 0, i32 1
    store %ubyte %18, %ubyte* %21
    %22 = call %code @"_Pshadow_Pstandard_Cubyte_Mdigit_Pshadow_Pstandard_Cubyte"(%"_Pshadow_Pstandard_Cubyte"* %20, %ubyte %17)
    ...
    %30 = load %ubyte* %base
    %31 = udiv %ubyte %29, %30
    store %ubyte %31, %ubyte* %value
    br label %_label4
_label4:
    %32 = load %ubyte* %value
    %33 = icmp eq %ubyte %32, 0
    %34 = xor %boolean %33, true
    br %boolean %34, label %_label3, label %_label5
_label5:
...
define %"_Pshadow_Pstandard_Cubyte"* @"_Pshadow_Pstandard_Cubyte_Mcreate"(%"_Pshadow_Pstandard_Cubyte"*) {
    %this = alloca %ubyte
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"* %0, i32 0, i32 1
    %3 = load %ubyte* %2
    store %ubyte %3, %ubyte* %this
    %4 = load %ubyte* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cubyte"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", %"_Pshadow_Pstandard_Cubyte_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"* %6, i32 0, i32 1
    store %ubyte %4, %ubyte* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", %"_Pshadow_Pstandard_Cubyte_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cubyte"* %0
}
...
@_array0 = private unnamed_addr constant [5 x %ubyte] c"ubyte"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([5 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 5] }, %boolean true }
