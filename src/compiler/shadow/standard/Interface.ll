...
@"_Pshadow_Pstandard_CInterface_Mclass" = global %"_Pshadow_Pstandard_CInterface_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Pstandard_CInterface"* getelementptr (%"_Pshadow_Pstandard_CInterface"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Pstandard_CInterface"** getelementptr (%"_Pshadow_Pstandard_CInterface"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_CInterface"* (%"_Pshadow_Pstandard_CInterface"*)* @"_Pshadow_Pstandard_CInterface_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CInterface"*)* @"_Pshadow_Pstandard_CInterface_MtoString", %boolean (%"_Pshadow_Pstandard_CInterface"*, %"_Pshadow_Pstandard_CInterface"*)* @"_Pshadow_Pstandard_CInterface_MisSubtype_Pshadow_Pstandard_CInterface" }
...
define %boolean @"_Pshadow_Pstandard_CInterface_MisSubtype_Pshadow_Pstandard_CInterface"(%"_Pshadow_Pstandard_CInterface"*, %"_Pshadow_Pstandard_CInterface"*) {
...
_label11:
    ...
    %17 = call %boolean @"_Pshadow_Pstandard_CInterface_MisSubtype_Pshadow_Pstandard_CInterface"(%"_Pshadow_Pstandard_CInterface"* %15, %"_Pshadow_Pstandard_CInterface"* %16)
    br %boolean %17, label %_label8, label %_label9
_label8:
    ret %boolean true
    br label %_label10
_label9:
...
_label7:
    ...
    br label %_label4
_label4:
    %21 = load %"_Pshadow_Pstandard_CInterface"** %this
    %22 = getelementptr inbounds %"_Pshadow_Pstandard_CInterface"* %21, i32 0, i32 1
    %23 = load { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] }* %22
    %24 = load %int* %i
    %25 = extractvalue { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } %23, 1
    ...
    %30 = extractvalue { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } %23, 0
    %31 = bitcast %"_Pshadow_Pstandard_CInterface"** %30 to %"_Pshadow_Pstandard_CObject"*
    ...
    %34 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_CT"(%"_Pshadow_Pstandard_CArray"* %33, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CInterface_Mclass"* @"_Pshadow_Pstandard_CInterface_Mclass", i32 0, i32 0), { %int*, [1 x %int] } %29, %"_Pshadow_Pstandard_CObject"* %31)
    %35 = getelementptr %"_Pshadow_Pstandard_CArray"* %34, i32 0, i32 0
    %36 = load %"_Pshadow_Pstandard_CArray_Mclass"** %35
    %37 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %36, i32 0, i32 12
    %38 = load %int (%"_Pshadow_Pstandard_CArray"*)** %37
    %39 = call %int %38(%"_Pshadow_Pstandard_CArray"* %34)
    %40 = icmp slt %int %24, %39
    br %boolean %40, label %_label3, label %_label5
_label5:
    ret %boolean false
}
...
define %"_Pshadow_Pstandard_CInterface"* @"_Pshadow_Pstandard_CInterface_Mcreate"(%"_Pshadow_Pstandard_CInterface"*) {
    %this = alloca %"_Pshadow_Pstandard_CInterface"*
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_CInterface"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CInterface_Mclass"* @"_Pshadow_Pstandard_CInterface_Mclass", %"_Pshadow_Pstandard_CInterface_Mclass"** %2
    store %"_Pshadow_Pstandard_CInterface"* %0, %"_Pshadow_Pstandard_CInterface"** %this
    %3 = load %"_Pshadow_Pstandard_CInterface"** %this
    %4 = getelementptr inbounds %"_Pshadow_Pstandard_CInterface"* %3, i32 0, i32 2
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %4
    %5 = load %"_Pshadow_Pstandard_CInterface"** %this
    %6 = getelementptr inbounds %"_Pshadow_Pstandard_CInterface"* %5, i32 0, i32 1
    %7 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CInterface_Mclass"* @"_Pshadow_Pstandard_CInterface_Mclass", i32 0, i32 0), %int 0)
    %8 = bitcast %"_Pshadow_Pstandard_CObject"* %7 to %"_Pshadow_Pstandard_CInterface"**
    %9 = insertvalue { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } undef, %"_Pshadow_Pstandard_CInterface"** %8, 0
    %10 = insertvalue { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } %9, %int 0, 1, 0
    store { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } %10, { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] }* %6
    ret %"_Pshadow_Pstandard_CInterface"* %0
}
