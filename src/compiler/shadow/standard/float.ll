...
%"_Pshadow_Pstandard_CException" = type { %"_Pshadow_Pstandard_CException_Mclass"*, %float, %float }
...
%"_Pshadow_Pstandard_CString_IStringIterator" = type { %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"*, %float, %float }
...
%"_Pshadow_Pstandard_CObject" = type { %"_Pshadow_Pstandard_CObject_Mclass"*, %float, %float }

@_class0 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cfloat"*, %float)* } { %int (%"_Pshadow_Pstandard_Cfloat"*, %float)* @"_Pshadow_Pstandard_Cfloat_Mcompare_Pshadow_Pstandard_Cfloat" }
@_interfaceData = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cfloat"*, %float)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*)]
@_interfaces = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CClass"*] [%"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CCanCompare_Mclass"]
@"_Pshadow_Pstandard_Cfloat_Mclass" = constant %"_Pshadow_Pstandard_Cfloat_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 1] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 1] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cfloat"* getelementptr (%"_Pshadow_Pstandard_Cfloat"* null, i32 1) to i32), %int ptrtoint (%float* getelementptr (%float* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cfloat"* (%"_Pshadow_Pstandard_Cfloat"*)* @"_Pshadow_Pstandard_Cfloat_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %float (%"_Pshadow_Pstandard_Cfloat"*, %float)* @"_Pshadow_Pstandard_Cfloat_Madd_Pshadow_Pstandard_Cfloat", %int (%"_Pshadow_Pstandard_Cfloat"*, %float)* @"_Pshadow_Pstandard_Cfloat_Mcompare_Pshadow_Pstandard_Cfloat", %float (%"_Pshadow_Pstandard_Cfloat"*, %float)* @"_Pshadow_Pstandard_Cfloat_Mdivide_Pshadow_Pstandard_Cfloat", %float (%"_Pshadow_Pstandard_Cfloat"*, %float)* @"_Pshadow_Pstandard_Cfloat_Mmodulus_Pshadow_Pstandard_Cfloat", %float (%"_Pshadow_Pstandard_Cfloat"*, %float)* @"_Pshadow_Pstandard_Cfloat_Mmultiply_Pshadow_Pstandard_Cfloat", %float (%"_Pshadow_Pstandard_Cfloat"*, %float)* @"_Pshadow_Pstandard_Cfloat_Msubtract_Pshadow_Pstandard_Cfloat" }
...
define %"_Pshadow_Pstandard_Cfloat"* @"_Pshadow_Pstandard_Cfloat_Mcreate"(%"_Pshadow_Pstandard_Cfloat"*) {
    %this = alloca %float
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cfloat"* %0, i32 0, i32 1
    %3 = load %float* %2
    store %float %3, %float* %this
    %4 = load %float* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cfloat_Mclass"* @"_Pshadow_Pstandard_Cfloat_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cfloat"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cfloat"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cfloat_Mclass"* @"_Pshadow_Pstandard_Cfloat_Mclass", %"_Pshadow_Pstandard_Cfloat_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cfloat"* %6, i32 0, i32 1
    store %float %4, %float* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cfloat"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cfloat_Mclass"* @"_Pshadow_Pstandard_Cfloat_Mclass", %"_Pshadow_Pstandard_Cfloat_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cfloat"* %0
}
...
@_array0 = private unnamed_addr constant [5 x %ubyte] c"float"
