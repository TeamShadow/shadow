...
define void @"shadow.standard!Array!!constructor!long!long[]"(%"shadow.standard!Array"*, %long, { %long*, [1 x %long] }) {
    ...
    %7 = getelementptr inbounds %"shadow.standard!Array"* %6, i32 0, i32 1
    %8 = sext %int 0 to %long
    store %long %8, %long* %7
    %9 = load %"shadow.standard!Array"** %this
    %10 = getelementptr inbounds %"shadow.standard!Array"* %9, i32 0, i32 2
    %11 = sext %int 0 to %long
    %12 = call noalias i8* @calloc(i64 %11, i64 ptrtoint (%long* getelementptr(%long* null, i32 1) to i64))
    %13 = bitcast i8* %12 to %long*
    %14 = insertvalue { %long*, [1 x %long] } undef, %long* %13, 0
    %15 = insertvalue { %long*, [1 x %long] } %14, %long %11, 1, 0
    store { %long*, [1 x %long] } %15, { %long*, [1 x %long] }* %10
    %16 = load %"shadow.standard!Array"** %this
