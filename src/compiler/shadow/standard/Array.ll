...
_label1:
    ...
    %34 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %33, i32 0, i32 13
...
declare %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CArray_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CArray"*, %int)
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CArray_MtoString"(%"_Pshadow_Pstandard_CArray"*) {
    ...
    %5 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %4, i32 0, i32 12
...
_label5:
    ...
    %13 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %11, i32 0, i32 0
    %14 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %13
    %15 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %14, i32 0, i32 11
    %16 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)** %15
    %17 = call %"_Pshadow_Pstandard_CMutableString"* %16(%"_Pshadow_Pstandard_CMutableString"* %11, %"_Pshadow_Pstandard_CObject"* %12)
    %18 = load %"_Pshadow_Pstandard_CArray"** %this
    %19 = getelementptr %"_Pshadow_Pstandard_CArray"* %18, i32 0, i32 0
    %20 = load %"_Pshadow_Pstandard_CArray_Mclass"** %19
    %21 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %20, i32 0, i32 10
    %22 = load %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CArray"*, %int)** %21
    %23 = call %"_Pshadow_Pstandard_CObject"* %22(%"_Pshadow_Pstandard_CArray"* %18, %int 0)
    %24 = bitcast %"_Pshadow_Pstandard_CObject"* %23 to %"_Pshadow_Pstandard_CObject"*
    %25 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %11, i32 0, i32 0
    %26 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %25
    %27 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %26, i32 0, i32 8
    %28 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)** %27
    %29 = call %"_Pshadow_Pstandard_CMutableString"* %28(%"_Pshadow_Pstandard_CMutableString"* %11, %"_Pshadow_Pstandard_CObject"* %24)
    store %"_Pshadow_Pstandard_CMutableString"* %29, %"_Pshadow_Pstandard_CMutableString"** %string
    store %int 1, %int* %i
    br label %_label7
_label6:
    ...
    %32 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %30, i32 0, i32 0
    %33 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %32
    %34 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %33, i32 0, i32 8
    %35 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)** %34
    %36 = call %"_Pshadow_Pstandard_CMutableString"* %35(%"_Pshadow_Pstandard_CMutableString"* %30, %"_Pshadow_Pstandard_CObject"* %31)
    %37 = load %"_Pshadow_Pstandard_CArray"** %this
    %38 = load %int* %i
    %39 = getelementptr %"_Pshadow_Pstandard_CArray"* %37, i32 0, i32 0
    %40 = load %"_Pshadow_Pstandard_CArray_Mclass"** %39
    %41 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %40, i32 0, i32 10
    %42 = load %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CArray"*, %int)** %41
    %43 = call %"_Pshadow_Pstandard_CObject"* %42(%"_Pshadow_Pstandard_CArray"* %37, %int %38)
    %44 = bitcast %"_Pshadow_Pstandard_CObject"* %43 to %"_Pshadow_Pstandard_CObject"*
    %45 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %36, i32 0, i32 0
    %46 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %45
    %47 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %46, i32 0, i32 8
    %48 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)** %47
    %49 = call %"_Pshadow_Pstandard_CMutableString"* %48(%"_Pshadow_Pstandard_CMutableString"* %36, %"_Pshadow_Pstandard_CObject"* %44)
    %50 = load %int* %i
    %51 = add %int %50, 1
    store %int %51, %int* %i
    br label %_label7
_label7:
    ...
    %53 = load %int* %i
    %54 = getelementptr %"_Pshadow_Pstandard_CArray"* %52, i32 0, i32 0
    %55 = load %"_Pshadow_Pstandard_CArray_Mclass"** %54
    %56 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %55, i32 0, i32 12
    %57 = load %int (%"_Pshadow_Pstandard_CArray"*)** %56
    %58 = call %int %57(%"_Pshadow_Pstandard_CArray"* %52)
    %59 = icmp slt %int %53, %58
    br %boolean %59, label %_label6, label %_label8
_label8:
    %60 = load %"_Pshadow_Pstandard_CMutableString"** %string
    %61 = bitcast %"_Pshadow_Pstandard_CString"* @_string4 to %"_Pshadow_Pstandard_CObject"*
    %62 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %60, i32 0, i32 0
    %63 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %62
    %64 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %63, i32 0, i32 8
    %65 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)** %64
    %66 = call %"_Pshadow_Pstandard_CMutableString"* %65(%"_Pshadow_Pstandard_CMutableString"* %60, %"_Pshadow_Pstandard_CObject"* %61)
    %67 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %66, i32 0, i32 0
    %68 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %67
    %69 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %68, i32 0, i32 7
    %70 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CMutableString"*)** %69
    %71 = call %"_Pshadow_Pstandard_CString"* %70(%"_Pshadow_Pstandard_CMutableString"* %66)
    ret %"_Pshadow_Pstandard_CString"* %71
}
...
define %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1"(%"_Pshadow_Pstandard_CArray"*, %"_Pshadow_Pstandard_CClass"*, { %int*, [1 x %int] }) {
    ...
    %42 = load %"_Pshadow_Pstandard_CArray"** %this
    %43 = getelementptr %"_Pshadow_Pstandard_CArray"* %41, i32 0, i32 0
    %44 = load %"_Pshadow_Pstandard_CArray_Mclass"** %43
    %45 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %44, i32 0, i32 12
    %46 = load %int (%"_Pshadow_Pstandard_CArray"*)** %45
    %47 = call %int %46(%"_Pshadow_Pstandard_CArray"* %41)
    %48 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CArray_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CArray"* %42, %int %47)
    %49 = load %"_Pshadow_Pstandard_CArray"** %this
    %50 = getelementptr inbounds %"_Pshadow_Pstandard_CArray"* %49, i32 0, i32 3
    store %"_Pshadow_Pstandard_CObject"* %48, %"_Pshadow_Pstandard_CObject"** %50
    ret %"_Pshadow_Pstandard_CArray"* %0
}
...
define %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcopy"(%"_Pshadow_Pstandard_CArray"*) {
    ...
    %8 = load %"_Pshadow_Pstandard_CArray"** %this
    %9 = getelementptr %"_Pshadow_Pstandard_CArray"* %7, i32 0, i32 0
    %10 = load %"_Pshadow_Pstandard_CArray_Mclass"** %9
    %11 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %10, i32 0, i32 12
    %12 = load %int (%"_Pshadow_Pstandard_CArray"*)** %11
    %13 = call %int %12(%"_Pshadow_Pstandard_CArray"* %7)
    %14 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CArray_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CArray"* %8, %int %13)
    %15 = load %"_Pshadow_Pstandard_CClass"** %5
    %16 = getelementptr %"_Pshadow_Pstandard_CArray"* %6, i32 0, i32 0
    %17 = load %"_Pshadow_Pstandard_CArray_Mclass"** %16
    %18 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %17, i32 0, i32 13
    %19 = load { %int*, [1 x %int] } (%"_Pshadow_Pstandard_CArray"*)** %18
    %20 = call { %int*, [1 x %int] } %19(%"_Pshadow_Pstandard_CArray"* %6)
    %21 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CArray"* %3, %"_Pshadow_Pstandard_CClass"* %15, { %int*, [1 x %int] } %20, %"_Pshadow_Pstandard_CObject"* %14)
...
_label9:
    ...
    %23 = load %int* %i
    %24 = getelementptr %"_Pshadow_Pstandard_CArray"* %22, i32 0, i32 0
    %25 = load %"_Pshadow_Pstandard_CArray_Mclass"** %24
    %26 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %25, i32 0, i32 10
    %27 = load %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CArray"*, %int)** %26
    %28 = call %"_Pshadow_Pstandard_CObject"* %27(%"_Pshadow_Pstandard_CArray"* %22, %int %23)
    %29 = load %"_Pshadow_Pstandard_CArray"** %copy
    %30 = load %int* %i
    %31 = getelementptr %"_Pshadow_Pstandard_CArray"* %29, i32 0, i32 0
    %32 = load %"_Pshadow_Pstandard_CArray_Mclass"** %31
    %33 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %32, i32 0, i32 11
    %34 = load void (%"_Pshadow_Pstandard_CArray"*, %int, %"_Pshadow_Pstandard_CObject"*)** %33
    call void %34(%"_Pshadow_Pstandard_CArray"* %29, %int %30, %"_Pshadow_Pstandard_CObject"* %28)
    %35 = load %int* %i
    %36 = add %int %35, 1
    store %int %36, %int* %i
    br label %_label10
_label10:
    ...
    %39 = getelementptr %"_Pshadow_Pstandard_CArray"* %37, i32 0, i32 0
    %40 = load %"_Pshadow_Pstandard_CArray_Mclass"** %39
    %41 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %40, i32 0, i32 12
    %42 = load %int (%"_Pshadow_Pstandard_CArray"*)** %41
    %43 = call %int %42(%"_Pshadow_Pstandard_CArray"* %37)
    %44 = icmp slt %int %38, %43
    br %boolean %44, label %_label9, label %_label11
_label11:
    %45 = load %"_Pshadow_Pstandard_CArray"** %copy
    ret %"_Pshadow_Pstandard_CArray"* %45
}
