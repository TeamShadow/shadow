...
%"_Pshadow_Pstandard_CException" = type { %"_Pshadow_Pstandard_CException_Mclass"*, %"_Pshadow_Pstandard_CClass"*, %"_Pshadow_Pstandard_CObject"* }
...
%"_Pshadow_Pstandard_CString_IStringIterator" = type { %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"*, %"_Pshadow_Pstandard_CClass"*, %"_Pshadow_Pstandard_CObject"* }
...
%"_Pshadow_Pstandard_CObject" = type { %"_Pshadow_Pstandard_CObject_Mclass"*, %"_Pshadow_Pstandard_CClass"*, %"_Pshadow_Pstandard_CObject"* }
...
define %"_Pshadow_Pstandard_CReference"* @"_Pshadow_Pstandard_CReference_Mcreate"(%"_Pshadow_Pstandard_CReference"*, %"_Pshadow_Pstandard_CClass"*) {
    ...
    %3 = load %"_Pshadow_Pstandard_CReference"** %this
    %4 = bitcast %"_Pshadow_Pstandard_CReference"* %3 to %"_Pshadow_Pstandard_CObject"*
    %5 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %4)
    %6 = getelementptr inbounds %"_Pshadow_Pstandard_CReference"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CReference_Mclass"* @"_Pshadow_Pstandard_CReference_Mclass", %"_Pshadow_Pstandard_CReference_Mclass"** %6
    %7 = load %"_Pshadow_Pstandard_CReference"** %this
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_CReference"* %7, i32 0, i32 1
    ...
    store %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CObject"** %11
...
define %"_Pshadow_Pstandard_CReference"* @"_Pshadow_Pstandard_CReference_Mcreate_CT"(%"_Pshadow_Pstandard_CReference"*, %"_Pshadow_Pstandard_CClass"*, %"_Pshadow_Pstandard_CObject"*) {
    ...
    %5 = bitcast %"_Pshadow_Pstandard_CReference"* %4 to %"_Pshadow_Pstandard_CObject"*
    %6 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_CReference"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CReference_Mclass"* @"_Pshadow_Pstandard_CReference_Mclass", %"_Pshadow_Pstandard_CReference_Mclass"** %7
    %8 = load %"_Pshadow_Pstandard_CReference"** %this
    %9 = getelementptr inbounds %"_Pshadow_Pstandard_CReference"* %8, i32 0, i32 1
    %10 = load %"_Pshadow_Pstandard_CClass"** %T
    store %"_Pshadow_Pstandard_CClass"* %10, %"_Pshadow_Pstandard_CClass"** %9
    %11 = load %"_Pshadow_Pstandard_CReference"** %this
    %12 = getelementptr inbounds %"_Pshadow_Pstandard_CReference"* %11, i32 0, i32 2
    store %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CObject"** %12
    %13 = load %"_Pshadow_Pstandard_CReference"** %this
    %14 = getelementptr inbounds %"_Pshadow_Pstandard_CReference"* %13, i32 0, i32 2
    %15 = load %"_Pshadow_Pstandard_CObject"** %value
    store %"_Pshadow_Pstandard_CObject"* %15, %"_Pshadow_Pstandard_CObject"** %14
    ret %"_Pshadow_Pstandard_CReference"* %0
}
