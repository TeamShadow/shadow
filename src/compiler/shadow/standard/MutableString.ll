...
%"_Pshadow_Pstandard_CMutableString_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CMutableString"*)*, %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)*, %int (%"_Pshadow_Pstandard_CMutableString"*)*, %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %int)*, %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %int)*, %int (%"_Pshadow_Pstandard_CMutableString"*)* }
%"_Pshadow_Pstandard_CMutableString" = type { %"_Pshadow_Pstandard_CMutableString_Mclass"*, { %ubyte*, [1 x %int] }, %int }
...
_label2:
    ...
    %19 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %18, i32 0, i32 15
...
_label4:
    ...
    %50 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %49, i32 0, i32 15
...
define %int @"_Pshadow_Pstandard_CMutableString_Mlength"(%"_Pshadow_Pstandard_CMutableString"*) {
    %this = alloca %"_Pshadow_Pstandard_CMutableString"*
    store %"_Pshadow_Pstandard_CMutableString"* %0, %"_Pshadow_Pstandard_CMutableString"** %this
...
define %"_Pshadow_Pstandard_CMutableString"* @"_Pshadow_Pstandard_CMutableString_MensureCapacity_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CMutableString"*, %int) {
    ...
    %4 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %3, i32 0, i32 1
    %5 = load { %ubyte*, [1 x %int] }* %4
    %6 = extractvalue { %ubyte*, [1 x %int] } %5, 1
    %7 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int 1)
    %8 = bitcast %"_Pshadow_Pstandard_CObject"* %7 to [1 x %int]*
    store [1 x %int] %6, [1 x %int]* %8
    %9 = getelementptr inbounds [1 x %int]* %8, i32 0, i32 0
    %10 = insertvalue { %int*, [1 x %int] } { %int* null, [1 x %int] [%int 1] }, %int* %9, 0
    %11 = extractvalue { %ubyte*, [1 x %int] } %5, 0
    %12 = bitcast %ubyte* %11 to %"_Pshadow_Pstandard_CObject"*
    %13 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CArray_Mclass"* @"_Pshadow_Pstandard_CArray_Mclass", i32 0, i32 0))
    %14 = bitcast %"_Pshadow_Pstandard_CObject"* %13 to %"_Pshadow_Pstandard_CArray"*
    %15 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_CT"(%"_Pshadow_Pstandard_CArray"* %14, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0), { %int*, [1 x %int] } %10, %"_Pshadow_Pstandard_CObject"* %12)
    %16 = getelementptr %"_Pshadow_Pstandard_CArray"* %15, i32 0, i32 0
    %17 = load %"_Pshadow_Pstandard_CArray_Mclass"** %16
    %18 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %17, i32 0, i32 12
    %19 = load %int (%"_Pshadow_Pstandard_CArray"*)** %18
    %20 = call %int %19(%"_Pshadow_Pstandard_CArray"* %15)
    %21 = load %int* %length
    %22 = icmp slt %int %20, %21
    br %boolean %22, label %_label6, label %_label7
_label6:
    %23 = load %int* %length
    %24 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0), %int %23)
    %25 = bitcast %"_Pshadow_Pstandard_CObject"* %24 to %ubyte*
    %26 = insertvalue { %ubyte*, [1 x %int] } undef, %ubyte* %25, 0
    %27 = insertvalue { %ubyte*, [1 x %int] } %26, %int %23, 1, 0
    store { %ubyte*, [1 x %int] } %27, { %ubyte*, [1 x %int] }* %data
    store %int 0, %int* %i
    br label %_label10
_label9:
    %28 = load %"_Pshadow_Pstandard_CMutableString"** %this
    %29 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %28, i32 0, i32 1
    %30 = load { %ubyte*, [1 x %int] }* %29
    %31 = load %int* %i
    %32 = extractvalue { %ubyte*, [1 x %int] } %30, 0
    %33 = getelementptr inbounds %ubyte* %32, %int %31
    %34 = load { %ubyte*, [1 x %int] }* %data
    %35 = load %int* %i
    %36 = extractvalue { %ubyte*, [1 x %int] } %34, 0
    %37 = getelementptr inbounds %ubyte* %36, %int %35
    %38 = load %ubyte* %33
    store %ubyte %38, %ubyte* %37
    %39 = load %int* %i
    %40 = add %int %39, 1
    store %int %40, %int* %i
    br label %_label10
_label10:
    ...
    %43 = load %int* %length
    %44 = load %int* %42
    %45 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %46 = bitcast %"_Pshadow_Pstandard_CObject"*%45 to %"_Pshadow_Pstandard_Cint"*
    %47 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%46, i32 0, i32 1
    store %int %43, %int* %47
    %48 = call %int @"_Pshadow_Pstandard_Cint_Mmin_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_Cint"* %46, %int %44)
    %49 = load %int* %i
    %50 = icmp slt %int %49, %48
    br %boolean %50, label %_label9, label %_label11
_label11:
    %51 = load %"_Pshadow_Pstandard_CMutableString"** %this
    %52 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %51, i32 0, i32 1
    %53 = load { %ubyte*, [1 x %int] }* %data
    store { %ubyte*, [1 x %int] } %53, { %ubyte*, [1 x %int] }* %52
    br label %_label8
_label7:
    br label %_label8
_label8:
...
define %int @"_Pshadow_Pstandard_CMutableString_Mcapacity"(%"_Pshadow_Pstandard_CMutableString"*) {
    ...
    %14 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_CT"(%"_Pshadow_Pstandard_CArray"* %13, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0), { %int*, [1 x %int] } %9, %"_Pshadow_Pstandard_CObject"* %11)
...
_label13:
    ...
    %23 = load %int* %i
    %24 = extractvalue { %ubyte*, [1 x %int] } %22, 1
    ...
    %29 = extractvalue { %ubyte*, [1 x %int] } %22, 0
    %30 = bitcast %ubyte* %29 to %"_Pshadow_Pstandard_CObject"*
    ...
    %33 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_CT"(%"_Pshadow_Pstandard_CArray"* %32, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0), { %int*, [1 x %int] } %28, %"_Pshadow_Pstandard_CObject"* %30)
    %34 = getelementptr %"_Pshadow_Pstandard_CArray"* %33, i32 0, i32 0
    %35 = load %"_Pshadow_Pstandard_CArray_Mclass"** %34
    %36 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %35, i32 0, i32 12
    %37 = load %int (%"_Pshadow_Pstandard_CArray"*)** %36
    %38 = call %int %37(%"_Pshadow_Pstandard_CArray"* %33)
    %39 = icmp slt %int %23, %38
    br %boolean %39, label %_label12, label %_label14
_label14:
    %40 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", i32 0, i32 0))
    %41 = bitcast %"_Pshadow_Pstandard_CObject"* %40 to %"_Pshadow_Pstandard_CString"*
    %42 = load { %ubyte*, [1 x %int] }* %data
    %43 = getelementptr %"_Pshadow_Pstandard_CString"* %41, i32 0, i32 0
    %44 = load %"_Pshadow_Pstandard_CString_Mclass"** %43
    %45 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %44, i32 0, i32 10
    %46 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, { %ubyte*, [1 x %int] })** %45
    %47 = call %"_Pshadow_Pstandard_CString"* %46(%"_Pshadow_Pstandard_CString"* %41, { %ubyte*, [1 x %int] } %42)
    ret %"_Pshadow_Pstandard_CString"* %41
}

define %"_Pshadow_Pstandard_CMutableString"* @"_Pshadow_Pstandard_CMutableString_Mcreate"(%"_Pshadow_Pstandard_CMutableString"*) {
    %this = alloca %"_Pshadow_Pstandard_CMutableString"*
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CMutableString_Mclass"* @"_Pshadow_Pstandard_CMutableString_Mclass", %"_Pshadow_Pstandard_CMutableString_Mclass"** %2
    store %"_Pshadow_Pstandard_CMutableString"* %0, %"_Pshadow_Pstandard_CMutableString"** %this
    %3 = load %"_Pshadow_Pstandard_CMutableString"** %this
    %4 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %3, i32 0, i32 1
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0), %int 10)
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %ubyte*
    %7 = insertvalue { %ubyte*, [1 x %int] } undef, %ubyte* %6, 0
    %8 = insertvalue { %ubyte*, [1 x %int] } %7, %int 10, 1, 0
    store { %ubyte*, [1 x %int] } %8, { %ubyte*, [1 x %int] }* %4
    %9 = load %"_Pshadow_Pstandard_CMutableString"** %this
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %9, i32 0, i32 2
    store %int 0, %int* %10
...
define %"_Pshadow_Pstandard_CMutableString"* @"_Pshadow_Pstandard_CMutableString_Mcreate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CMutableString"*, %int) {
    %this = alloca %"_Pshadow_Pstandard_CMutableString"*
    %initialLength = alloca %int
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_CMutableString_Mclass"* @"_Pshadow_Pstandard_CMutableString_Mclass", %"_Pshadow_Pstandard_CMutableString_Mclass"** %3
    store %"_Pshadow_Pstandard_CMutableString"* %0, %"_Pshadow_Pstandard_CMutableString"** %this
    store %int %1, %int* %initialLength
    %4 = load %"_Pshadow_Pstandard_CMutableString"** %this
    %5 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %4, i32 0, i32 1
    %6 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0), %int 10)
    %7 = bitcast %"_Pshadow_Pstandard_CObject"* %6 to %ubyte*
    %8 = insertvalue { %ubyte*, [1 x %int] } undef, %ubyte* %7, 0
    %9 = insertvalue { %ubyte*, [1 x %int] } %8, %int 10, 1, 0
    store { %ubyte*, [1 x %int] } %9, { %ubyte*, [1 x %int] }* %5
    %10 = load %"_Pshadow_Pstandard_CMutableString"** %this
    %11 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %10, i32 0, i32 2
    store %int 0, %int* %11
    %12 = load %int* %initialLength
    %13 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0), %int %12)
    %14 = bitcast %"_Pshadow_Pstandard_CObject"* %13 to %ubyte*
    %15 = insertvalue { %ubyte*, [1 x %int] } undef, %ubyte* %14, 0
    %16 = insertvalue { %ubyte*, [1 x %int] } %15, %int %12, 1, 0
    %17 = load %"_Pshadow_Pstandard_CMutableString"** %this
    %18 = getelementptr inbounds %"_Pshadow_Pstandard_CMutableString"* %17, i32 0, i32 1
    store { %ubyte*, [1 x %int] } %16, { %ubyte*, [1 x %int] }* %18
    ret %"_Pshadow_Pstandard_CMutableString"* %0
}
...
define %"_Pshadow_Pstandard_CMutableString"* @"_Pshadow_Pstandard_CMutableString_Mcreate_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*) {
    ...
    %13 = load %"_Pshadow_Pstandard_CObject"** %initialValue
    %14 = getelementptr %"_Pshadow_Pstandard_CMutableString"* %12, i32 0, i32 0
    %15 = load %"_Pshadow_Pstandard_CMutableString_Mclass"** %14
    %16 = getelementptr %"_Pshadow_Pstandard_CMutableString_Mclass"* %15, i32 0, i32 8
    %17 = load %"_Pshadow_Pstandard_CMutableString"* (%"_Pshadow_Pstandard_CMutableString"*, %"_Pshadow_Pstandard_CObject"*)** %16
    %18 = call %"_Pshadow_Pstandard_CMutableString"* %17(%"_Pshadow_Pstandard_CMutableString"* %12, %"_Pshadow_Pstandard_CObject"* %13)
    ret %"_Pshadow_Pstandard_CMutableString"* %0
}
...
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([29 x %ubyte]* @_array0, i32 0, i32 0), [1 x %int] [%int 29] } }
