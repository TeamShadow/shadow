...
@"_Pshadow_Pstandard_Cushort_Mclass" = global %"_Pshadow_Pstandard_Cushort_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int 2 }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %ushort (%ushort, %ushort)* @"_Pshadow_Pstandard_Cushort_Madd_R_Pshadow_Pstandard_Cushort", %int (%ushort, %ushort)* @"_Pshadow_Pstandard_Cushort_Mcompare_R_Pshadow_Pstandard_Cushort", %ushort (%ushort, %ushort)* @"_Pshadow_Pstandard_Cushort_Mdivide_R_Pshadow_Pstandard_Cushort", %ushort (%ushort, %ushort)* @"_Pshadow_Pstandard_Cushort_Mmodulus_R_Pshadow_Pstandard_Cushort", %ushort (%ushort, %ushort)* @"_Pshadow_Pstandard_Cushort_Mmultiply_R_Pshadow_Pstandard_Cushort", %ushort (%ushort, %ushort)* @"_Pshadow_Pstandard_Cushort_Msubtract_R_Pshadow_Pstandard_Cushort" }
...
declare %ushort @"_Pshadow_Pstandard_Cushort_Msubtract_R_Pshadow_Pstandard_Cushort"(%ushort, %ushort)

declare %int @"_Pshadow_Pstandard_Cushort_Mcompare_R_Pshadow_Pstandard_Cushort"(%ushort, %ushort)

declare %ushort @"_Pshadow_Pstandard_Cushort_Mdivide_R_Pshadow_Pstandard_Cushort"(%ushort, %ushort)

declare %ushort @"_Pshadow_Pstandard_Cushort_Mmultiply_R_Pshadow_Pstandard_Cushort"(%ushort, %ushort)

declare %ushort @"_Pshadow_Pstandard_Cushort_Madd_R_Pshadow_Pstandard_Cushort"(%ushort, %ushort)

define %ushort @"_Pshadow_Pstandard_Cushort_Mcreate"(%ushort) {
    %this = alloca %ushort
    store %ushort %0, %ushort* %this
    %2 = load %ushort* %this
    ret %ushort %2
}

declare %ushort @"_Pshadow_Pstandard_Cushort_Mmodulus_R_Pshadow_Pstandard_Cushort"(%ushort, %ushort)
