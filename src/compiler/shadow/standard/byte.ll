...
@_class0 = private unnamed_addr constant { %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* } { %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Madd_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mdivide_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mmodulus_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mmultiply_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Msubtract_Pshadow_Pstandard_Cbyte" }
@_class1 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cbyte"*, %byte)* } { %int (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mcompare_Pshadow_Pstandard_Cbyte" }
@_interfaceData = private unnamed_addr constant [2 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)*, %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cbyte"*, %byte)* }* @_class1 to %"_Pshadow_Pstandard_CObject"*)]
@_interfaces = private unnamed_addr constant [2 x %"_Pshadow_Pstandard_CClass"*] [%"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CNumber_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CCanCompare_Mclass"]
@"_Pshadow_Pstandard_Cbyte_Mclass" = constant %"_Pshadow_Pstandard_Cbyte_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 2] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 2] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cbyte"* getelementptr (%"_Pshadow_Pstandard_Cbyte"* null, i32 1) to i32), %int ptrtoint (%byte* getelementptr (%byte* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cbyte"* (%"_Pshadow_Pstandard_Cbyte"*)* @"_Pshadow_Pstandard_Cbyte_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cbyte"*)* @"_Pshadow_Pstandard_Cbyte_MtoString", %ubyte (%"_Pshadow_Pstandard_Cbyte"*)* @"_Pshadow_Pstandard_Cbyte_Mabs", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Madd_Pshadow_Pstandard_Cbyte", %int (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mcompare_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mdivide_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mmax_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mmin_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mmodulus_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Mmultiply_Pshadow_Pstandard_Cbyte", %byte (%"_Pshadow_Pstandard_Cbyte"*, %byte)* @"_Pshadow_Pstandard_Cbyte_Msubtract_Pshadow_Pstandard_Cbyte", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cbyte"*, %ubyte)* @"_Pshadow_Pstandard_Cbyte_MtoString_Pshadow_Pstandard_Cubyte" }
...
define %byte @"_Pshadow_Pstandard_Cbyte_Mmin_Pshadow_Pstandard_Cbyte"(%"_Pshadow_Pstandard_Cbyte"*, %byte) {
    %this = alloca %byte
    %other = alloca %byte
    %_temp = alloca %byte
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %0, i32 0, i32 1
    %4 = load %byte* %3
    store %byte %4, %byte* %this
    store %byte %1, %byte* %other
    %5 = load %byte* %this
    %6 = load %byte* %other
    %7 = icmp slt %byte %5, %6
...
_label0:
    %8 = load %byte* %this
    store %byte %8, %byte* %_temp
    br label %_label2
_label1:
    %9 = load %byte* %other
    store %byte %9, %byte* %_temp
    br label %_label2
_label2:
    %10 = load %byte* %_temp
    ret %byte %10
...
define %byte @"_Pshadow_Pstandard_Cbyte_Mmax_Pshadow_Pstandard_Cbyte"(%"_Pshadow_Pstandard_Cbyte"*, %byte) {
    %this = alloca %byte
    %other = alloca %byte
    %_temp = alloca %byte
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %0, i32 0, i32 1
...
define %ubyte @"_Pshadow_Pstandard_Cbyte_Mabs"(%"_Pshadow_Pstandard_Cbyte"*) {
    %this = alloca %byte
    %_temp = alloca %byte
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %0, i32 0, i32 1
    %3 = load %byte* %2
    store %byte %3, %byte* %this
    %4 = load %byte* %this
    %5 = icmp slt %byte %4, 0
...
_label8:
    %9 = load %byte* %_temp
    %10 = bitcast %byte %9 to %ubyte
    ret %ubyte %10
}

declare %int @"_Pshadow_Pstandard_Cbyte_Mcompare_Pshadow_Pstandard_Cbyte"(%"_Pshadow_Pstandard_Cbyte"*, %byte)

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cbyte_MtoString"(%"_Pshadow_Pstandard_Cbyte"*) {
    %this = alloca %byte
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %0, i32 0, i32 1
    %3 = load %byte* %2
    store %byte %3, %byte* %this
    %4 = load %byte* %this
    %5 = load %byte* %this
    %6 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cbyte_Mclass"* @"_Pshadow_Pstandard_Cbyte_Mclass", i32 0, i32 0))
    %7 = bitcast %"_Pshadow_Pstandard_CObject"*%6 to %"_Pshadow_Pstandard_Cbyte"*
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"*%7, i32 0, i32 1
    store %byte %5, %byte* %8
    %9 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cbyte_MtoString_Pshadow_Pstandard_Cubyte"(%"_Pshadow_Pstandard_Cbyte"* %7, %ubyte 10)
    ret %"_Pshadow_Pstandard_CString"* %9
}

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cbyte_MtoString_Pshadow_Pstandard_Cubyte"(%"_Pshadow_Pstandard_Cbyte"*, %ubyte) {
    %this = alloca %byte
    %base = alloca %ubyte
    ...
    %4 = load %byte* %3
    store %byte %4, %byte* %this
    store %ubyte %1, %ubyte* %base
    %5 = load %byte* %this
    %6 = load %byte* %this
    %7 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cbyte_Mclass"* @"_Pshadow_Pstandard_Cbyte_Mclass", i32 0, i32 0))
    %8 = bitcast %"_Pshadow_Pstandard_CObject"*%7 to %"_Pshadow_Pstandard_Cbyte"*
    %9 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"*%8, i32 0, i32 1
    store %byte %6, %byte* %9
    %10 = call %ubyte @"_Pshadow_Pstandard_Cbyte_Mabs"(%"_Pshadow_Pstandard_Cbyte"* %8)
    %11 = load %ubyte* %base
    %12 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cubyte_Mclass"* @"_Pshadow_Pstandard_Cubyte_Mclass", i32 0, i32 0))
    %13 = bitcast %"_Pshadow_Pstandard_CObject"*%12 to %"_Pshadow_Pstandard_Cubyte"*
    %14 = getelementptr inbounds %"_Pshadow_Pstandard_Cubyte"*%13, i32 0, i32 1
    store %ubyte %10, %ubyte* %14
    %15 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cubyte_MtoString_Pshadow_Pstandard_Cubyte"(%"_Pshadow_Pstandard_Cubyte"* %13, %ubyte %11)
    store %"_Pshadow_Pstandard_CString"* %15, %"_Pshadow_Pstandard_CString"** %string
    %16 = load %byte* %this
    %17 = sext %byte %16 to %int
    %18 = icmp sge %int %17, 0
    br %boolean %18, label %_label9, label %_label10
_label9:
    %19 = load %"_Pshadow_Pstandard_CString"** %string
    store %"_Pshadow_Pstandard_CString"* %19, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label11
_label10:
    ...
    store %code 45, %code* %23
    %24 = getelementptr %"_Pshadow_Pstandard_CObject"* %20, i32 0, i32 0
    ...
    %28 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %29 = bitcast %"_Pshadow_Pstandard_CObject"* %28 to %"_Pshadow_Pstandard_Ccode"*
    %30 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %29, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %30
    %31 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %29, i32 0, i32 1
    store %code 45, %code* %31
    %32 = call %"_Pshadow_Pstandard_CString"* %27(%"_Pshadow_Pstandard_CObject"* %28)
    %33 = load %"_Pshadow_Pstandard_CString"** %string
    %34 = bitcast %"_Pshadow_Pstandard_CString"* %33 to %"_Pshadow_Pstandard_CObject"*
    %35 = icmp eq %"_Pshadow_Pstandard_CObject"* %34, null
    br %boolean %35, label %_label12, label %_label13
_label12:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label14
_label13:
    %36 = load %"_Pshadow_Pstandard_CString"** %string
    %37 = bitcast %"_Pshadow_Pstandard_CString"* %36 to %"_Pshadow_Pstandard_CObject"*
    %38 = getelementptr %"_Pshadow_Pstandard_CObject"* %37, i32 0, i32 0
    %39 = load %"_Pshadow_Pstandard_CObject_Mclass"** %38
    %40 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %39, i32 0, i32 6
    %41 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %40
    %42 = load %"_Pshadow_Pstandard_CString"** %string
    %43 = bitcast %"_Pshadow_Pstandard_CString"* %42 to %"_Pshadow_Pstandard_CObject"*
    %44 = call %"_Pshadow_Pstandard_CString"* %41(%"_Pshadow_Pstandard_CObject"* %43)
    store %"_Pshadow_Pstandard_CString"* %44, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label14
_label14:
    %45 = load %"_Pshadow_Pstandard_CString"** %_temp
    %46 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %32, %"_Pshadow_Pstandard_CString"* %45)
    store %"_Pshadow_Pstandard_CString"* %46, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label11
_label11:
    %47 = load %"_Pshadow_Pstandard_CString"** %_temp1
    ret %"_Pshadow_Pstandard_CString"* %47
}
...
define %"_Pshadow_Pstandard_Cbyte"* @"_Pshadow_Pstandard_Cbyte_Mcreate"(%"_Pshadow_Pstandard_Cbyte"*) {
    %this = alloca %byte
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %0, i32 0, i32 1
    %3 = load %byte* %2
    store %byte %3, %byte* %this
    %4 = load %byte* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cbyte_Mclass"* @"_Pshadow_Pstandard_Cbyte_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cbyte"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cbyte_Mclass"* @"_Pshadow_Pstandard_Cbyte_Mclass", %"_Pshadow_Pstandard_Cbyte_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %6, i32 0, i32 1
    store %byte %4, %byte* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cbyte"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cbyte_Mclass"* @"_Pshadow_Pstandard_Cbyte_Mclass", %"_Pshadow_Pstandard_Cbyte_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cbyte"* %0
}
...
@_array0 = private unnamed_addr constant [4 x %ubyte] c"byte"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([4 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 4] }, %boolean true }
