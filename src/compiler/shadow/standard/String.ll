...
%"_Pshadow_Pstandard_CException" = type { %"_Pshadow_Pstandard_CException_Mclass"*, { %byte*, [1 x %int] }, %boolean }
...
%"_Pshadow_Pstandard_CIllegalArgumentException" = type { %"_Pshadow_Pstandard_CIllegalArgumentException_Mclass"*, { %byte*, [1 x %int] }, %boolean }
...
%"_Pshadow_Pstandard_CObject" = type { %"_Pshadow_Pstandard_CObject_Mclass"*, { %byte*, [1 x %int] }, %boolean }
...
%"_Pshadow_Pstandard_CString_IStringIterator" = type { %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"*, { %byte*, [1 x %int] }, %boolean }
...
define { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } @"_Pshadow_Pstandard_CString_Miterator"(%"_Pshadow_Pstandard_CString"*) {
    %this = alloca %"_Pshadow_Pstandard_CString"*
    store %"_Pshadow_Pstandard_CString"* %0, %"_Pshadow_Pstandard_CString"** %this
    %2 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_CString_IStringIterator_Mclass"* @"_Pshadow_Pstandard_CString_IStringIterator_Mclass", i32 0, i32 0))
    %3 = bitcast %"_Pshadow_Pstandard_CObject"* %2 to %"_Pshadow_Pstandard_CString_IStringIterator"*
    %4 = load %"_Pshadow_Pstandard_CString"** %this
    %5 = call %"_Pshadow_Pstandard_CString_IStringIterator"* @"_Pshadow_Pstandard_CString_IStringIterator_Mcreate"(%"_Pshadow_Pstandard_CString_IStringIterator"* %3, %"_Pshadow_Pstandard_CString"* %4)
    %6 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_MinterfaceData_Pshadow_Pstandard_CClass"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CString_IStringIterator_Mclass"* @"_Pshadow_Pstandard_CString_IStringIterator_Mclass", i32 0, i32 0), %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CIterator_Mclass")
    %7 = bitcast %"_Pshadow_Pstandard_CObject"* %6 to %"_Pshadow_Pstandard_CIterator_Mclass"*
    %8 = insertvalue { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } undef, %"_Pshadow_Pstandard_CIterator_Mclass"* %7, 0
    %9 = bitcast %"_Pshadow_Pstandard_CString_IStringIterator"* %3 to %"_Pshadow_Pstandard_CObject"*
    %10 = insertvalue { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } %8, %"_Pshadow_Pstandard_CObject"* %9, 1
    ret { %"_Pshadow_Pstandard_CIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"* } %10
}
