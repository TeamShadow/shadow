...
%"_Pshadow_Pstandard_Cdouble" = type { %"_Pshadow_Pstandard_Cdouble_Mclass"*, %double, %double }
...
@"_Pshadow_Pstandard_Cdouble_Mclass" = global %"_Pshadow_Pstandard_Cdouble_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 8, %int 8 }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %double (%double, %double)* @"_Pshadow_Pstandard_Cdouble_Madd_R_Pshadow_Pstandard_Cdouble", %int (%double, %double)* @"_Pshadow_Pstandard_Cdouble_Mcompare_R_Pshadow_Pstandard_Cdouble", %double (%double, %double)* @"_Pshadow_Pstandard_Cdouble_Mdivide_R_Pshadow_Pstandard_Cdouble", %double (%double, %double)* @"_Pshadow_Pstandard_Cdouble_Mmodulus_R_Pshadow_Pstandard_Cdouble", %double (%double, %double)* @"_Pshadow_Pstandard_Cdouble_Mmultiply_R_Pshadow_Pstandard_Cdouble", %double (%double, %double)* @"_Pshadow_Pstandard_Cdouble_Msubtract_R_Pshadow_Pstandard_Cdouble" }
...
declare %double @"_Pshadow_Pstandard_Cdouble_Msubtract_R_Pshadow_Pstandard_Cdouble"(%double, %double)

declare %int @"_Pshadow_Pstandard_Cdouble_Mcompare_R_Pshadow_Pstandard_Cdouble"(%double, %double)

declare %double @"_Pshadow_Pstandard_Cdouble_Mdivide_R_Pshadow_Pstandard_Cdouble"(%double, %double)

declare %double @"_Pshadow_Pstandard_Cdouble_Mmultiply_R_Pshadow_Pstandard_Cdouble"(%double, %double)

declare %double @"_Pshadow_Pstandard_Cdouble_Madd_R_Pshadow_Pstandard_Cdouble"(%double, %double)

define %double @"_Pshadow_Pstandard_Cdouble_Mcreate"(%double) {
    %this = alloca %double
    store %double %0, %double* %this
    %2 = load %double* %this
    ret %double %2
}

declare %double @"_Pshadow_Pstandard_Cdouble_Mmodulus_R_Pshadow_Pstandard_Cdouble"(%double, %double)
