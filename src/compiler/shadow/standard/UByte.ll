...
@"_Pshadow_Pstandard_Cubyte_Mclass" = global %"_Pshadow_Pstandard_Cubyte_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 1, %int 1 }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %ubyte (%ubyte, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Madd_R_Pshadow_Pstandard_Cubyte", %int (%ubyte, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mcompare_R_Pshadow_Pstandard_Cubyte", %ubyte (%ubyte, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mdivide_R_Pshadow_Pstandard_Cubyte", %ubyte (%ubyte, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mmodulus_R_Pshadow_Pstandard_Cubyte", %ubyte (%ubyte, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Mmultiply_R_Pshadow_Pstandard_Cubyte", %ubyte (%ubyte, %ubyte)* @"_Pshadow_Pstandard_Cubyte_Msubtract_R_Pshadow_Pstandard_Cubyte" }
...
declare %ubyte @"_Pshadow_Pstandard_Cubyte_Msubtract_R_Pshadow_Pstandard_Cubyte"(%ubyte, %ubyte)

declare %int @"_Pshadow_Pstandard_Cubyte_Mcompare_R_Pshadow_Pstandard_Cubyte"(%ubyte, %ubyte)

declare %ubyte @"_Pshadow_Pstandard_Cubyte_Mdivide_R_Pshadow_Pstandard_Cubyte"(%ubyte, %ubyte)

declare %ubyte @"_Pshadow_Pstandard_Cubyte_Mmultiply_R_Pshadow_Pstandard_Cubyte"(%ubyte, %ubyte)

declare %ubyte @"_Pshadow_Pstandard_Cubyte_Madd_R_Pshadow_Pstandard_Cubyte"(%ubyte, %ubyte)

define %ubyte @"_Pshadow_Pstandard_Cubyte_Mcreate"(%ubyte) {
    %this = alloca %ubyte
    store %ubyte %0, %ubyte* %this
    %2 = load %ubyte* %this
    ret %ubyte %2
}

declare %ubyte @"_Pshadow_Pstandard_Cubyte_Mmodulus_R_Pshadow_Pstandard_Cubyte"(%ubyte, %ubyte)
