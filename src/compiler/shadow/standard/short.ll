...
@_class0 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cshort"*, %short)* } { %int (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mcompare_Pshadow_Pstandard_Cshort" }
@_interfaceData = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cshort"*, %short)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*)]
...
@"_Pshadow_Pstandard_Cshort_Mclass" = constant %"_Pshadow_Pstandard_Cshort_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 1] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 1] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cshort"* getelementptr (%"_Pshadow_Pstandard_Cshort"* null, i32 1) to i32), %int ptrtoint (%short* getelementptr (%short* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cshort"* (%"_Pshadow_Pstandard_Cshort"*)* @"_Pshadow_Pstandard_Cshort_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Madd_Pshadow_Pstandard_Cshort", %int (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mcompare_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mdivide_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mmodulus_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Mmultiply_Pshadow_Pstandard_Cshort", %short (%"_Pshadow_Pstandard_Cshort"*, %short)* @"_Pshadow_Pstandard_Cshort_Msubtract_Pshadow_Pstandard_Cshort" }
...
define %"_Pshadow_Pstandard_Cshort"* @"_Pshadow_Pstandard_Cshort_Mcreate"(%"_Pshadow_Pstandard_Cshort"*) {
    %this = alloca %short
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cshort"* %0, i32 0, i32 1
    %3 = load %short* %2
    store %short %3, %short* %this
    %4 = load %short* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cshort_Mclass"* @"_Pshadow_Pstandard_Cshort_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cshort"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cshort"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cshort_Mclass"* @"_Pshadow_Pstandard_Cshort_Mclass", %"_Pshadow_Pstandard_Cshort_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cshort"* %6, i32 0, i32 1
    store %short %4, %short* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cshort"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cshort_Mclass"* @"_Pshadow_Pstandard_Cshort_Mclass", %"_Pshadow_Pstandard_Cshort_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cshort"* %0
}
...
@_array0 = private unnamed_addr constant [5 x %ubyte] c"short"
