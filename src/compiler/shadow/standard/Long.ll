...
declare %long @"_Pshadow_Pstandard_Clong_Msubtract_R_Pshadow_Pstandard_Clong"(%long, %long)

declare %int @"_Pshadow_Pstandard_Clong_Mcompare_R_Pshadow_Pstandard_Clong"(%long, %long)

declare %long @"_Pshadow_Pstandard_Clong_Mdivide_R_Pshadow_Pstandard_Clong"(%long, %long)

declare %long @"_Pshadow_Pstandard_Clong_Mmultiply_R_Pshadow_Pstandard_Clong"(%long, %long)

declare %long @"_Pshadow_Pstandard_Clong_Madd_R_Pshadow_Pstandard_Clong"(%long, %long)

define %long @"_Pshadow_Pstandard_Clong_Mcreate"(%long) {
    %this = alloca %long
    store %long %0, %long* %this
    %2 = load %long* %this
    ret %long %2
}

declare %long @"_Pshadow_Pstandard_Clong_Mmodulus_R_Pshadow_Pstandard_Clong"(%long, %long)
