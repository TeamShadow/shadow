...
@_class0 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)* } { %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Madd_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mdivide_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mmodulus_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mmultiply_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Msubtract_Pshadow_Pstandard_Cint" }
@_class1 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cint"*, %int)* } { %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mcompare_Pshadow_Pstandard_Cint" }
@_class2 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cint"*)* } { %int (%"_Pshadow_Pstandard_Cint"*)* @"_Pshadow_Pstandard_Cint_Mhash" }
@_interfaceData = private unnamed_addr constant [3 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)*, %int (%"_Pshadow_Pstandard_Cint"*, %int)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cint"*, %int)* }* @_class1 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cint"*)* }* @_class2 to %"_Pshadow_Pstandard_CObject"*)]
@_interfaces = private unnamed_addr constant [3 x %"_Pshadow_Pstandard_CClass"*] [%"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CNumber_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CCanCompare_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CCanHash_Mclass"]
@"_Pshadow_Pstandard_Cint_Mclass" = constant %"_Pshadow_Pstandard_Cint_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([3 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 3] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([3 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 3] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cint"* getelementptr (%"_Pshadow_Pstandard_Cint"* null, i32 1) to i32), %int ptrtoint (%int* getelementptr (%int* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cint"* (%"_Pshadow_Pstandard_Cint"*)* @"_Pshadow_Pstandard_Cint_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cint"*)* @"_Pshadow_Pstandard_Cint_MtoString", %uint (%"_Pshadow_Pstandard_Cint"*)* @"_Pshadow_Pstandard_Cint_Mabs", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Madd_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mcompare_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mdivide_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*)* @"_Pshadow_Pstandard_Cint_Mhash", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mmax_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mmin_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mmodulus_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Mmultiply_Pshadow_Pstandard_Cint", %int (%"_Pshadow_Pstandard_Cint"*, %int)* @"_Pshadow_Pstandard_Cint_Msubtract_Pshadow_Pstandard_Cint", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_Cint"*, %uint)* @"_Pshadow_Pstandard_Cint_MtoString_Pshadow_Pstandard_Cuint" }
...
define %int @"_Pshadow_Pstandard_Cint_Mmin_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_Cint"*, %int) {
    %this = alloca %int
    %other = alloca %int
    %_temp = alloca %int
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %0, i32 0, i32 1
    %4 = load %int* %3
    store %int %4, %int* %this
...
_label0:
    %8 = load %int* %this
    store %int %8, %int* %_temp
    br label %_label2
_label1:
    %9 = load %int* %other
    store %int %9, %int* %_temp
    br label %_label2
_label2:
    %10 = load %int* %_temp
    ret %int %10
...
define %int @"_Pshadow_Pstandard_Cint_Mmax_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_Cint"*, %int) {
    %this = alloca %int
    %other = alloca %int
    %_temp = alloca %int
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %0, i32 0, i32 1
    ...
    %6 = load %int* %other
    %7 = icmp sgt %int %5, %6
    br %boolean %7, label %_label3, label %_label4
_label3:
    %8 = load %int* %this
    store %int %8, %int* %_temp
    br label %_label5
...
define %uint @"_Pshadow_Pstandard_Cint_Mabs"(%"_Pshadow_Pstandard_Cint"*) {
    %this = alloca %int
    %_temp = alloca %int
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %0, i32 0, i32 1
    %3 = load %int* %2
    store %int %3, %int* %this
    %4 = load %int* %this
    %5 = icmp slt %int %4, 0
...
_label8:
    %9 = load %int* %_temp
    %10 = bitcast %int %9 to %uint
    ret %uint %10
}

define %int @"_Pshadow_Pstandard_Cint_Mhash"(%"_Pshadow_Pstandard_Cint"*) {
    %this = alloca %int
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %0, i32 0, i32 1
    %3 = load %int* %2
    store %int %3, %int* %this
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cint_MtoString"(%"_Pshadow_Pstandard_Cint"*) {
    %this = alloca %int
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %0, i32 0, i32 1
    %3 = load %int* %2
    store %int %3, %int* %this
    %4 = load %int* %this
    %5 = load %int* %this
    %6 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %7 = bitcast %"_Pshadow_Pstandard_CObject"*%6 to %"_Pshadow_Pstandard_Cint"*
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%7, i32 0, i32 1
    store %int %5, %int* %8
    %9 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cint_MtoString_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cint"* %7, %uint 10)
    ret %"_Pshadow_Pstandard_CString"* %9
}

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cint_MtoString_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cint"*, %uint) {
    %this = alloca %int
    %base = alloca %uint
    ...
    %4 = load %int* %3
    store %int %4, %int* %this
    store %uint %1, %uint* %base
    %5 = load %int* %this
    %6 = load %int* %this
    %7 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %8 = bitcast %"_Pshadow_Pstandard_CObject"*%7 to %"_Pshadow_Pstandard_Cint"*
    %9 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%8, i32 0, i32 1
    store %int %6, %int* %9
    %10 = call %uint @"_Pshadow_Pstandard_Cint_Mabs"(%"_Pshadow_Pstandard_Cint"* %8)
    %11 = load %uint* %base
    %12 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cuint_Mclass"* @"_Pshadow_Pstandard_Cuint_Mclass", i32 0, i32 0))
    %13 = bitcast %"_Pshadow_Pstandard_CObject"*%12 to %"_Pshadow_Pstandard_Cuint"*
    %14 = getelementptr inbounds %"_Pshadow_Pstandard_Cuint"*%13, i32 0, i32 1
    store %uint %10, %uint* %14
    %15 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_Cuint_MtoString_Pshadow_Pstandard_Cuint"(%"_Pshadow_Pstandard_Cuint"* %13, %uint %11)
    store %"_Pshadow_Pstandard_CString"* %15, %"_Pshadow_Pstandard_CString"** %string
    %16 = load %int* %this
    %17 = icmp sge %int %16, 0
    br %boolean %17, label %_label9, label %_label10
_label9:
    %18 = load %"_Pshadow_Pstandard_CString"** %string
    store %"_Pshadow_Pstandard_CString"* %18, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label11
_label10:
    %19 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %20 = bitcast %"_Pshadow_Pstandard_CObject"* %19 to %"_Pshadow_Pstandard_Ccode"*
    %21 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %20, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %21
    %22 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %20, i32 0, i32 1
    store %code 45, %code* %22
    %23 = getelementptr %"_Pshadow_Pstandard_CObject"* %19, i32 0, i32 0
    ...
    %27 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %28 = bitcast %"_Pshadow_Pstandard_CObject"* %27 to %"_Pshadow_Pstandard_Ccode"*
    %29 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %28, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %29
    %30 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %28, i32 0, i32 1
    store %code 45, %code* %30
    %31 = call %"_Pshadow_Pstandard_CString"* %26(%"_Pshadow_Pstandard_CObject"* %27)
    %32 = load %"_Pshadow_Pstandard_CString"** %string
    %33 = bitcast %"_Pshadow_Pstandard_CString"* %32 to %"_Pshadow_Pstandard_CObject"*
    %34 = icmp eq %"_Pshadow_Pstandard_CObject"* %33, null
    br %boolean %34, label %_label12, label %_label13
_label12:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label14
_label13:
    %35 = load %"_Pshadow_Pstandard_CString"** %string
    %36 = bitcast %"_Pshadow_Pstandard_CString"* %35 to %"_Pshadow_Pstandard_CObject"*
    %37 = getelementptr %"_Pshadow_Pstandard_CObject"* %36, i32 0, i32 0
    %38 = load %"_Pshadow_Pstandard_CObject_Mclass"** %37
    %39 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %38, i32 0, i32 6
    %40 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %39
    %41 = load %"_Pshadow_Pstandard_CString"** %string
    %42 = bitcast %"_Pshadow_Pstandard_CString"* %41 to %"_Pshadow_Pstandard_CObject"*
    %43 = call %"_Pshadow_Pstandard_CString"* %40(%"_Pshadow_Pstandard_CObject"* %42)
    store %"_Pshadow_Pstandard_CString"* %43, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label14
_label14:
    %44 = load %"_Pshadow_Pstandard_CString"** %_temp
    %45 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %31, %"_Pshadow_Pstandard_CString"* %44)
    store %"_Pshadow_Pstandard_CString"* %45, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label11
_label11:
    %46 = load %"_Pshadow_Pstandard_CString"** %_temp1
    ret %"_Pshadow_Pstandard_CString"* %46
}
...
define %"_Pshadow_Pstandard_Cint"* @"_Pshadow_Pstandard_Cint_Mcreate"(%"_Pshadow_Pstandard_Cint"*) {
    %this = alloca %int
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %0, i32 0, i32 1
    %3 = load %int* %2
    store %int %3, %int* %this
    %4 = load %int* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cint"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %6, i32 0, i32 1
    store %int %4, %int* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cint"* %0
}
...
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([3 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 3] }, %boolean true }
