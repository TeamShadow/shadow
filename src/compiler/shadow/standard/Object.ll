...
@"_Pshadow_Pstandard_CObject_Mclass" = global %"_Pshadow_Pstandard_CObject_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* null, %int ptrtoint (%"_Pshadow_Pstandard_CObject"* getelementptr (%"_Pshadow_Pstandard_CObject"* null, i32 1) to i32), %int 8 }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_R_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString" }
...
define %boolean @"_Pshadow_Pstandard_CObject_Mequals_R_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
    %other = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pstandard_CObject"* %0, %"_Pshadow_Pstandard_CObject"** %this
    store %"_Pshadow_Pstandard_CObject"* %1, %"_Pshadow_Pstandard_CObject"** %other
    %3 = load %"_Pshadow_Pstandard_CObject"** %this
    %4 = load %"_Pshadow_Pstandard_CObject"** %other
    %5 = getelementptr %"_Pshadow_Pstandard_CObject"* %3, i32 0, i32 0
    %6 = load %"_Pshadow_Pstandard_CObject_Mclass"** %5
    %7 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %6, i32 0, i32 5
    %8 = load %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)** %7
    %9 = call %boolean %8(%"_Pshadow_Pstandard_CObject"* %3, %"_Pshadow_Pstandard_CObject"* %4)
    ret %boolean %9
}

declare %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mfreeze"(%"_Pshadow_Pstandard_CObject"*)

define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CObject_MtoString"(%"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pstandard_CObject"* %0, %"_Pshadow_Pstandard_CObject"** %this
    %2 = load %"_Pshadow_Pstandard_CObject"** %this
    %3 = getelementptr %"_Pshadow_Pstandard_CObject"* %2, i32 0, i32 0
    %4 = load %"_Pshadow_Pstandard_CObject_Mclass"** %3
    %5 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %4, i32 0, i32 4
    %6 = load %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)** %5
    %7 = call %"_Pshadow_Pstandard_CClass"* %6(%"_Pshadow_Pstandard_CObject"* %2)
    %8 = getelementptr %"_Pshadow_Pstandard_CClass"* %7, i32 0, i32 0
    %9 = load %"_Pshadow_Pstandard_CClass_Mclass"** %8
    %10 = getelementptr %"_Pshadow_Pstandard_CClass_Mclass"* %9, i32 0, i32 6
    %11 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CClass"*)** %10
    %12 = call %"_Pshadow_Pstandard_CString"* %11(%"_Pshadow_Pstandard_CClass"* %7)
    ret %"_Pshadow_Pstandard_CString"* %12
}

define %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pstandard_CObject"* %0, %"_Pshadow_Pstandard_CObject"** %this
    %2 = load %"_Pshadow_Pstandard_CObject"** %this
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_CObject"* %2, i32 0, i32 0
    store %"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", %"_Pshadow_Pstandard_CObject_Mclass"** %3
    %4 = load %"_Pshadow_Pstandard_CObject"** %this
...
@_array0 = private unnamed_addr constant [22 x %ubyte] c"shadow.standard@Object"
