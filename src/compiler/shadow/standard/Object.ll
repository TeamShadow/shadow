...
define %boolean @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*) {
    ...
    %5 = icmp eq %"_Pshadow_Pstandard_CObject"* %3, %4
    ret %boolean %5
}
...
define %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CObject_MtoString"(%"_Pshadow_Pstandard_CObject"*) {
    ...
    %7 = load %"_Pshadow_Pstandard_CObject"** %this
    %8 = call %"_Pshadow_Pstandard_CClass"* %6(%"_Pshadow_Pstandard_CObject"* %7)
    %9 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CClass_MtoString"(%"_Pshadow_Pstandard_CClass"* %8)
