...
@_class0 = private unnamed_addr constant { %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* } { %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Madd_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mdivide_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mmodulus_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mmultiply_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Msubtract_Pshadow_Pstandard_Cushort" }
@_class1 = private unnamed_addr constant { %int (%"_Pshadow_Pstandard_Cushort"*, %ushort)* } { %int (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mcompare_Pshadow_Pstandard_Cushort" }
@_interfaceData = private unnamed_addr constant [2 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)*, %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ %int (%"_Pshadow_Pstandard_Cushort"*, %ushort)* }* @_class1 to %"_Pshadow_Pstandard_CObject"*)]
...
@"_Pshadow_Pstandard_Cushort_Mclass" = constant %"_Pshadow_Pstandard_Cushort_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 2] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 2] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 2, %int ptrtoint (%"_Pshadow_Pstandard_Cushort"* getelementptr (%"_Pshadow_Pstandard_Cushort"* null, i32 1) to i32), %int ptrtoint (%ushort* getelementptr (%ushort* null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_Cushort"* (%"_Pshadow_Pstandard_Cushort"*)* @"_Pshadow_Pstandard_Cushort_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Madd_Pshadow_Pstandard_Cushort", %int (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mcompare_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mdivide_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mmodulus_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Mmultiply_Pshadow_Pstandard_Cushort", %ushort (%"_Pshadow_Pstandard_Cushort"*, %ushort)* @"_Pshadow_Pstandard_Cushort_Msubtract_Pshadow_Pstandard_Cushort" }
...
define %"_Pshadow_Pstandard_Cushort"* @"_Pshadow_Pstandard_Cushort_Mcreate"(%"_Pshadow_Pstandard_Cushort"*) {
    %this = alloca %ushort
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cushort"* %0, i32 0, i32 1
    %3 = load %ushort* %2
    store %ushort %3, %ushort* %this
    %4 = load %ushort* %this
    %5 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cushort_Mclass"* @"_Pshadow_Pstandard_Cushort_Mclass", i32 0, i32 0))
    %6 = bitcast %"_Pshadow_Pstandard_CObject"* %5 to %"_Pshadow_Pstandard_Cushort"*
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cushort"* %6, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cushort_Mclass"* @"_Pshadow_Pstandard_Cushort_Mclass", %"_Pshadow_Pstandard_Cushort_Mclass"** %7
    %8 = getelementptr inbounds %"_Pshadow_Pstandard_Cushort"* %6, i32 0, i32 1
    store %ushort %4, %ushort* %8
    %9 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %5)
    %10 = getelementptr inbounds %"_Pshadow_Pstandard_Cushort"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cushort_Mclass"* @"_Pshadow_Pstandard_Cushort_Mclass", %"_Pshadow_Pstandard_Cushort_Mclass"** %10
    ret %"_Pshadow_Pstandard_Cushort"* %0
}
...
@_array0 = private unnamed_addr constant [6 x %ubyte] c"ushort"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([6 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 6] }, %boolean true }
