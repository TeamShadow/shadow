...
define %"_Pshadow_Pstandard_Cushort"* @"_Pshadow_Pstandard_Cushort_Mcreate"(%"_Pshadow_Pstandard_Cushort"*) {
    %this = alloca %ushort
    %2 = getelementptr inbounds %"_Pshadow_Pstandard_Cushort"* %0, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cushort_Mclass"* @"_Pshadow_Pstandard_Cushort_Mclass", %"_Pshadow_Pstandard_Cushort_Mclass"** %2
    %3 = getelementptr inbounds %"_Pshadow_Pstandard_Cushort"* %0, i32 0, i32 1
    %4 = load %ushort* %3
    store %ushort %4, %ushort* %this
...
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([6 x %ubyte]* @_array0, i32 0, i32 0), [1 x %int] [%int 6] }, %boolean true }
