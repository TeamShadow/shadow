...
@_class0 = private unnamed_addr constant { void (%"_Pshadow_Ptest_CCheetah"*)* } { void (%"_Pshadow_Ptest_CCheetah"*)* @"_Pshadow_Ptest_CCheetah_Mrun" }
@_interfaceData = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ void (%"_Pshadow_Ptest_CCheetah"*)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*)]
...
@"_Pshadow_Ptest_CCheetah_Mclass" = constant %"_Pshadow_Ptest_CCheetah_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 1] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 1] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Ptest_CCheetah"* getelementptr (%"_Pshadow_Ptest_CCheetah"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Ptest_CCheetah"** getelementptr (%"_Pshadow_Ptest_CCheetah"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Ptest_CCheetah"* (%"_Pshadow_Ptest_CCheetah"*)* @"_Pshadow_Ptest_CCheetah_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", void (%"_Pshadow_Ptest_CCheetah"*)* @"_Pshadow_Ptest_CCheetah_Mrun" }
...
define void @"_Pshadow_Ptest_CCheetah_Mrun"(%"_Pshadow_Ptest_CCheetah"*) {
    %this = alloca %"_Pshadow_Ptest_CCheetah"*
    %_temp = alloca %"_Pshadow_Pstandard_CString"*
    %_temp1 = alloca %"_Pshadow_Pstandard_CString"*
    %_temp2 = alloca %"_Pshadow_Pstandard_CString"*
    store %"_Pshadow_Ptest_CCheetah"* %0, %"_Pshadow_Ptest_CCheetah"** %this
...
_label1:
    ...
    %13 = load %"_Pshadow_Ptest_CCheetah"** %this
    %14 = bitcast %"_Pshadow_Ptest_CCheetah"* %13 to %"_Pshadow_Pstandard_CObject"*
...
_label2:
    ...
    br label %_label4
_label3:
    %16 = load %"_Pshadow_Ptest_CCheetah"** %this
    %17 = bitcast %"_Pshadow_Ptest_CCheetah"* %16 to %"_Pshadow_Pstandard_CObject"*
    ...
    %22 = load %"_Pshadow_Ptest_CCheetah"** %this
    %23 = bitcast %"_Pshadow_Ptest_CCheetah"* %22 to %"_Pshadow_Pstandard_CObject"*
...
define %"_Pshadow_Ptest_CCheetah"* @"_Pshadow_Ptest_CCheetah_Mcreate"(%"_Pshadow_Ptest_CCheetah"*) {
    %this = alloca %"_Pshadow_Ptest_CCheetah"*
    store %"_Pshadow_Ptest_CCheetah"* %0, %"_Pshadow_Ptest_CCheetah"** %this
    %2 = load %"_Pshadow_Ptest_CCheetah"** %this
    %3 = bitcast %"_Pshadow_Ptest_CCheetah"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Ptest_CCheetah"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CCheetah_Mclass"* @"_Pshadow_Ptest_CCheetah_Mclass", %"_Pshadow_Ptest_CCheetah_Mclass"** %5
    ret %"_Pshadow_Ptest_CCheetah"* %0
}
...
@_array0 = private unnamed_addr constant [19 x %ubyte] c"shadow.test@Cheetah"
@_string0 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([19 x %byte]* @_array0, i32 0, i32 0), [1 x %int] [%int 19] }, %boolean true }
