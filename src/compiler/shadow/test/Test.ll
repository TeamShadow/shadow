...
define void @"_Pshadow_Ptest_CTest_Mmain"(%"_Pshadow_Ptest_CTest"*) {
    ...
    %4 = getelementptr %"_Pshadow_Ptest_CTest"* %3, i32 0, i32 0
    %5 = load %"_Pshadow_Ptest_CTest_Mclass"** %4
    %6 = getelementptr %"_Pshadow_Ptest_CTest_Mclass"* %5, i32 0, i32 2
    %7 = load %"_Pshadow_Ptest_CTest"* (%"_Pshadow_Ptest_CTest"*)** %6
    %8 = call %"_Pshadow_Ptest_CTest"* %7(%"_Pshadow_Ptest_CTest"* %3)
...
_label2:
    ...
    %15 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %14, i32 0, i32 2
    %16 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %15
    %17 = call %"_Pshadow_Pio_CConsole"* %16(%"_Pshadow_Pio_CConsole"* %12)
...
_label3:
    ...
    %19 = load %"_Pshadow_Ptest_CTest"** %test
    %20 = icmp ne %"_Pshadow_Ptest_CTest"* %19, null
    br %boolean %20, label %_label5, label %_label0
_label5:
    %21 = load %"_Pshadow_Ptest_CTest"** %test
    %22 = getelementptr inbounds %"_Pshadow_Ptest_CTest"* %21, i32 0, i32 1
    %23 = load %"_Pshadow_Ptest_CTest"** %22
    %24 = icmp ne %"_Pshadow_Ptest_CTest"* %23, null
    br %boolean %24, label %_label4, label %_label0
_label4:
    %25 = load %"_Pshadow_Ptest_CTest"** %22
    %26 = bitcast %"_Pshadow_Ptest_CTest"* %25 to %"_Pshadow_Pstandard_CObject"*
    %27 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %18, %"_Pshadow_Pstandard_CObject"* %26)
    br label %_label1
_label0:
    %28 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %29 = icmp eq %"_Pshadow_Pio_CConsole"* %28, null
    br %boolean %29, label %_label6, label %_label7
_label6:
    %30 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pio_CConsole_Mclass"* @"_Pshadow_Pio_CConsole_Mclass", i32 0, i32 0))
    %31 = bitcast %"_Pshadow_Pstandard_CObject"* %30 to %"_Pshadow_Pio_CConsole"*
    %32 = getelementptr %"_Pshadow_Pio_CConsole"* %31, i32 0, i32 0
    %33 = load %"_Pshadow_Pio_CConsole_Mclass"** %32
    %34 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %33, i32 0, i32 2
    %35 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %34
    %36 = call %"_Pshadow_Pio_CConsole"* %35(%"_Pshadow_Pio_CConsole"* %31)
    store %"_Pshadow_Pio_CConsole"* %36, %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    br label %_label7
_label7:
    %37 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %38 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %39 = bitcast %"_Pshadow_Pstandard_CObject"*%38 to %"_Pshadow_Pstandard_Cint"*
    %40 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%39, i32 0, i32 1
    store %int 1, %int* %40
    %41 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %37, %"_Pshadow_Pstandard_CObject"* %38)
    br label %_label1
_label1:
    %42 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %43 = icmp eq %"_Pshadow_Pio_CConsole"* %42, null
    br %boolean %43, label %_label8, label %_label9
_label8:
    ...
    %46 = getelementptr %"_Pshadow_Pio_CConsole"* %45, i32 0, i32 0
    %47 = load %"_Pshadow_Pio_CConsole_Mclass"** %46
    %48 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %47, i32 0, i32 2
    %49 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %48
    %50 = call %"_Pshadow_Pio_CConsole"* %49(%"_Pshadow_Pio_CConsole"* %45)
    store %"_Pshadow_Pio_CConsole"* %50, %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    br label %_label9
_label9:
    %51 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    store %"_Pshadow_Pio_CConsole"* %51, %"_Pshadow_Pio_CConsole"** %console
    %52 = load %"_Pshadow_Ptest_CTest"** %test
    %53 = icmp ne %"_Pshadow_Ptest_CTest"* %52, null
    br %boolean %53, label %_label12, label %_label10
_label12:
    %54 = load %"_Pshadow_Ptest_CTest"** %test
    %55 = getelementptr inbounds %"_Pshadow_Ptest_CTest"* %54, i32 0, i32 1
    store %"_Pshadow_Ptest_CTest"* null, %"_Pshadow_Ptest_CTest"** %55
    br label %_label11
_label10:
    %56 = load %"_Pshadow_Pio_CConsole"** %console
    %57 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %58 = bitcast %"_Pshadow_Pstandard_CObject"*%57 to %"_Pshadow_Pstandard_Cint"*
    %59 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%58, i32 0, i32 1
    store %int 2, %int* %59
    %60 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %56, %"_Pshadow_Pstandard_CObject"* %57)
    br label %_label11
_label11:
    %61 = load %"_Pshadow_Ptest_CTest"** %test
    %62 = icmp ne %"_Pshadow_Ptest_CTest"* %61, null
    br %boolean %62, label %_label16, label %_label13
_label16:
    %63 = load %"_Pshadow_Ptest_CTest"** %test
    %64 = getelementptr inbounds %"_Pshadow_Ptest_CTest"* %63, i32 0, i32 1
    %65 = load %"_Pshadow_Ptest_CTest"** %64
    %66 = icmp ne %"_Pshadow_Ptest_CTest"* %65, null
    br %boolean %66, label %_label15, label %_label13
_label15:
    %67 = load %"_Pshadow_Pio_CConsole"** %console
    %68 = load %"_Pshadow_Ptest_CTest"** %64
    %69 = bitcast %"_Pshadow_Ptest_CTest"* %68 to %"_Pshadow_Pstandard_CObject"*
    %70 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %67, %"_Pshadow_Pstandard_CObject"* %69)
    br label %_label14
_label13:
    %71 = load %"_Pshadow_Pio_CConsole"** %console
    %72 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %73 = bitcast %"_Pshadow_Pstandard_CObject"*%72 to %"_Pshadow_Pstandard_Cint"*
    %74 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%73, i32 0, i32 1
    store %int 3, %int* %74
    %75 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %71, %"_Pshadow_Pstandard_CObject"* %72)
    br label %_label14
_label14:
    %76 = load %"_Pshadow_Pio_CConsole"** %console
    %77 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine"(%"_Pshadow_Pio_CConsole"* %76)
    ret void
}
