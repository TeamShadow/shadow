...
@_class0 = private unnamed_addr constant { void (%"_Pshadow_Ptest_CTortoise"*)* } { void (%"_Pshadow_Ptest_CTortoise"*)* @"_Pshadow_Ptest_CTortoise_Mrun" }
@_interfaceData = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ void (%"_Pshadow_Ptest_CTortoise"*)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*)]
...
@"_Pshadow_Ptest_CTortoise_Mclass" = constant %"_Pshadow_Ptest_CTortoise_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 1] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 1] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Ptest_CTortoise"* getelementptr (%"_Pshadow_Ptest_CTortoise"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Ptest_CTortoise"** getelementptr (%"_Pshadow_Ptest_CTortoise"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Ptest_CTortoise"* (%"_Pshadow_Ptest_CTortoise"*)* @"_Pshadow_Ptest_CTortoise_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", void (%"_Pshadow_Ptest_CTortoise"*)* @"_Pshadow_Ptest_CTortoise_Mrun" }
...
define void @"_Pshadow_Ptest_CTortoise_Mrun"(%"_Pshadow_Ptest_CTortoise"*) {
    %this = alloca %"_Pshadow_Ptest_CTortoise"*
    %_temp = alloca %"_Pshadow_Pstandard_CString"*
    %_temp1 = alloca %"_Pshadow_Pstandard_CString"*
    store %"_Pshadow_Ptest_CTortoise"* %0, %"_Pshadow_Ptest_CTortoise"** %this
...
_label1:
    ...
    %13 = load %"_Pshadow_Ptest_CTortoise"** %this
    %14 = bitcast %"_Pshadow_Ptest_CTortoise"* %13 to %"_Pshadow_Pstandard_CObject"*
...
_label2:
    ...
    br label %_label4
_label3:
    %16 = load %"_Pshadow_Ptest_CTortoise"** %this
    %17 = bitcast %"_Pshadow_Ptest_CTortoise"* %16 to %"_Pshadow_Pstandard_CObject"*
    ...
    %22 = load %"_Pshadow_Ptest_CTortoise"** %this
    %23 = bitcast %"_Pshadow_Ptest_CTortoise"* %22 to %"_Pshadow_Pstandard_CObject"*
...
_label7:
    ...
    %38 = call %"_Pshadow_Pio_CConsole"* %12(%"_Pshadow_Pio_CConsole"* %8, %"_Pshadow_Pstandard_CObject"* %37)
    ret void
}

define %"_Pshadow_Ptest_CTortoise"* @"_Pshadow_Ptest_CTortoise_Mcreate"(%"_Pshadow_Ptest_CTortoise"*) {
    %this = alloca %"_Pshadow_Ptest_CTortoise"*
    store %"_Pshadow_Ptest_CTortoise"* %0, %"_Pshadow_Ptest_CTortoise"** %this
    %2 = load %"_Pshadow_Ptest_CTortoise"** %this
    %3 = bitcast %"_Pshadow_Ptest_CTortoise"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Ptest_CTortoise"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CTortoise_Mclass"* @"_Pshadow_Ptest_CTortoise_Mclass", %"_Pshadow_Ptest_CTortoise_Mclass"** %5
    ret %"_Pshadow_Ptest_CTortoise"* %0
}
...
@_array0 = private unnamed_addr constant [20 x %ubyte] c"shadow.test@Tortoise"
...
@_array2 = private unnamed_addr constant [22 x %ubyte] c" runs slow and steady."
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([22 x %byte]* @_array2, i32 0, i32 0), [1 x %int] [%int 22] }, %boolean true }
