...
%"_P_CFileTest_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_P_CFileTest"* (%"_P_CFileTest"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, void (%"_P_CFileTest"*, { %"_Pshadow_Pstandard_CString"**, [1 x %int] })* }
%"_P_CFileTest" = type { %"_P_CFileTest_Mclass"* }
...
%"_Pshadow_Pio_CFile" = type { %"_Pshadow_Pio_CFile_Mclass"* }
...
%"_Pshadow_Pio_CPath" = type { %"_Pshadow_Pio_CPath_Mclass"* }
...
@"_P_CFileTest_Mclass" = constant %"_P_CFileTest_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_P_CFileTest"* getelementptr (%"_P_CFileTest"* null, i32 1) to i32), %int ptrtoint (%"_P_CFileTest"** getelementptr (%"_P_CFileTest"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_P_CFileTest"* (%"_P_CFileTest"*)* @"_P_CFileTest_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", void (%"_P_CFileTest"*, { %"_Pshadow_Pstandard_CString"**, [1 x %int] })* @"_P_CFileTest_Mmain_Pshadow_Pstandard_CString_A1" }
...
@"_Pshadow_Pio_CFile_Mclass" = external constant %"_Pshadow_Pio_CFile_Mclass"
...
define %"_P_CFileTest"* @"_P_CFileTest_Mcreate"(%"_P_CFileTest"*) {
    %this = alloca %"_P_CFileTest"*
    store %"_P_CFileTest"* %0, %"_P_CFileTest"** %this
    %2 = load %"_P_CFileTest"** %this
    %3 = bitcast %"_P_CFileTest"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %3)
    %5 = getelementptr inbounds %"_P_CFileTest"* %0, i32 0, i32 0
    store %"_P_CFileTest_Mclass"* @"_P_CFileTest_Mclass", %"_P_CFileTest_Mclass"** %5
    ret %"_P_CFileTest"* %0
}

define void @"_P_CFileTest_Mmain_Pshadow_Pstandard_CString_A1"(%"_P_CFileTest"*, { %"_Pshadow_Pstandard_CString"**, [1 x %int] }) {
    %this = alloca %"_P_CFileTest"*
    %args = alloca { %"_Pshadow_Pstandard_CString"**, [1 x %int] }
    %file = alloca %"_Pshadow_Pio_CFile"*
    store %"_P_CFileTest"* %0, %"_P_CFileTest"** %this
    store { %"_Pshadow_Pstandard_CString"**, [1 x %int] } %1, { %"_Pshadow_Pstandard_CString"**, [1 x %int] }* %args
    %3 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pio_CFile_Mclass"* @"_Pshadow_Pio_CFile_Mclass", i32 0, i32 0))
    %4 = bitcast %"_Pshadow_Pstandard_CObject"* %3 to %"_Pshadow_Pio_CFile"*
    %5 = call %"_Pshadow_Pio_CFile"* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pstandard_CString"(%"_Pshadow_Pio_CFile"* %4, %"_Pshadow_Pstandard_CString"* @_string1)
    store %"_Pshadow_Pio_CFile"* %4, %"_Pshadow_Pio_CFile"** %file
    ret void
}
...
declare void @"_Pshadow_Pio_CFile_Mdestroy"(%"_Pshadow_Pio_CFile"*)
...
declare %"_Pshadow_Pio_CPath"* @"_Pshadow_Pio_CFile_Mpath"(%"_Pshadow_Pio_CFile"*)
declare %int @"_Pshadow_Pio_CFile_Mread_Pshadow_Pstandard_Cbyte_A1"(%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })
declare %"_Pshadow_Pio_CFile"* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pstandard_CString"(%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pstandard_CString"*)
declare %"_Pshadow_Pio_CFile"* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pio_CPath"(%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pio_CPath"*)
...
@_array0 = private unnamed_addr constant [16 x %ubyte] c"default@FileTest"
...
@_array1 = private unnamed_addr constant [8 x %ubyte] c"testFile"
@_string1 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([8 x %byte]* @_array1, i32 0, i32 0), [1 x %int] [%int 8] }, %boolean true }
