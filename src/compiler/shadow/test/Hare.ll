...
@_class0 = private unnamed_addr constant { void (%"_Pshadow_Ptest_CHare"*)* } { void (%"_Pshadow_Ptest_CHare"*)* @"_Pshadow_Ptest_CHare_Mrun" }
@_interfaceData = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ void (%"_Pshadow_Ptest_CHare"*)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*)]
@_interfaces = private unnamed_addr constant [1 x %"_Pshadow_Pstandard_CClass"*] [%"_Pshadow_Pstandard_CClass"* @"_Pshadow_Ptest_CCanRun_Mclass"]
@"_Pshadow_Ptest_CHare_Mclass" = constant %"_Pshadow_Ptest_CHare_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 1] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([1 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 1] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Ptest_CHare"* getelementptr (%"_Pshadow_Ptest_CHare"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Ptest_CHare"** getelementptr (%"_Pshadow_Ptest_CHare"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Ptest_CHare"* (%"_Pshadow_Ptest_CHare"*)* @"_Pshadow_Ptest_CHare_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", void (%"_Pshadow_Ptest_CHare"*)* @"_Pshadow_Ptest_CHare_Mrun" }
...
define void @"_Pshadow_Ptest_CHare_Mrun"(%"_Pshadow_Ptest_CHare"*) {
    %this = alloca %"_Pshadow_Ptest_CHare"*
    %_temp = alloca %"_Pshadow_Pstandard_CString"*
    %_temp1 = alloca %"_Pshadow_Pstandard_CString"*
    %_temp2 = alloca %"_Pshadow_Pstandard_CString"*
    store %"_Pshadow_Ptest_CHare"* %0, %"_Pshadow_Ptest_CHare"** %this
...
_label1:
    ...
    %13 = load %"_Pshadow_Ptest_CHare"** %this
    %14 = bitcast %"_Pshadow_Ptest_CHare"* %13 to %"_Pshadow_Pstandard_CObject"*
    %15 = icmp eq %"_Pshadow_Pstandard_CObject"* %14, null
    br %boolean %15, label %_label2, label %_label3
_label2:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label4
_label3:
    %16 = load %"_Pshadow_Ptest_CHare"** %this
    %17 = bitcast %"_Pshadow_Ptest_CHare"* %16 to %"_Pshadow_Pstandard_CObject"*
    ...
    %22 = load %"_Pshadow_Ptest_CHare"** %this
    %23 = bitcast %"_Pshadow_Ptest_CHare"* %22 to %"_Pshadow_Pstandard_CObject"*
    %24 = call %"_Pshadow_Pstandard_CString"* %21(%"_Pshadow_Pstandard_CObject"* %23)
...
_label4:
    ...
    br %boolean %27, label %_label5, label %_label6
_label5:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label7
_label6:
    %28 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
    ...
    %33 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
...
_label7:
    ...
    %36 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %25, %"_Pshadow_Pstandard_CString"* %35)
    ...
    %45 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %46 = bitcast %"_Pshadow_Pstandard_CObject"* %45 to %"_Pshadow_Pstandard_Cint"*
    %47 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %46, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %47
    %48 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %46, i32 0, i32 1
    store %int 40, %int* %48
    %49 = call %"_Pshadow_Pstandard_CString"* %44(%"_Pshadow_Pstandard_CObject"* %45)
    %50 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %36, %"_Pshadow_Pstandard_CString"* %49)
    %51 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %52 = icmp eq %"_Pshadow_Pstandard_CObject"* %51, null
    br %boolean %52, label %_label8, label %_label9
_label8:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label10
_label9:
    %53 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %54 = getelementptr %"_Pshadow_Pstandard_CObject"* %53, i32 0, i32 0
    %55 = load %"_Pshadow_Pstandard_CObject_Mclass"** %54
    %56 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %55, i32 0, i32 6
    %57 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %56
    %58 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %59 = call %"_Pshadow_Pstandard_CString"* %57(%"_Pshadow_Pstandard_CObject"* %58)
    store %"_Pshadow_Pstandard_CString"* %59, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label10
_label10:
    %60 = load %"_Pshadow_Pstandard_CString"** %_temp2
    %61 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %50, %"_Pshadow_Pstandard_CString"* %60)
    %62 = bitcast %"_Pshadow_Pstandard_CString"* %61 to %"_Pshadow_Pstandard_CObject"*
    %63 = call %"_Pshadow_Pio_CConsole"* %12(%"_Pshadow_Pio_CConsole"* %8, %"_Pshadow_Pstandard_CObject"* %62)
    ret void
}

define %"_Pshadow_Ptest_CHare"* @"_Pshadow_Ptest_CHare_Mcreate"(%"_Pshadow_Ptest_CHare"*) {
    %this = alloca %"_Pshadow_Ptest_CHare"*
    store %"_Pshadow_Ptest_CHare"* %0, %"_Pshadow_Ptest_CHare"** %this
    %2 = load %"_Pshadow_Ptest_CHare"** %this
    %3 = bitcast %"_Pshadow_Ptest_CHare"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Ptest_CHare"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CHare_Mclass"* @"_Pshadow_Ptest_CHare_Mclass", %"_Pshadow_Ptest_CHare_Mclass"** %5
    ret %"_Pshadow_Ptest_CHare"* %0
}
...
@_array0 = private unnamed_addr constant [16 x %ubyte] c"shadow.test@Hare"
...
@_array2 = private unnamed_addr constant [9 x %ubyte] c" runs at "
...
@_array3 = private unnamed_addr constant [5 x %ubyte] c" mph."
@_string3 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([5 x %byte]* @_array3, i32 0, i32 0), [1 x %int] [%int 5] }, %boolean true }
