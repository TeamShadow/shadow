...
%"_Pshadow_Ptest_CExceptionTest_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Ptest_CExceptionTest"* (%"_Pshadow_Ptest_CExceptionTest"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, %int (%"_Pshadow_Ptest_CExceptionTest"*, { %"_Pshadow_Pstandard_CString"**, [1 x %int] })*, void (%"_Pshadow_Ptest_CExceptionTest"*)*, void (%"_Pshadow_Ptest_CExceptionTest"*)*, void (%"_Pshadow_Ptest_CExceptionTest"*)*, void (%"_Pshadow_Ptest_CExceptionTest"*)* }
...
define void @"_Pshadow_Ptest_CExceptionTest_Mtest"(%"_Pshadow_Ptest_CExceptionTest"*) {
    ...
    %6 = bitcast %"_Pshadow_Ptest_CExceptionA"* %3 to %"_Pshadow_Pstandard_CException"*
...
@_string1 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([23 x %ubyte]* @_array1, i32 0, i32 0), [1 x %int] [%int 23] }, %boolean true }
@_array2 = private unnamed_addr constant [23 x %ubyte] c"test2 caught ExceptionA"
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([23 x %ubyte]* @_array2, i32 0, i32 0), [1 x %int] [%int 23] }, %boolean true }
@_array3 = private unnamed_addr constant [23 x %ubyte] c"test2 caught ExceptionB"
@_string3 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([23 x %ubyte]* @_array3, i32 0, i32 0), [1 x %int] [%int 23] }, %boolean true }
@_array4 = private unnamed_addr constant [22 x %ubyte] c"test3 caught Exception"
@_string4 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([22 x %ubyte]* @_array4, i32 0, i32 0), [1 x %int] [%int 22] }, %boolean true }
