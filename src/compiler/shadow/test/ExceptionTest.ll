...
define void @"_Pshadow_Ptest_CExceptionTest_Mtest"(%"_Pshadow_Ptest_CExceptionTest"*) {
    ...
    %6 = bitcast %"_Pshadow_Pstandard_CIndexOutOfBoundsException"* %3 to %"_Pshadow_Pstandard_CException"*
    call void @"_Pshadow_Pstandard_CException_Mthrow__"(%"_Pshadow_Pstandard_CException"* %6)
    ret void
}
