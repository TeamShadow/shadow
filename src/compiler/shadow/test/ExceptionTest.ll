...
%"_Pshadow_Ptest_CExceptionTest_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Ptest_CExceptionTest"* (%"_Pshadow_Ptest_CExceptionTest"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, %int (%"_Pshadow_Ptest_CExceptionTest"*, { %"_Pshadow_Pstandard_CString"**, [1 x %int] })*, void (%"_Pshadow_Ptest_CExceptionTest"*)*, void (%"_Pshadow_Ptest_CExceptionTest"*)*, void (%"_Pshadow_Ptest_CExceptionTest"*)*, void (%"_Pshadow_Ptest_CExceptionTest"*)* }
%"_Pshadow_Ptest_CExceptionTest" = type { %"_Pshadow_Ptest_CExceptionTest_Mclass"* }
...
define void @"_Pshadow_Ptest_CExceptionTest_Mtest1"(%"_Pshadow_Ptest_CExceptionTest"*) {
    %this = alloca %"_Pshadow_Ptest_CExceptionTest"*
    store %"_Pshadow_Ptest_CExceptionTest"* %0, %"_Pshadow_Ptest_CExceptionTest"** %this
    %2 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    %3 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    invoke void @"_Pshadow_Ptest_CExceptionTest_Mtest"(%"_Pshadow_Ptest_CExceptionTest"* %3)
             to label %_label3
             unwind label %_label2
_label3:
    br label %_label0
_label2:
    %4 = landingpad { i8*, i32 } personality i32 (...)* @__shadow_personality_v0
    ...
    %7 = tail call i32 @llvm.eh.typeid.for(i8* bitcast (%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CExceptionA_Mclass"* @"_Pshadow_Ptest_CExceptionA_Mclass", i32 0, i32 0) to i8*)) nounwind
    %8 = icmp ne i32 %6, %7
    br i1 %8, label %_label4, label %_label1
_label4:
    resume { i8*, i32 } %4
_label1:
    %9 = call %"_Pshadow_Pstandard_CException"* @__shadow_catch(i8* %5) nounwind
    %10 = bitcast %"_Pshadow_Pstandard_CException"* %9 to %"_Pshadow_Ptest_CExceptionA"*
    %11 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %12 = icmp eq %"_Pshadow_Pio_CConsole"* %11, null
    br %boolean %12, label %_label5, label %_label6
_label5:
...
_label6:
    ...
    %21 = bitcast %"_Pshadow_Pstandard_CString"* @_string1 to %"_Pshadow_Pstandard_CObject"*
    %22 = call %"_Pshadow_Pio_CConsole"* %20(%"_Pshadow_Pio_CConsole"* %16, %"_Pshadow_Pstandard_CObject"* %21)
    br label %_label0
_label0:
    ret void
}

define void @"_Pshadow_Ptest_CExceptionTest_Mtest"(%"_Pshadow_Ptest_CExceptionTest"*) {
    %this = alloca %"_Pshadow_Ptest_CExceptionTest"*
    store %"_Pshadow_Ptest_CExceptionTest"* %0, %"_Pshadow_Ptest_CExceptionTest"** %this
    %2 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_CIndexOutOfBoundsException_Mclass"* @"_Pshadow_Pstandard_CIndexOutOfBoundsException_Mclass", i32 0, i32 0))
    %3 = bitcast %"_Pshadow_Pstandard_CObject"* %2 to %"_Pshadow_Pstandard_CIndexOutOfBoundsException"*
    %4 = call %"_Pshadow_Pstandard_CIndexOutOfBoundsException"* @"_Pshadow_Pstandard_CIndexOutOfBoundsException_Mcreate"(%"_Pshadow_Pstandard_CIndexOutOfBoundsException"* %3)
    %5 = bitcast %"_Pshadow_Pstandard_CIndexOutOfBoundsException"* %3 to %"_Pshadow_Pstandard_CException"*
    %6 = getelementptr %"_Pshadow_Pstandard_CException"* %5, i32 0, i32 0
    %7 = load %"_Pshadow_Pstandard_CException_Mclass"** %6
    %8 = getelementptr %"_Pshadow_Pstandard_CException_Mclass"* %7, i32 0, i32 9
    %9 = load void (%"_Pshadow_Pstandard_CException"*)** %8
    %10 = bitcast %"_Pshadow_Pstandard_CIndexOutOfBoundsException"* %3 to %"_Pshadow_Pstandard_CException"*
    call void %9(%"_Pshadow_Pstandard_CException"* %10)
    ret void
}
...
define %"_Pshadow_Ptest_CExceptionTest"* @"_Pshadow_Ptest_CExceptionTest_Mcreate"(%"_Pshadow_Ptest_CExceptionTest"*) {
    ...
    store %"_Pshadow_Ptest_CExceptionTest"* %0, %"_Pshadow_Ptest_CExceptionTest"** %this
    %2 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    %3 = bitcast %"_Pshadow_Ptest_CExceptionTest"* %2 to %"_Pshadow_Pstandard_CObject"*
    %4 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Ptest_CExceptionTest"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CExceptionTest_Mclass"* @"_Pshadow_Ptest_CExceptionTest_Mclass", %"_Pshadow_Ptest_CExceptionTest_Mclass"** %5
    ret %"_Pshadow_Ptest_CExceptionTest"* %0
}

define void @"_Pshadow_Ptest_CExceptionTest_Mtest2"(%"_Pshadow_Ptest_CExceptionTest"*) {
    %this = alloca %"_Pshadow_Ptest_CExceptionTest"*
    store %"_Pshadow_Ptest_CExceptionTest"* %0, %"_Pshadow_Ptest_CExceptionTest"** %this
    %2 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    %3 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    invoke void @"_Pshadow_Ptest_CExceptionTest_Mtest1"(%"_Pshadow_Ptest_CExceptionTest"* %3)
             to label %_label11
             unwind label %_label10
_label11:
    br label %_label7
_label10:
    %4 = landingpad { i8*, i32 } personality i32 (...)* @__shadow_personality_v0
    ...
    %7 = tail call i32 @llvm.eh.typeid.for(i8* bitcast (%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CExceptionA_Mclass"* @"_Pshadow_Ptest_CExceptionA_Mclass", i32 0, i32 0) to i8*)) nounwind
    %8 = icmp ne i32 %6, %7
    br i1 %8, label %_label12, label %_label8
_label12:
    %9 = tail call i32 @llvm.eh.typeid.for(i8* bitcast (%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CExceptionB_Mclass"* @"_Pshadow_Ptest_CExceptionB_Mclass", i32 0, i32 0) to i8*)) nounwind
    %10 = icmp ne i32 %6, %9
    br i1 %10, label %_label13, label %_label9
_label13:
    resume { i8*, i32 } %4
_label8:
    %11 = call %"_Pshadow_Pstandard_CException"* @__shadow_catch(i8* %5) nounwind
    %12 = bitcast %"_Pshadow_Pstandard_CException"* %11 to %"_Pshadow_Ptest_CExceptionA"*
    %13 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %14 = icmp eq %"_Pshadow_Pio_CConsole"* %13, null
    br %boolean %14, label %_label14, label %_label15
_label14:
...
_label15:
    ...
    %21 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %20, i32 0, i32 13
    %22 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CObject"*)** %21
    %23 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
    %24 = call %"_Pshadow_Pio_CConsole"* %22(%"_Pshadow_Pio_CConsole"* %18, %"_Pshadow_Pstandard_CObject"* %23)
    br label %_label7
_label9:
    %25 = call %"_Pshadow_Pstandard_CException"* @__shadow_catch(i8* %5) nounwind
    %26 = bitcast %"_Pshadow_Pstandard_CException"* %25 to %"_Pshadow_Ptest_CExceptionB"*
    %27 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %28 = icmp eq %"_Pshadow_Pio_CConsole"* %27, null
    br %boolean %28, label %_label16, label %_label17
_label16:
    %29 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pio_CConsole_Mclass"* @"_Pshadow_Pio_CConsole_Mclass", i32 0, i32 0))
    %30 = bitcast %"_Pshadow_Pstandard_CObject"* %29 to %"_Pshadow_Pio_CConsole"*
    %31 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_Mcreate"(%"_Pshadow_Pio_CConsole"* %30)
    store %"_Pshadow_Pio_CConsole"* %31, %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    br label %_label17
_label17:
    %32 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %33 = getelementptr %"_Pshadow_Pio_CConsole"* %32, i32 0, i32 0
    %34 = load %"_Pshadow_Pio_CConsole_Mclass"** %33
    %35 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %34, i32 0, i32 13
    %36 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CObject"*)** %35
    %37 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %38 = call %"_Pshadow_Pio_CConsole"* %36(%"_Pshadow_Pio_CConsole"* %32, %"_Pshadow_Pstandard_CObject"* %37)
    br label %_label7
_label7:
    ret void
}
...
define %int @"_Pshadow_Ptest_CExceptionTest_Mmain_Pshadow_Pstandard_CString_A1"(%"_Pshadow_Ptest_CExceptionTest"*, { %"_Pshadow_Pstandard_CString"**, [1 x %int] }) {
    ...
    %3 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    %4 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    call void @"_Pshadow_Ptest_CExceptionTest_Mtest3"(%"_Pshadow_Ptest_CExceptionTest"* %4)
    ret %int 0
}

define void @"_Pshadow_Ptest_CExceptionTest_Mtest3"(%"_Pshadow_Ptest_CExceptionTest"*) {
    %this = alloca %"_Pshadow_Ptest_CExceptionTest"*
    store %"_Pshadow_Ptest_CExceptionTest"* %0, %"_Pshadow_Ptest_CExceptionTest"** %this
    %2 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    %3 = load %"_Pshadow_Ptest_CExceptionTest"** %this
    invoke void @"_Pshadow_Ptest_CExceptionTest_Mtest2"(%"_Pshadow_Ptest_CExceptionTest"* %3)
             to label %_label21
             unwind label %_label20
_label21:
    br label %_label18
_label20:
    %4 = landingpad { i8*, i32 } personality i32 (...)* @__shadow_personality_v0
    ...
    %5 = extractvalue { i8*, i32 } %4, 0
    %6 = extractvalue { i8*, i32 } %4, 1
    %7 = tail call i32 @llvm.eh.typeid.for(i8* bitcast (%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CException_Mclass"* @"_Pshadow_Pstandard_CException_Mclass", i32 0, i32 0) to i8*)) nounwind
    %8 = icmp ne i32 %6, %7
    br i1 %8, label %_label22, label %_label19
_label22:
    resume { i8*, i32 } %4
_label19:
    %9 = call %"_Pshadow_Pstandard_CException"* @__shadow_catch(i8* %5) nounwind
    %10 = bitcast %"_Pshadow_Pstandard_CException"* %9 to %"_Pshadow_Pstandard_CException"*
    %11 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %12 = icmp eq %"_Pshadow_Pio_CConsole"* %11, null
    br %boolean %12, label %_label23, label %_label24
_label23:
    %13 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pio_CConsole_Mclass"* @"_Pshadow_Pio_CConsole_Mclass", i32 0, i32 0))
    %14 = bitcast %"_Pshadow_Pstandard_CObject"* %13 to %"_Pshadow_Pio_CConsole"*
    %15 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_Mcreate"(%"_Pshadow_Pio_CConsole"* %14)
...
_label24:
    ...
    %19 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %18, i32 0, i32 13
    %20 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CObject"*)** %19
    %21 = bitcast %"_Pshadow_Pstandard_CString"* @_string4 to %"_Pshadow_Pstandard_CObject"*
    %22 = call %"_Pshadow_Pio_CConsole"* %20(%"_Pshadow_Pio_CConsole"* %16, %"_Pshadow_Pstandard_CObject"* %21)
    br label %_label18
_label18:
    ret void
...
@_array1 = private unnamed_addr constant [23 x %ubyte] c"test1 caught ExceptionA"
@_string1 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([23 x %byte]* @_array1, i32 0, i32 0), [1 x %int] [%int 23] }, %boolean true }
@_array2 = private unnamed_addr constant [23 x %ubyte] c"test2 caught ExceptionA"
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([23 x %byte]* @_array2, i32 0, i32 0), [1 x %int] [%int 23] }, %boolean true }
@_array3 = private unnamed_addr constant [23 x %ubyte] c"test2 caught ExceptionB"
@_string3 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([23 x %byte]* @_array3, i32 0, i32 0), [1 x %int] [%int 23] }, %boolean true }
@_array4 = private unnamed_addr constant [22 x %ubyte] c"test3 caught Exception"
@_string4 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %byte*, [1 x %int] } { %byte* getelementptr inbounds ([22 x %byte]* @_array4, i32 0, i32 0), [1 x %int] [%int 22] }, %boolean true }
