...
define %"_Pshadow_Ptest_CExceptionB"* @"_Pshadow_Ptest_CExceptionB_Mcreate"(%"_Pshadow_Ptest_CExceptionB"*) {
    %this = alloca %"_Pshadow_Ptest_CExceptionB"*
    %2 = getelementptr inbounds %"_Pshadow_Ptest_CExceptionB"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CExceptionB_Mclass"* @"_Pshadow_Ptest_CExceptionB_Mclass", %"_Pshadow_Ptest_CExceptionB_Mclass"** %2
    store %"_Pshadow_Ptest_CExceptionB"* %0, %"_Pshadow_Ptest_CExceptionB"** %this
    ret %"_Pshadow_Ptest_CExceptionB"* %0
}
...
@_array0 = private unnamed_addr constant [22 x %ubyte] c"shadow.test@ExceptionB"
