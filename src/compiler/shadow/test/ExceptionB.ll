...
define %"_Pshadow_Ptest_CExceptionB"* @"_Pshadow_Ptest_CExceptionB_Mcreate"(%"_Pshadow_Ptest_CExceptionB"*) {
    ...
    %2 = load %"_Pshadow_Ptest_CExceptionB"** %this
    %3 = bitcast %"_Pshadow_Ptest_CExceptionB"* %2 to %"_Pshadow_Pstandard_CException"*
    %4 = call %"_Pshadow_Pstandard_CException"* @"_Pshadow_Pstandard_CException_Mcreate"(%"_Pshadow_Pstandard_CException"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Ptest_CExceptionB"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CExceptionB_Mclass"* @"_Pshadow_Ptest_CExceptionB_Mclass", %"_Pshadow_Ptest_CExceptionB_Mclass"** %5
