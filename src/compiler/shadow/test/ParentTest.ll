...
_label1:
    ...
    %16 = icmp eq %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CParentTest_Mclass"* @"_Pshadow_Ptest_CParentTest_Mclass", i32 0, i32 0), null
    br %boolean %16, label %_label2, label %_label3
_label2:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label4
_label3:
    %17 = bitcast %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CParentTest_Mclass"* @"_Pshadow_Ptest_CParentTest_Mclass", i32 0, i32 0) to %"_Pshadow_Pstandard_CObject"*
    %18 = getelementptr %"_Pshadow_Pstandard_CObject"* %17, i32 0, i32 0
    %19 = load %"_Pshadow_Pstandard_CObject_Mclass"** %18
    %20 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %19, i32 0, i32 6
    %21 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %20
    %22 = bitcast %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CParentTest_Mclass"* @"_Pshadow_Ptest_CParentTest_Mclass", i32 0, i32 0) to %"_Pshadow_Pstandard_CObject"*
    %23 = call %"_Pshadow_Pstandard_CString"* %21(%"_Pshadow_Pstandard_CObject"* %22)
    store %"_Pshadow_Pstandard_CString"* %23, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label4
_label4:
    %24 = load %"_Pshadow_Pstandard_CString"** %_temp
    %25 = icmp eq %"_Pshadow_Pstandard_CString"* @_string2, null
    br %boolean %25, label %_label5, label %_label6
_label5:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label7
_label6:
    %26 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
    %27 = getelementptr %"_Pshadow_Pstandard_CObject"* %26, i32 0, i32 0
    %28 = load %"_Pshadow_Pstandard_CObject_Mclass"** %27
    %29 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %28, i32 0, i32 6
    ...
    %32 = call %"_Pshadow_Pstandard_CString"* %30(%"_Pshadow_Pstandard_CObject"* %31)
    store %"_Pshadow_Pstandard_CString"* %32, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label7
_label7:
    %33 = load %"_Pshadow_Pstandard_CString"** %_temp1
    %34 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %24, %"_Pshadow_Pstandard_CString"* %33)
    %35 = bitcast %"_Pshadow_Pstandard_CString"* %34 to %"_Pshadow_Pstandard_CObject"*
    %36 = call %"_Pshadow_Pio_CConsole"* %15(%"_Pshadow_Pio_CConsole"* %11, %"_Pshadow_Pstandard_CObject"* %35)
...
_label9:
    ...
    %13 = getelementptr %"_Pshadow_Pio_CConsole"* %12, i32 0, i32 0
    %14 = load %"_Pshadow_Pio_CConsole_Mclass"** %13
    %15 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %14, i32 0, i32 13
    %16 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CObject"*)** %15
    %17 = icmp eq %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CParentTest_Mclass"* @"_Pshadow_Ptest_CParentTest_Mclass", i32 0, i32 0), null
    br %boolean %17, label %_label10, label %_label11
_label10:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label12
_label11:
    %18 = bitcast %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CParentTest_Mclass"* @"_Pshadow_Ptest_CParentTest_Mclass", i32 0, i32 0) to %"_Pshadow_Pstandard_CObject"*
    %19 = getelementptr %"_Pshadow_Pstandard_CObject"* %18, i32 0, i32 0
    %20 = load %"_Pshadow_Pstandard_CObject_Mclass"** %19
    %21 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %20, i32 0, i32 6
    %22 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %21
    %23 = bitcast %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CParentTest_Mclass"* @"_Pshadow_Ptest_CParentTest_Mclass", i32 0, i32 0) to %"_Pshadow_Pstandard_CObject"*
    %24 = call %"_Pshadow_Pstandard_CString"* %22(%"_Pshadow_Pstandard_CObject"* %23)
    store %"_Pshadow_Pstandard_CString"* %24, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label12
_label12:
    %25 = load %"_Pshadow_Pstandard_CString"** %_temp
    %26 = icmp eq %"_Pshadow_Pstandard_CString"* @_string3, null
    br %boolean %26, label %_label13, label %_label14
_label13:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label15
_label14:
    %27 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %28 = getelementptr %"_Pshadow_Pstandard_CObject"* %27, i32 0, i32 0
    ...
    %33 = call %"_Pshadow_Pstandard_CString"* %31(%"_Pshadow_Pstandard_CObject"* %32)
    store %"_Pshadow_Pstandard_CString"* %33, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label15
_label15:
    %34 = load %"_Pshadow_Pstandard_CString"** %_temp1
    %35 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %25, %"_Pshadow_Pstandard_CString"* %34)
    %36 = load %int* %x
    %37 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %38 = bitcast %"_Pshadow_Pstandard_CObject"* %37 to %"_Pshadow_Pstandard_Cint"*
    %39 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %38, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %39
    %40 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %38, i32 0, i32 1
    store %int %36, %int* %40
    %41 = getelementptr %"_Pshadow_Pstandard_CObject"* %37, i32 0, i32 0
    %42 = load %"_Pshadow_Pstandard_CObject_Mclass"** %41
    %43 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %42, i32 0, i32 6
    %44 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %43
    %45 = load %int* %x
    %46 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %47 = bitcast %"_Pshadow_Pstandard_CObject"* %46 to %"_Pshadow_Pstandard_Cint"*
    %48 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %47, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %48
    %49 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %47, i32 0, i32 1
    store %int %45, %int* %49
    %50 = call %"_Pshadow_Pstandard_CString"* %44(%"_Pshadow_Pstandard_CObject"* %46)
    %51 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %35, %"_Pshadow_Pstandard_CString"* %50)
    %52 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %53 = bitcast %"_Pshadow_Pstandard_CObject"* %52 to %"_Pshadow_Pstandard_Ccode"*
    %54 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %53, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %54
    %55 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %53, i32 0, i32 1
    store %code 41, %code* %55
    %56 = getelementptr %"_Pshadow_Pstandard_CObject"* %52, i32 0, i32 0
    ...
    %60 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %61 = bitcast %"_Pshadow_Pstandard_CObject"* %60 to %"_Pshadow_Pstandard_Ccode"*
    %62 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %61, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %62
    %63 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %61, i32 0, i32 1
    store %code 41, %code* %63
    %64 = call %"_Pshadow_Pstandard_CString"* %59(%"_Pshadow_Pstandard_CObject"* %60)
    %65 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %51, %"_Pshadow_Pstandard_CString"* %64)
    %66 = bitcast %"_Pshadow_Pstandard_CString"* %65 to %"_Pshadow_Pstandard_CObject"*
    %67 = call %"_Pshadow_Pio_CConsole"* %16(%"_Pshadow_Pio_CConsole"* %12, %"_Pshadow_Pstandard_CObject"* %66)
    ret %"_Pshadow_Ptest_CParentTest"* %0
}
...
_label17:
    ...
    %16 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*, %"_Pshadow_Pstandard_CObject"*)** %15
    %17 = icmp eq %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Ptest_CParentTest_Mclass"* @"_Pshadow_Ptest_CParentTest_Mclass", i32 0, i32 0), null
    br %boolean %17, label %_label18, label %_label19
_label18:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label20
_label19:
...
_label20:
    %25 = load %"_Pshadow_Pstandard_CString"** %_temp
    %26 = icmp eq %"_Pshadow_Pstandard_CString"* @_string4, null
    br %boolean %26, label %_label21, label %_label22
_label21:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label23
_label22:
    %27 = bitcast %"_Pshadow_Pstandard_CString"* @_string4 to %"_Pshadow_Pstandard_CObject"*
    %28 = getelementptr %"_Pshadow_Pstandard_CObject"* %27, i32 0, i32 0
    %29 = load %"_Pshadow_Pstandard_CObject_Mclass"** %28
    %30 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %29, i32 0, i32 6
    %31 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %30
...
_label23:
    %34 = load %"_Pshadow_Pstandard_CString"** %_temp1
    %35 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %25, %"_Pshadow_Pstandard_CString"* %34)
    %36 = load %"_Pshadow_Pstandard_CString"** %y
    %37 = icmp eq %"_Pshadow_Pstandard_CString"* %36, null
    br %boolean %37, label %_label24, label %_label25
_label24:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label26
_label25:
    %38 = load %"_Pshadow_Pstandard_CString"** %y
    %39 = bitcast %"_Pshadow_Pstandard_CString"* %38 to %"_Pshadow_Pstandard_CObject"*
    %40 = getelementptr %"_Pshadow_Pstandard_CObject"* %39, i32 0, i32 0
    %41 = load %"_Pshadow_Pstandard_CObject_Mclass"** %40
    %42 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %41, i32 0, i32 6
    %43 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %42
    %44 = load %"_Pshadow_Pstandard_CString"** %y
    %45 = bitcast %"_Pshadow_Pstandard_CString"* %44 to %"_Pshadow_Pstandard_CObject"*
    %46 = call %"_Pshadow_Pstandard_CString"* %43(%"_Pshadow_Pstandard_CObject"* %45)
    store %"_Pshadow_Pstandard_CString"* %46, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label26
_label26:
    %47 = load %"_Pshadow_Pstandard_CString"** %_temp2
    %48 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %35, %"_Pshadow_Pstandard_CString"* %47)
    %49 = icmp eq %"_Pshadow_Pstandard_CString"* @_string5, null
    br %boolean %49, label %_label27, label %_label28
_label27:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp3
    br label %_label29
_label28:
    %50 = bitcast %"_Pshadow_Pstandard_CString"* @_string5 to %"_Pshadow_Pstandard_CObject"*
    %51 = getelementptr %"_Pshadow_Pstandard_CObject"* %50, i32 0, i32 0
    %52 = load %"_Pshadow_Pstandard_CObject_Mclass"** %51
    %53 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %52, i32 0, i32 6
    %54 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %53
    %55 = bitcast %"_Pshadow_Pstandard_CString"* @_string5 to %"_Pshadow_Pstandard_CObject"*
    %56 = call %"_Pshadow_Pstandard_CString"* %54(%"_Pshadow_Pstandard_CObject"* %55)
    store %"_Pshadow_Pstandard_CString"* %56, %"_Pshadow_Pstandard_CString"** %_temp3
    br label %_label29
_label29:
    %57 = load %"_Pshadow_Pstandard_CString"** %_temp3
    %58 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %48, %"_Pshadow_Pstandard_CString"* %57)
    %59 = bitcast %"_Pshadow_Pstandard_CString"* %58 to %"_Pshadow_Pstandard_CObject"*
    %60 = call %"_Pshadow_Pio_CConsole"* %16(%"_Pshadow_Pio_CConsole"* %12, %"_Pshadow_Pstandard_CObject"* %59)
    ret %"_Pshadow_Ptest_CParentTest"* %0
}
