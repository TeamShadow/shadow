...
_label1:
    ...
    %14 = load %"_Pshadow_Ptest_CParentTest"** %this
    %15 = bitcast %"_Pshadow_Ptest_CParentTest"* %14 to %"_Pshadow_Pstandard_CObject"*
    %16 = call %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CObject_MgetClass"(%"_Pshadow_Pstandard_CObject"* %15)
    %17 = icmp eq %"_Pshadow_Pstandard_CClass"* %16, null
    br %boolean %17, label %_label2, label %_label3
_label2:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label4
_label3:
    %18 = bitcast %"_Pshadow_Pstandard_CClass"* %16 to %"_Pshadow_Pstandard_CObject"*
    ...
    %23 = bitcast %"_Pshadow_Pstandard_CClass"* %16 to %"_Pshadow_Pstandard_CObject"*
...
_label4:
    ...
    %26 = icmp eq %"_Pshadow_Pstandard_CString"* @_string2, null
    br %boolean %26, label %_label5, label %_label6
_label5:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label7
_label6:
    %27 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
    ...
    %32 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
...
_label7:
    ...
    %37 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %11, %"_Pshadow_Pstandard_CObject"* %36)
...
_label9:
    ...
    %15 = load %"_Pshadow_Ptest_CParentTest"** %this
    %16 = bitcast %"_Pshadow_Ptest_CParentTest"* %15 to %"_Pshadow_Pstandard_CObject"*
    %17 = call %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CObject_MgetClass"(%"_Pshadow_Pstandard_CObject"* %16)
    %18 = icmp eq %"_Pshadow_Pstandard_CClass"* %17, null
    br %boolean %18, label %_label10, label %_label11
_label10:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label12
_label11:
    %19 = bitcast %"_Pshadow_Pstandard_CClass"* %17 to %"_Pshadow_Pstandard_CObject"*
    %20 = getelementptr %"_Pshadow_Pstandard_CObject"* %19, i32 0, i32 0
    %21 = load %"_Pshadow_Pstandard_CObject_Mclass"** %20
    %22 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %21, i32 0, i32 6
    %23 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %22
    %24 = bitcast %"_Pshadow_Pstandard_CClass"* %17 to %"_Pshadow_Pstandard_CObject"*
    %25 = call %"_Pshadow_Pstandard_CString"* %23(%"_Pshadow_Pstandard_CObject"* %24)
    store %"_Pshadow_Pstandard_CString"* %25, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label12
_label12:
    %26 = load %"_Pshadow_Pstandard_CString"** %_temp
    %27 = icmp eq %"_Pshadow_Pstandard_CString"* @_string3, null
    br %boolean %27, label %_label13, label %_label14
_label13:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label15
_label14:
    %28 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    ...
    %33 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %34 = call %"_Pshadow_Pstandard_CString"* %32(%"_Pshadow_Pstandard_CObject"* %33)
    store %"_Pshadow_Pstandard_CString"* %34, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label15
_label15:
    %35 = load %"_Pshadow_Pstandard_CString"** %_temp1
    %36 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %26, %"_Pshadow_Pstandard_CString"* %35)
    %37 = load %int* %x
    %38 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %39 = bitcast %"_Pshadow_Pstandard_CObject"* %38 to %"_Pshadow_Pstandard_Cint"*
    %40 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %39, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %40
    %41 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %39, i32 0, i32 1
    store %int %37, %int* %41
    %42 = getelementptr %"_Pshadow_Pstandard_CObject"* %38, i32 0, i32 0
    %43 = load %"_Pshadow_Pstandard_CObject_Mclass"** %42
    %44 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %43, i32 0, i32 6
    %45 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %44
    %46 = load %int* %x
    %47 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %48 = bitcast %"_Pshadow_Pstandard_CObject"* %47 to %"_Pshadow_Pstandard_Cint"*
    %49 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %48, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %49
    %50 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %48, i32 0, i32 1
    store %int %46, %int* %50
    %51 = call %"_Pshadow_Pstandard_CString"* %45(%"_Pshadow_Pstandard_CObject"* %47)
    %52 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %36, %"_Pshadow_Pstandard_CString"* %51)
    %53 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %54 = bitcast %"_Pshadow_Pstandard_CObject"* %53 to %"_Pshadow_Pstandard_Ccode"*
    %55 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %54, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %55
    %56 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %54, i32 0, i32 1
    store %code 41, %code* %56
    %57 = getelementptr %"_Pshadow_Pstandard_CObject"* %53, i32 0, i32 0
    %58 = load %"_Pshadow_Pstandard_CObject_Mclass"** %57
    %59 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %58, i32 0, i32 6
    %60 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %59
    %61 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", i32 0, i32 0))
    %62 = bitcast %"_Pshadow_Pstandard_CObject"* %61 to %"_Pshadow_Pstandard_Ccode"*
    %63 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %62, i32 0, i32 0
    store %"_Pshadow_Pstandard_Ccode_Mclass"* @"_Pshadow_Pstandard_Ccode_Mclass", %"_Pshadow_Pstandard_Ccode_Mclass"** %63
    %64 = getelementptr inbounds %"_Pshadow_Pstandard_Ccode"* %62, i32 0, i32 1
    store %code 41, %code* %64
    %65 = call %"_Pshadow_Pstandard_CString"* %60(%"_Pshadow_Pstandard_CObject"* %61)
    %66 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %52, %"_Pshadow_Pstandard_CString"* %65)
    %67 = bitcast %"_Pshadow_Pstandard_CString"* %66 to %"_Pshadow_Pstandard_CObject"*
    %68 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %12, %"_Pshadow_Pstandard_CObject"* %67)
    ret %"_Pshadow_Ptest_CParentTest"* %0
}
...
_label17:
    ...
    %17 = call %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pstandard_CObject_MgetClass"(%"_Pshadow_Pstandard_CObject"* %16)
    %18 = icmp eq %"_Pshadow_Pstandard_CClass"* %17, null
    br %boolean %18, label %_label18, label %_label19
_label18:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label20
_label19:
...
_label20:
    %26 = load %"_Pshadow_Pstandard_CString"** %_temp
    %27 = icmp eq %"_Pshadow_Pstandard_CString"* @_string4, null
    br %boolean %27, label %_label21, label %_label22
_label21:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label23
_label22:
    %28 = bitcast %"_Pshadow_Pstandard_CString"* @_string4 to %"_Pshadow_Pstandard_CObject"*
    %29 = getelementptr %"_Pshadow_Pstandard_CObject"* %28, i32 0, i32 0
    %30 = load %"_Pshadow_Pstandard_CObject_Mclass"** %29
    %31 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %30, i32 0, i32 6
    %32 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %31
    %33 = bitcast %"_Pshadow_Pstandard_CString"* @_string4 to %"_Pshadow_Pstandard_CObject"*
    %34 = call %"_Pshadow_Pstandard_CString"* %32(%"_Pshadow_Pstandard_CObject"* %33)
    store %"_Pshadow_Pstandard_CString"* %34, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label23
_label23:
    %35 = load %"_Pshadow_Pstandard_CString"** %_temp1
    %36 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %26, %"_Pshadow_Pstandard_CString"* %35)
    %37 = load %"_Pshadow_Pstandard_CString"** %y
    %38 = icmp eq %"_Pshadow_Pstandard_CString"* %37, null
    br %boolean %38, label %_label24, label %_label25
_label24:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label26
_label25:
    %39 = load %"_Pshadow_Pstandard_CString"** %y
    %40 = bitcast %"_Pshadow_Pstandard_CString"* %39 to %"_Pshadow_Pstandard_CObject"*
    %41 = getelementptr %"_Pshadow_Pstandard_CObject"* %40, i32 0, i32 0
    ...
    %45 = load %"_Pshadow_Pstandard_CString"** %y
    %46 = bitcast %"_Pshadow_Pstandard_CString"* %45 to %"_Pshadow_Pstandard_CObject"*
    %47 = call %"_Pshadow_Pstandard_CString"* %44(%"_Pshadow_Pstandard_CObject"* %46)
    store %"_Pshadow_Pstandard_CString"* %47, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label26
_label26:
    %48 = load %"_Pshadow_Pstandard_CString"** %_temp2
    %49 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %36, %"_Pshadow_Pstandard_CString"* %48)
    %50 = icmp eq %"_Pshadow_Pstandard_CString"* @_string5, null
    br %boolean %50, label %_label27, label %_label28
_label27:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp3
    br label %_label29
_label28:
    %51 = bitcast %"_Pshadow_Pstandard_CString"* @_string5 to %"_Pshadow_Pstandard_CObject"*
    %52 = getelementptr %"_Pshadow_Pstandard_CObject"* %51, i32 0, i32 0
    ...
    %56 = bitcast %"_Pshadow_Pstandard_CString"* @_string5 to %"_Pshadow_Pstandard_CObject"*
    %57 = call %"_Pshadow_Pstandard_CString"* %55(%"_Pshadow_Pstandard_CObject"* %56)
    store %"_Pshadow_Pstandard_CString"* %57, %"_Pshadow_Pstandard_CString"** %_temp3
    br label %_label29
_label29:
    %58 = load %"_Pshadow_Pstandard_CString"** %_temp3
    %59 = call %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pstandard_CString_Mconcatenate_Pshadow_Pstandard_CString"(%"_Pshadow_Pstandard_CString"* %49, %"_Pshadow_Pstandard_CString"* %58)
    %60 = bitcast %"_Pshadow_Pstandard_CString"* %59 to %"_Pshadow_Pstandard_CObject"*
    %61 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %12, %"_Pshadow_Pstandard_CObject"* %60)
    ret %"_Pshadow_Ptest_CParentTest"* %0
}
