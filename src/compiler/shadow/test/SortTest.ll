...
%"_P_CSortTest_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)*, %"_P_CSortTest"* (%"_P_CSortTest"*, %int, %int, %int)*, { %int*, [1 x %int] } (%"_P_CSortTest"*)*, %int (%"_P_CSortTest"*)*, %int (%"_P_CSortTest"*)*, %int (%"_P_CSortTest"*)*, %int (%"_P_CSortTest"*)*, %int (%"_P_CSortTest"*)*, %double (%"_P_CSortTest"*)*, void (%"_P_CSortTest"*, { %int*, [1 x %int] })*, { %int*, [1 x %int] } (%"_P_CSortTest"*, { %int*, [1 x %int] })*, void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)*, void (%"_P_CSortTest"*)* }
%"_P_CSortTest" = type { %"_P_CSortTest_Mclass"*, { %int*, [1 x %int] }, %ulong, %int, %int }
...
%"_Pshadow_Putility_CRandom_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Putility_CRandom"* (%"_Pshadow_Putility_CRandom"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Putility_CRandom"* (%"_Pshadow_Putility_CRandom"*, %ulong)*, %int (%"_Pshadow_Putility_CRandom"*)*, %int (%"_Pshadow_Putility_CRandom"*, %int)*, %uint (%"_Pshadow_Putility_CRandom"*)*, %uint (%"_Pshadow_Putility_CRandom"*, %uint)*, void (%"_Pshadow_Putility_CRandom"*, %ulong)* }
...
%"_Pshadow_Pstandard_CSystem_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CSystem"* (%"_Pshadow_Pstandard_CSystem"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, %ulong (%"_Pshadow_Pstandard_CSystem"*)* }
...
@"_P_CSortTest_Mclass" = global %"_P_CSortTest_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CInterface"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_P_CSortTest"* getelementptr (%"_P_CSortTest"* null, i32 1) to i32), %int ptrtoint (%"_P_CSortTest"** getelementptr (%"_P_CSortTest"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)* @"_P_CSortTest_MbucketSort_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint", %"_P_CSortTest"* (%"_P_CSortTest"*, %int, %int, %int)* @"_P_CSortTest_Mcreate_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint", { %int*, [1 x %int] } (%"_P_CSortTest"*)* @"_P_CSortTest_MgetArray", %int (%"_P_CSortTest"*)* @"_P_CSortTest_MgetArrayEnd", %int (%"_P_CSortTest"*)* @"_P_CSortTest_MgetArrayLength", %int (%"_P_CSortTest"*)* @"_P_CSortTest_MgetArrayStart", %int (%"_P_CSortTest"*)* @"_P_CSortTest_MgetMaximum", %int (%"_P_CSortTest"*)* @"_P_CSortTest_MgetMinimum", %double (%"_P_CSortTest"*)* @"_P_CSortTest_MgetTime", void (%"_P_CSortTest"*, { %int*, [1 x %int] })* @"_P_CSortTest_MheapSort_Pshadow_Pstandard_Cint_A1", { %int*, [1 x %int] } (%"_P_CSortTest"*, { %int*, [1 x %int] })* @"_P_CSortTest_MmergeSort_Pshadow_Pstandard_Cint_A1", void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)* @"_P_CSortTest_MquickSort_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint", void (%"_P_CSortTest"*)* @"_P_CSortTest_Mrun" }
...
@"_Pshadow_Putility_CRandom_Mclass" = external global %"_Pshadow_Putility_CRandom_Mclass"
...
@"_Pshadow_Pstandard_CSystem_Mclass" = external global %"_Pshadow_Pstandard_CSystem_Mclass"
...
define %boolean @"_P_CSortTest_McheckArray_Pshadow_Pstandard_Cint_A1"(%"_P_CSortTest"*, { %int*, [1 x %int] }) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    %last = alloca %int
    %i = alloca %int
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    store { %int*, [1 x %int] } %1, { %int*, [1 x %int] }* %array
    %3 = load %"_P_CSortTest"** %this
    %4 = getelementptr %"_P_CSortTest"* %3, i32 0, i32 0
    %5 = load %"_P_CSortTest_Mclass"** %4
    %6 = getelementptr %"_P_CSortTest_Mclass"* %5, i32 0, i32 15
    %7 = load %int (%"_P_CSortTest"*)** %6
    %8 = call %int %7(%"_P_CSortTest"* %3)
    store %int %8, %int* %last
    store %int 0, %int* %i
    br label %_label1
_label0:
    ...
    %13 = load %int* %12
    %14 = load %int* %last
    %15 = icmp slt %int %13, %14
    br %boolean %15, label %_label3, label %_label4
_label3:
    ret %boolean false
    br label %_label5
_label4:
...
_label1:
    ...
    %25 = extractvalue { %int*, [1 x %int] } %24, 1, 0
    %26 = load %int* %i
    %27 = icmp slt %int %26, %25
    br %boolean %27, label %_label0, label %_label2
_label2:
    ret %boolean true
}

define void @"_P_CSortTest_Mstop_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CString"(%"_P_CSortTest"*, { %int*, [1 x %int] }, %"_Pshadow_Pstandard_CString"*) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    ...
    %4 = load %"_P_CSortTest"** %this
    %5 = getelementptr %"_P_CSortTest"* %4, i32 0, i32 0
    %6 = load %"_P_CSortTest_Mclass"** %5
    %7 = getelementptr %"_P_CSortTest_Mclass"* %6, i32 0, i32 16
    %8 = load %double (%"_P_CSortTest"*)** %7
    %9 = call %double %8(%"_P_CSortTest"* %4)
    store %double %9, %double* %time
    %10 = load %"_P_CSortTest"** %this
    %11 = load { %int*, [1 x %int] }* %array
    %12 = call %boolean @"_P_CSortTest_McheckArray_Pshadow_Pstandard_Cint_A1"(%"_P_CSortTest"* %10, { %int*, [1 x %int] } %11)
    br %boolean %12, label %_label6, label %_label7
_label6:
    %13 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %14 = icmp eq %"_Pshadow_Pio_CConsole"* %13, null
    br %boolean %14, label %_label9, label %_label10
_label9:
    %15 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pio_CConsole_Mclass"* @"_Pshadow_Pio_CConsole_Mclass", i32 0, i32 0))
    %16 = bitcast %"_Pshadow_Pstandard_CObject"* %15 to %"_Pshadow_Pio_CConsole"*
    %17 = getelementptr %"_Pshadow_Pio_CConsole"* %16, i32 0, i32 0
    %18 = load %"_Pshadow_Pio_CConsole_Mclass"** %17
    %19 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %18, i32 0, i32 2
    %20 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %19
    %21 = call %"_Pshadow_Pio_CConsole"* %20(%"_Pshadow_Pio_CConsole"* %16)
    store %"_Pshadow_Pio_CConsole"* %21, %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    br label %_label10
_label10:
    %22 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %23 = load %"_Pshadow_Pstandard_CString"** %name
    %24 = icmp eq %"_Pshadow_Pstandard_CString"* %23, null
    br %boolean %24, label %_label11, label %_label12
_label11:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label13
_label12:
    %25 = load %"_Pshadow_Pstandard_CString"** %name
    %26 = bitcast %"_Pshadow_Pstandard_CString"* %25 to %"_Pshadow_Pstandard_CObject"*
    %27 = getelementptr %"_Pshadow_Pstandard_CObject"* %26, i32 0, i32 0
    %28 = load %"_Pshadow_Pstandard_CObject_Mclass"** %27
    %29 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %28, i32 0, i32 7
    %30 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %29
    %31 = call %"_Pshadow_Pstandard_CString"* %30(%"_Pshadow_Pstandard_CObject"* %26)
...
_label15:
    ...
    %37 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %36, i32 0, i32 7
    %38 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %37
    %39 = call %"_Pshadow_Pstandard_CString"* %38(%"_Pshadow_Pstandard_CObject"* %34)
    store %"_Pshadow_Pstandard_CString"* %39, %"_Pshadow_Pstandard_CString"** %_temp1
    br label %_label16
_label16:
    %40 = load %"_Pshadow_Pstandard_CString"** %_temp1
    %41 = getelementptr %"_Pshadow_Pstandard_CString"* %32, i32 0, i32 0
    %42 = load %"_Pshadow_Pstandard_CString_Mclass"** %41
    %43 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %42, i32 0, i32 10
    %44 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, %"_Pshadow_Pstandard_CString"*)** %43
    %45 = call %"_Pshadow_Pstandard_CString"* %44(%"_Pshadow_Pstandard_CString"* %32, %"_Pshadow_Pstandard_CString"* %40)
    %46 = load %double* %time
    %47 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cdouble_Mclass"* @"_Pshadow_Pstandard_Cdouble_Mclass", i32 0, i32 0))
    %48 = bitcast %"_Pshadow_Pstandard_CObject"*%47 to %"_Pshadow_Pstandard_Cdouble"*
    %49 = getelementptr inbounds %"_Pshadow_Pstandard_Cdouble"*%48, i32 0, i32 1
    store %double %46, %double* %49
    %50 = getelementptr %"_Pshadow_Pstandard_CObject"* %47, i32 0, i32 0
    %51 = load %"_Pshadow_Pstandard_CObject_Mclass"** %50
    %52 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %51, i32 0, i32 7
    %53 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %52
    %54 = call %"_Pshadow_Pstandard_CString"* %53(%"_Pshadow_Pstandard_CObject"* %47)
    %55 = getelementptr %"_Pshadow_Pstandard_CString"* %45, i32 0, i32 0
    %56 = load %"_Pshadow_Pstandard_CString_Mclass"** %55
    %57 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %56, i32 0, i32 10
    %58 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, %"_Pshadow_Pstandard_CString"*)** %57
    %59 = call %"_Pshadow_Pstandard_CString"* %58(%"_Pshadow_Pstandard_CString"* %45, %"_Pshadow_Pstandard_CString"* %54)
    %60 = icmp eq %"_Pshadow_Pstandard_CString"* @_string3, null
    br %boolean %60, label %_label17, label %_label18
_label17:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label19
_label18:
    %61 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %62 = getelementptr %"_Pshadow_Pstandard_CObject"* %61, i32 0, i32 0
    %63 = load %"_Pshadow_Pstandard_CObject_Mclass"** %62
    %64 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %63, i32 0, i32 7
    %65 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %64
    %66 = call %"_Pshadow_Pstandard_CString"* %65(%"_Pshadow_Pstandard_CObject"* %61)
    store %"_Pshadow_Pstandard_CString"* %66, %"_Pshadow_Pstandard_CString"** %_temp2
    br label %_label19
_label19:
    %67 = load %"_Pshadow_Pstandard_CString"** %_temp2
    %68 = getelementptr %"_Pshadow_Pstandard_CString"* %59, i32 0, i32 0
    %69 = load %"_Pshadow_Pstandard_CString_Mclass"** %68
    %70 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %69, i32 0, i32 10
    %71 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, %"_Pshadow_Pstandard_CString"*)** %70
    %72 = call %"_Pshadow_Pstandard_CString"* %71(%"_Pshadow_Pstandard_CString"* %59, %"_Pshadow_Pstandard_CString"* %67)
    %73 = bitcast %"_Pshadow_Pstandard_CString"* %72 to %"_Pshadow_Pstandard_CObject"*
    %74 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %22, %"_Pshadow_Pstandard_CObject"* %73)
    br label %_label8
_label7:
...
_label20:
    ...
    %81 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %80, i32 0, i32 2
    %82 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %81
    %83 = call %"_Pshadow_Pio_CConsole"* %82(%"_Pshadow_Pio_CConsole"* %78)
    store %"_Pshadow_Pio_CConsole"* %83, %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    br label %_label21
_label21:
    %84 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
...
_label23:
    ...
    %91 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %90, i32 0, i32 7
    %92 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %91
    %93 = call %"_Pshadow_Pstandard_CString"* %92(%"_Pshadow_Pstandard_CObject"* %88)
    store %"_Pshadow_Pstandard_CString"* %93, %"_Pshadow_Pstandard_CString"** %_temp3
    br label %_label24
_label24:
    %94 = load %"_Pshadow_Pstandard_CString"** %_temp3
    %95 = icmp eq %"_Pshadow_Pstandard_CString"* @_string2, null
    br %boolean %95, label %_label25, label %_label26
_label25:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp4
    br label %_label27
_label26:
    %96 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
    %97 = getelementptr %"_Pshadow_Pstandard_CObject"* %96, i32 0, i32 0
    %98 = load %"_Pshadow_Pstandard_CObject_Mclass"** %97
    %99 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %98, i32 0, i32 7
    %100 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %99
    %101 = call %"_Pshadow_Pstandard_CString"* %100(%"_Pshadow_Pstandard_CObject"* %96)
    store %"_Pshadow_Pstandard_CString"* %101, %"_Pshadow_Pstandard_CString"** %_temp4
    br label %_label27
_label27:
    %102 = load %"_Pshadow_Pstandard_CString"** %_temp4
    %103 = getelementptr %"_Pshadow_Pstandard_CString"* %94, i32 0, i32 0
    %104 = load %"_Pshadow_Pstandard_CString_Mclass"** %103
    %105 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %104, i32 0, i32 10
    %106 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, %"_Pshadow_Pstandard_CString"*)** %105
    %107 = call %"_Pshadow_Pstandard_CString"* %106(%"_Pshadow_Pstandard_CString"* %94, %"_Pshadow_Pstandard_CString"* %102)
    %108 = load %double* %time
    %109 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cdouble_Mclass"* @"_Pshadow_Pstandard_Cdouble_Mclass", i32 0, i32 0))
    %110 = bitcast %"_Pshadow_Pstandard_CObject"*%109 to %"_Pshadow_Pstandard_Cdouble"*
    %111 = getelementptr inbounds %"_Pshadow_Pstandard_Cdouble"*%110, i32 0, i32 1
    store %double %108, %double* %111
    %112 = getelementptr %"_Pshadow_Pstandard_CObject"* %109, i32 0, i32 0
    %113 = load %"_Pshadow_Pstandard_CObject_Mclass"** %112
    %114 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %113, i32 0, i32 7
    %115 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %114
    %116 = call %"_Pshadow_Pstandard_CString"* %115(%"_Pshadow_Pstandard_CObject"* %109)
    %117 = getelementptr %"_Pshadow_Pstandard_CString"* %107, i32 0, i32 0
    %118 = load %"_Pshadow_Pstandard_CString_Mclass"** %117
    %119 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %118, i32 0, i32 10
    %120 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, %"_Pshadow_Pstandard_CString"*)** %119
    %121 = call %"_Pshadow_Pstandard_CString"* %120(%"_Pshadow_Pstandard_CString"* %107, %"_Pshadow_Pstandard_CString"* %116)
    %122 = icmp eq %"_Pshadow_Pstandard_CString"* @_string3, null
    br %boolean %122, label %_label28, label %_label29
_label28:
    store %"_Pshadow_Pstandard_CString"* @_string1, %"_Pshadow_Pstandard_CString"** %_temp5
    br label %_label30
_label29:
    %123 = bitcast %"_Pshadow_Pstandard_CString"* @_string3 to %"_Pshadow_Pstandard_CObject"*
    %124 = getelementptr %"_Pshadow_Pstandard_CObject"* %123, i32 0, i32 0
    %125 = load %"_Pshadow_Pstandard_CObject_Mclass"** %124
    %126 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %125, i32 0, i32 7
    %127 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %126
    %128 = call %"_Pshadow_Pstandard_CString"* %127(%"_Pshadow_Pstandard_CObject"* %123)
    store %"_Pshadow_Pstandard_CString"* %128, %"_Pshadow_Pstandard_CString"** %_temp5
    br label %_label30
_label30:
    %129 = load %"_Pshadow_Pstandard_CString"** %_temp5
    %130 = getelementptr %"_Pshadow_Pstandard_CString"* %121, i32 0, i32 0
    %131 = load %"_Pshadow_Pstandard_CString_Mclass"** %130
    %132 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %131, i32 0, i32 10
    %133 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, %"_Pshadow_Pstandard_CString"*)** %132
    %134 = call %"_Pshadow_Pstandard_CString"* %133(%"_Pshadow_Pstandard_CString"* %121, %"_Pshadow_Pstandard_CString"* %129)
    %135 = bitcast %"_Pshadow_Pstandard_CString"* %134 to %"_Pshadow_Pstandard_CObject"*
    %136 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintErrorLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %84, %"_Pshadow_Pstandard_CObject"* %135)
    br label %_label8
_label8:
    %137 = load %"_P_CSortTest"** %this
    %138 = getelementptr inbounds %"_P_CSortTest"* %137, i32 0, i32 2
    store %ulong 0, %ulong* %138
    ret void
}

define %int @"_P_CSortTest_MgetMaximum"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    %3 = getelementptr inbounds %"_P_CSortTest"* %2, i32 0, i32 3
    %4 = load %int* %3
    ret %int %4
}

define %int @"_P_CSortTest_MgetArrayLength"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    %3 = getelementptr inbounds %"_P_CSortTest"* %2, i32 0, i32 1
    %4 = load { %int*, [1 x %int] }* %3
    %5 = extractvalue { %int*, [1 x %int] } %4, 1, 0
    ret %int %5
}

define %int @"_P_CSortTest_MgetArrayStart"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    ret %int 0
}

define void @"_P_CSortTest_Mrun"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    %_temp = alloca %"_Pshadow_Pstandard_CString"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
...
_label31:
    ...
    %8 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %7, i32 0, i32 2
    %9 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %8
    %10 = call %"_Pshadow_Pio_CConsole"* %9(%"_Pshadow_Pio_CConsole"* %5)
...
_label34:
    ...
    %16 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %15, i32 0, i32 7
    %17 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %16
    %18 = call %"_Pshadow_Pstandard_CString"* %17(%"_Pshadow_Pstandard_CObject"* %13)
    store %"_Pshadow_Pstandard_CString"* %18, %"_Pshadow_Pstandard_CString"** %_temp
    br label %_label35
_label35:
    %19 = load %"_Pshadow_Pstandard_CString"** %_temp
    %20 = load %"_P_CSortTest"** %this
    %21 = getelementptr %"_P_CSortTest"* %20, i32 0, i32 0
    %22 = load %"_P_CSortTest_Mclass"** %21
    %23 = getelementptr %"_P_CSortTest_Mclass"* %22, i32 0, i32 12
    %24 = load %int (%"_P_CSortTest"*)** %23
    %25 = call %int %24(%"_P_CSortTest"* %20)
    %26 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %27 = bitcast %"_Pshadow_Pstandard_CObject"*%26 to %"_Pshadow_Pstandard_Cint"*
    %28 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%27, i32 0, i32 1
    store %int %25, %int* %28
    %29 = getelementptr %"_Pshadow_Pstandard_CObject"* %26, i32 0, i32 0
    %30 = load %"_Pshadow_Pstandard_CObject_Mclass"** %29
    %31 = getelementptr %"_Pshadow_Pstandard_CObject_Mclass"* %30, i32 0, i32 7
    %32 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)** %31
    %33 = call %"_Pshadow_Pstandard_CString"* %32(%"_Pshadow_Pstandard_CObject"* %26)
    %34 = getelementptr %"_Pshadow_Pstandard_CString"* %19, i32 0, i32 0
    %35 = load %"_Pshadow_Pstandard_CString_Mclass"** %34
    %36 = getelementptr %"_Pshadow_Pstandard_CString_Mclass"* %35, i32 0, i32 10
    %37 = load %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CString"*, %"_Pshadow_Pstandard_CString"*)** %36
    %38 = call %"_Pshadow_Pstandard_CString"* %37(%"_Pshadow_Pstandard_CString"* %19, %"_Pshadow_Pstandard_CString"* %33)
    %39 = bitcast %"_Pshadow_Pstandard_CString"* %38 to %"_Pshadow_Pstandard_CObject"*
    %40 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CConsole"* %11, %"_Pshadow_Pstandard_CObject"* %39)
    %41 = load %"_P_CSortTest"** %this
    call void @"_P_CSortTest_MquickSort"(%"_P_CSortTest"* %41)
    %42 = load %"_P_CSortTest"** %this
    call void @"_P_CSortTest_MmergeSort"(%"_P_CSortTest"* %42)
    %43 = load %"_P_CSortTest"** %this
    call void @"_P_CSortTest_MheapSort"(%"_P_CSortTest"* %43)
    %44 = load %"_P_CSortTest"** %this
    call void @"_P_CSortTest_MbucketSort"(%"_P_CSortTest"* %44)
    %45 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %46 = icmp eq %"_Pshadow_Pio_CConsole"* %45, null
    br %boolean %46, label %_label36, label %_label37
_label36:
    ...
    %51 = getelementptr %"_Pshadow_Pio_CConsole_Mclass"* %50, i32 0, i32 2
    %52 = load %"_Pshadow_Pio_CConsole"* (%"_Pshadow_Pio_CConsole"*)** %51
    %53 = call %"_Pshadow_Pio_CConsole"* %52(%"_Pshadow_Pio_CConsole"* %48)
    store %"_Pshadow_Pio_CConsole"* %53, %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    br label %_label37
_label37:
    %54 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_Minstance"
    %55 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine"(%"_Pshadow_Pio_CConsole"* %54)
    ret void
}

define %"_P_CSortTest"* @"_P_CSortTest_Mcreate_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint"(%"_P_CSortTest"*, %int, %int, %int) {
    %this = alloca %"_P_CSortTest"*
    %length = alloca %int
    %min = alloca %int
    %max = alloca %int
    ...
    %i = alloca %int
    %5 = getelementptr inbounds %"_P_CSortTest"* %0, i32 0, i32 0
    store %"_P_CSortTest_Mclass"* @"_P_CSortTest_Mclass", %"_P_CSortTest_Mclass"** %5
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    store %int %1, %int* %length
    store %int %2, %int* %min
    store %int %3, %int* %max
    %6 = load %"_P_CSortTest"** %this
    %7 = getelementptr inbounds %"_P_CSortTest"* %6, i32 0, i32 2
    store %ulong 0, %ulong* %7
    %8 = load %"_P_CSortTest"** %this
    %9 = getelementptr inbounds %"_P_CSortTest"* %8, i32 0, i32 4
    store %int 0, %int* %9
    %10 = load %"_P_CSortTest"** %this
    %11 = getelementptr inbounds %"_P_CSortTest"* %10, i32 0, i32 3
    store %int 0, %int* %11
    %12 = load %"_P_CSortTest"** %this
    %13 = getelementptr inbounds %"_P_CSortTest"* %12, i32 0, i32 1
    %14 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int 0)
    %15 = bitcast %"_Pshadow_Pstandard_CObject"* %14 to %int*
    %16 = insertvalue { %int*, [1 x %int] } undef, %int* %15, 0
    %17 = insertvalue { %int*, [1 x %int] } %16, %int 0, 1, 0
    store { %int*, [1 x %int] } %17, { %int*, [1 x %int] }* %13
    %18 = load %int* %length
    %19 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int %18)
    %20 = bitcast %"_Pshadow_Pstandard_CObject"* %19 to %int*
    %21 = insertvalue { %int*, [1 x %int] } undef, %int* %20, 0
    %22 = insertvalue { %int*, [1 x %int] } %21, %int %18, 1, 0
    store { %int*, [1 x %int] } %22, { %int*, [1 x %int] }* %array
    %23 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Putility_CRandom_Mclass"* @"_Pshadow_Putility_CRandom_Mclass", i32 0, i32 0))
    %24 = bitcast %"_Pshadow_Pstandard_CObject"* %23 to %"_Pshadow_Putility_CRandom"*
    %25 = getelementptr %"_Pshadow_Putility_CRandom"* %24, i32 0, i32 0
    %26 = load %"_Pshadow_Putility_CRandom_Mclass"** %25
    %27 = getelementptr %"_Pshadow_Putility_CRandom_Mclass"* %26, i32 0, i32 2
    %28 = load %"_Pshadow_Putility_CRandom"* (%"_Pshadow_Putility_CRandom"*)** %27
    %29 = call %"_Pshadow_Putility_CRandom"* %28(%"_Pshadow_Putility_CRandom"* %24)
    store %"_Pshadow_Putility_CRandom"* %24, %"_Pshadow_Putility_CRandom"** %random
    store %int 0, %int* %i
    br label %_label39
_label38:
    %30 = load %int* %max
    ...
    %32 = sub %int %30, %31
    %33 = add %int %32, 1
    %34 = load %"_Pshadow_Putility_CRandom"** %random
    %35 = getelementptr %"_Pshadow_Putility_CRandom"* %34, i32 0, i32 0
    %36 = load %"_Pshadow_Putility_CRandom_Mclass"** %35
    %37 = getelementptr %"_Pshadow_Putility_CRandom_Mclass"* %36, i32 0, i32 10
    %38 = load %int (%"_Pshadow_Putility_CRandom"*, %int)** %37
    %39 = call %int %38(%"_Pshadow_Putility_CRandom"* %34, %int %33)
    %40 = load %int* %min
    %41 = add %int %39, %40
...
_label40:
    %52 = load %"_P_CSortTest"** %this
    %53 = getelementptr inbounds %"_P_CSortTest"* %52, i32 0, i32 1
    %54 = load { %int*, [1 x %int] }* %array
    store { %int*, [1 x %int] } %54, { %int*, [1 x %int] }* %53
    %55 = load %"_P_CSortTest"** %this
    %56 = getelementptr inbounds %"_P_CSortTest"* %55, i32 0, i32 4
    %57 = load %int* %min
    store %int %57, %int* %56
    %58 = load %"_P_CSortTest"** %this
    %59 = getelementptr inbounds %"_P_CSortTest"* %58, i32 0, i32 3
    %60 = load %int* %max
    store %int %60, %int* %59
    %61 = load %"_P_CSortTest"** %this
    %62 = getelementptr inbounds %"_P_CSortTest"* %61, i32 0, i32 2
    store %ulong 0, %ulong* %62
    ret %"_P_CSortTest"* %0
}

define void @"_P_CSortTest_MquickSort"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    %3 = getelementptr %"_P_CSortTest"* %2, i32 0, i32 0
    %4 = load %"_P_CSortTest_Mclass"** %3
    %5 = getelementptr %"_P_CSortTest_Mclass"* %4, i32 0, i32 10
    %6 = load { %int*, [1 x %int] } (%"_P_CSortTest"*)** %5
    %7 = call { %int*, [1 x %int] } %6(%"_P_CSortTest"* %2)
    store { %int*, [1 x %int] } %7, { %int*, [1 x %int] }* %array
    %8 = load %"_P_CSortTest"** %this
    call void @"_P_CSortTest_Mstart"(%"_P_CSortTest"* %8)
    %9 = load %"_P_CSortTest"** %this
    %10 = getelementptr %"_P_CSortTest"* %9, i32 0, i32 0
    %11 = load %"_P_CSortTest_Mclass"** %10
    %12 = getelementptr %"_P_CSortTest_Mclass"* %11, i32 0, i32 12
    %13 = load %int (%"_P_CSortTest"*)** %12
    %14 = call %int %13(%"_P_CSortTest"* %9)
    %15 = load %"_P_CSortTest"** %this
    %16 = load { %int*, [1 x %int] }* %array
    %17 = getelementptr %"_P_CSortTest"* %15, i32 0, i32 0
    %18 = load %"_P_CSortTest_Mclass"** %17
    %19 = getelementptr %"_P_CSortTest_Mclass"* %18, i32 0, i32 19
    %20 = load void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)** %19
    call void %20(%"_P_CSortTest"* %15, { %int*, [1 x %int] } %16, %int 0, %int %14)
    %21 = load %"_P_CSortTest"** %this
    %22 = load { %int*, [1 x %int] }* %array
    call void @"_P_CSortTest_Mstop_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CString"(%"_P_CSortTest"* %21, { %int*, [1 x %int] } %22, %"_Pshadow_Pstandard_CString"* @_string5)
    ret void
}

define void @"_P_CSortTest_MquickSort_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint"(%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    %start = alloca %int
    %end = alloca %int
...
_label46:
    ...
    %53 = load %int* %pivot
    store %int %53, %int* %52
    %54 = load %"_P_CSortTest"** %this
    %55 = load { %int*, [1 x %int] }* %array
    %56 = load %int* %start
    %57 = load %int* %left
    %58 = getelementptr %"_P_CSortTest"* %54, i32 0, i32 0
    %59 = load %"_P_CSortTest_Mclass"** %58
    %60 = getelementptr %"_P_CSortTest_Mclass"* %59, i32 0, i32 19
    %61 = load void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)** %60
    call void %61(%"_P_CSortTest"* %54, { %int*, [1 x %int] } %55, %int %56, %int %57)
    %62 = load %int* %left
    %63 = add %int %62, 1
    %64 = load %"_P_CSortTest"** %this
    %65 = load { %int*, [1 x %int] }* %array
    %66 = load %int* %end
    %67 = getelementptr %"_P_CSortTest"* %64, i32 0, i32 0
    %68 = load %"_P_CSortTest_Mclass"** %67
    %69 = getelementptr %"_P_CSortTest_Mclass"* %68, i32 0, i32 19
    %70 = load void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)** %69
    call void %70(%"_P_CSortTest"* %64, { %int*, [1 x %int] } %65, %int %63, %int %66)
    br label %_label43
_label42:
    br label %_label43
_label43:
...
define void @"_P_CSortTest_MheapSort"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    ...
    %11 = getelementptr %"_P_CSortTest"* %9, i32 0, i32 0
    %12 = load %"_P_CSortTest_Mclass"** %11
    %13 = getelementptr %"_P_CSortTest_Mclass"* %12, i32 0, i32 17
    %14 = load void (%"_P_CSortTest"*, { %int*, [1 x %int] })** %13
    call void %14(%"_P_CSortTest"* %9, { %int*, [1 x %int] } %10)
    %15 = load %"_P_CSortTest"** %this
    %16 = load { %int*, [1 x %int] }* %array
    call void @"_P_CSortTest_Mstop_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CString"(%"_P_CSortTest"* %15, { %int*, [1 x %int] } %16, %"_Pshadow_Pstandard_CString"* @_string6)
    ret void
}

define void @"_P_CSortTest_MheapSort_Pshadow_Pstandard_Cint_A1"(%"_P_CSortTest"*, { %int*, [1 x %int] }) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    %i = alloca %int
    %j = alloca %int
...
define { %int*, [1 x %int] } @"_P_CSortTest_MgetArray"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    %3 = getelementptr inbounds %"_P_CSortTest"* %2, i32 0, i32 1
    ...
    %25 = load [1 x %int]* %24
    %26 = insertvalue { %int*, [1 x %int] } %21, [1 x %int] %25, 1
    ret { %int*, [1 x %int] } %26
}

define void @"_P_CSortTest_MmergeSort"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    ...
    %11 = getelementptr %"_P_CSortTest"* %9, i32 0, i32 0
    %12 = load %"_P_CSortTest_Mclass"** %11
    %13 = getelementptr %"_P_CSortTest_Mclass"* %12, i32 0, i32 18
    %14 = load { %int*, [1 x %int] } (%"_P_CSortTest"*, { %int*, [1 x %int] })** %13
    %15 = call { %int*, [1 x %int] } %14(%"_P_CSortTest"* %9, { %int*, [1 x %int] } %10)
    %16 = load %"_P_CSortTest"** %this
    %17 = load { %int*, [1 x %int] }* %array
    call void @"_P_CSortTest_Mstop_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CString"(%"_P_CSortTest"* %16, { %int*, [1 x %int] } %17, %"_Pshadow_Pstandard_CString"* @_string7)
    ret void
}

define { %int*, [1 x %int] } @"_P_CSortTest_MmergeSort_Pshadow_Pstandard_Cint_A1"(%"_P_CSortTest"*, { %int*, [1 x %int] }) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
...
_label69:
    %6 = load { %int*, [1 x %int] }* %array
    %7 = extractvalue { %int*, [1 x %int] } %6, 1, 0
    %8 = ashr %int %7, 1
    %9 = load { %int*, [1 x %int] }* %array
    %10 = extractvalue { %int*, [1 x %int] } %9, 1
    %11 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int 1)
    %12 = bitcast %"_Pshadow_Pstandard_CObject"* %11 to [1 x %int]*
    store [1 x %int] %10, [1 x %int]* %12
    %13 = getelementptr inbounds [1 x %int]* %12, i32 0, i32 0
    %14 = insertvalue { %int*, [1 x %int] } { %int* null, [1 x %int] [%int 1] }, %int* %13, 0
    %15 = extractvalue { %int*, [1 x %int] } %9, 0
    %16 = bitcast %int* %15 to %"_Pshadow_Pstandard_CObject"*
    %17 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CArray_Mclass"* @"_Pshadow_Pstandard_CArray_Mclass", i32 0, i32 0))
    %18 = bitcast %"_Pshadow_Pstandard_CObject"* %17 to %"_Pshadow_Pstandard_CArray"*
    %19 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CArray"* %18, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), { %int*, [1 x %int] } %14, %"_Pshadow_Pstandard_CObject"* %16)
    %20 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Msubarray_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CArray"* %19, %int 0, %int %8)
    ...
    %25 = bitcast %"_Pshadow_Pstandard_CObject"* %24 to %int*
    %26 = insertvalue { %int*, [1 x %int] } undef, %int* %25, 0
    %27 = getelementptr inbounds %"_Pshadow_Pstandard_CArray"* %22, i32 0, i32 1, i32 0
    %28 = load %int** %27
    %29 = bitcast %int* %28 to [1 x %int]*
    %30 = load [1 x %int]* %29
    %31 = insertvalue { %int*, [1 x %int] } %26, [1 x %int] %30, 1
    %32 = load %"_P_CSortTest"** %this
    %33 = getelementptr %"_P_CSortTest"* %32, i32 0, i32 0
    %34 = load %"_P_CSortTest_Mclass"** %33
    %35 = getelementptr %"_P_CSortTest_Mclass"* %34, i32 0, i32 18
    %36 = load { %int*, [1 x %int] } (%"_P_CSortTest"*, { %int*, [1 x %int] })** %35
    %37 = call { %int*, [1 x %int] } %36(%"_P_CSortTest"* %32, { %int*, [1 x %int] } %31)
    store { %int*, [1 x %int] } %37, { %int*, [1 x %int] }* %left
    %38 = load { %int*, [1 x %int] }* %array
    %39 = extractvalue { %int*, [1 x %int] } %38, 1, 0
    %40 = ashr %int %39, 1
    %41 = load { %int*, [1 x %int] }* %array
    %42 = extractvalue { %int*, [1 x %int] } %41, 1, 0
    %43 = load { %int*, [1 x %int] }* %array
    %44 = extractvalue { %int*, [1 x %int] } %43, 1
    %45 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int 1)
    %46 = bitcast %"_Pshadow_Pstandard_CObject"* %45 to [1 x %int]*
    store [1 x %int] %44, [1 x %int]* %46
    %47 = getelementptr inbounds [1 x %int]* %46, i32 0, i32 0
    %48 = insertvalue { %int*, [1 x %int] } { %int* null, [1 x %int] [%int 1] }, %int* %47, 0
    %49 = extractvalue { %int*, [1 x %int] } %43, 0
    %50 = bitcast %int* %49 to %"_Pshadow_Pstandard_CObject"*
    %51 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CArray_Mclass"* @"_Pshadow_Pstandard_CArray_Mclass", i32 0, i32 0))
    %52 = bitcast %"_Pshadow_Pstandard_CObject"* %51 to %"_Pshadow_Pstandard_CArray"*
    %53 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Mcreate_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CObject"(%"_Pshadow_Pstandard_CArray"* %52, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), { %int*, [1 x %int] } %48, %"_Pshadow_Pstandard_CObject"* %50)
    %54 = call %"_Pshadow_Pstandard_CArray"* @"_Pshadow_Pstandard_CArray_Msubarray_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CArray"* %53, %int %40, %int %42)
    %55 = bitcast %"_Pshadow_Pstandard_CArray"* %54 to %"_Pshadow_Pstandard_CObject"*
    %56 = bitcast %"_Pshadow_Pstandard_CObject"* %55 to %"_Pshadow_Pstandard_CArray"*
    %57 = getelementptr inbounds %"_Pshadow_Pstandard_CArray"* %56, i32 0, i32 3
    %58 = load %"_Pshadow_Pstandard_CObject"** %57
    %59 = bitcast %"_Pshadow_Pstandard_CObject"* %58 to %int*
    %60 = insertvalue { %int*, [1 x %int] } undef, %int* %59, 0
    %61 = getelementptr inbounds %"_Pshadow_Pstandard_CArray"* %56, i32 0, i32 1, i32 0
    %62 = load %int** %61
    %63 = bitcast %int* %62 to [1 x %int]*
    %64 = load [1 x %int]* %63
    %65 = insertvalue { %int*, [1 x %int] } %60, [1 x %int] %64, 1
    %66 = load %"_P_CSortTest"** %this
    %67 = getelementptr %"_P_CSortTest"* %66, i32 0, i32 0
    %68 = load %"_P_CSortTest_Mclass"** %67
    %69 = getelementptr %"_P_CSortTest_Mclass"* %68, i32 0, i32 18
    %70 = load { %int*, [1 x %int] } (%"_P_CSortTest"*, { %int*, [1 x %int] })** %69
    %71 = call { %int*, [1 x %int] } %70(%"_P_CSortTest"* %66, { %int*, [1 x %int] } %65)
    store { %int*, [1 x %int] } %71, { %int*, [1 x %int] }* %right
    %72 = load { %int*, [1 x %int] }* %array
    %73 = extractvalue { %int*, [1 x %int] } %72, 1, 0
    %74 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate_Pshadow_Pstandard_Cint"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0), %int %73)
    %75 = bitcast %"_Pshadow_Pstandard_CObject"* %74 to %int*
    %76 = insertvalue { %int*, [1 x %int] } undef, %int* %75, 0
    %77 = insertvalue { %int*, [1 x %int] } %76, %int %73, 1, 0
    store { %int*, [1 x %int] } %77, { %int*, [1 x %int] }* %array
    store %int 0, %int* %index
    store %int 0, %int* %leftIndex
    store %int 0, %int* %rightIndex
    br label %_label73
_label72:
    %78 = load { %int*, [1 x %int] }* %left
    %79 = extractvalue { %int*, [1 x %int] } %78, 1, 0
    %80 = load %int* %leftIndex
    %81 = icmp ne %int %80, %79
    store %boolean %81, %boolean* %_temp1
    br %boolean %81, label %_label79, label %_label78
_label79:
    %82 = load { %int*, [1 x %int] }* %right
    %83 = extractvalue { %int*, [1 x %int] } %82, 1, 0
    %84 = load %int* %rightIndex
    %85 = icmp eq %int %84, %83
    store %boolean %85, %boolean* %_temp
    br %boolean %85, label %_label80, label %_label81
_label81:
    %86 = load { %int*, [1 x %int] }* %left
    %87 = load %int* %leftIndex
    %88 = extractvalue { %int*, [1 x %int] } %86, 0
    %89 = getelementptr inbounds %int* %88, %int %87
    %90 = load { %int*, [1 x %int] }* %right
    %91 = load %int* %rightIndex
    %92 = extractvalue { %int*, [1 x %int] } %90, 0
    %93 = getelementptr inbounds %int* %92, %int %91
    %94 = load %int* %89
    %95 = load %int* %93
    %96 = icmp slt %int %94, %95
    store %boolean %96, %boolean* %_temp
    br label %_label80
_label80:
    %97 = load %boolean* %_temp
    store %boolean %97, %boolean* %_temp1
    br label %_label78
_label78:
    %98 = load %boolean* %_temp1
    br %boolean %98, label %_label75, label %_label76
_label75:
    %99 = load { %int*, [1 x %int] }* %left
    %100 = load %int* %leftIndex
    %101 = extractvalue { %int*, [1 x %int] } %99, 0
    %102 = getelementptr inbounds %int* %101, %int %100
    %103 = load { %int*, [1 x %int] }* %array
    %104 = load %int* %index
    %105 = extractvalue { %int*, [1 x %int] } %103, 0
    %106 = getelementptr inbounds %int* %105, %int %104
    %107 = load %int* %102
    store %int %107, %int* %106
    %108 = load %int* %leftIndex
    %109 = add %int %108, 1
    store %int %109, %int* %leftIndex
    br label %_label77
_label76:
    %110 = load { %int*, [1 x %int] }* %right
    %111 = load %int* %rightIndex
    ...
    %119 = load %int* %rightIndex
    %120 = add %int %119, 1
    store %int %120, %int* %rightIndex
    br label %_label77
_label77:
    %121 = load %int* %index
    %122 = add %int %121, 1
    store %int %122, %int* %index
    br label %_label73
_label73:
    %123 = load { %int*, [1 x %int] }* %array
    %124 = extractvalue { %int*, [1 x %int] } %123, 1, 0
    %125 = load %int* %index
    %126 = icmp slt %int %125, %124
    br %boolean %126, label %_label72, label %_label74
_label74:
    br label %_label71
_label70:
    br label %_label71
_label71:
    %127 = load { %int*, [1 x %int] }* %array
    ret { %int*, [1 x %int] } %127
}

define %int @"_P_CSortTest_MgetMinimum"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    %3 = getelementptr inbounds %"_P_CSortTest"* %2, i32 0, i32 4
    %4 = load %int* %3
    ret %int %4
}

define void @"_P_CSortTest_MbucketSort"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    ...
    %10 = getelementptr %"_P_CSortTest"* %9, i32 0, i32 0
    %11 = load %"_P_CSortTest_Mclass"** %10
    %12 = getelementptr %"_P_CSortTest_Mclass"* %11, i32 0, i32 15
    %13 = load %int (%"_P_CSortTest"*)** %12
    %14 = call %int %13(%"_P_CSortTest"* %9)
    %15 = load %"_P_CSortTest"** %this
    %16 = getelementptr %"_P_CSortTest"* %15, i32 0, i32 0
    %17 = load %"_P_CSortTest_Mclass"** %16
    %18 = getelementptr %"_P_CSortTest_Mclass"* %17, i32 0, i32 14
    %19 = load %int (%"_P_CSortTest"*)** %18
    %20 = call %int %19(%"_P_CSortTest"* %15)
    %21 = load %"_P_CSortTest"** %this
    %22 = load { %int*, [1 x %int] }* %array
    %23 = getelementptr %"_P_CSortTest"* %21, i32 0, i32 0
    %24 = load %"_P_CSortTest_Mclass"** %23
    %25 = getelementptr %"_P_CSortTest_Mclass"* %24, i32 0, i32 8
    %26 = load void (%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int)** %25
    call void %26(%"_P_CSortTest"* %21, { %int*, [1 x %int] } %22, %int %14, %int %20)
    %27 = load %"_P_CSortTest"** %this
    %28 = load { %int*, [1 x %int] }* %array
    call void @"_P_CSortTest_Mstop_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_CString"(%"_P_CSortTest"* %27, { %int*, [1 x %int] } %28, %"_Pshadow_Pstandard_CString"* @_string8)
    ret void
}

define void @"_P_CSortTest_MbucketSort_Pshadow_Pstandard_Cint_A1_Pshadow_Pstandard_Cint_Pshadow_Pstandard_Cint"(%"_P_CSortTest"*, { %int*, [1 x %int] }, %int, %int) {
    %this = alloca %"_P_CSortTest"*
    %array = alloca { %int*, [1 x %int] }
    %min = alloca %int
    %max = alloca %int
...
define %double @"_P_CSortTest_MgetTime"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
...
_label91:
    ...
    %6 = getelementptr %"_Pshadow_Pstandard_CSystem"* %5, i32 0, i32 0
    %7 = load %"_Pshadow_Pstandard_CSystem_Mclass"** %6
    %8 = getelementptr %"_Pshadow_Pstandard_CSystem_Mclass"* %7, i32 0, i32 2
    %9 = load %"_Pshadow_Pstandard_CSystem"* (%"_Pshadow_Pstandard_CSystem"*)** %8
    %10 = call %"_Pshadow_Pstandard_CSystem"* %9(%"_Pshadow_Pstandard_CSystem"* %5)
    store %"_Pshadow_Pstandard_CSystem"* %10, %"_Pshadow_Pstandard_CSystem"** @"_Pshadow_Pstandard_CSystem_Minstance"
    br label %_label92
_label92:
    %11 = load %"_Pshadow_Pstandard_CSystem"** @"_Pshadow_Pstandard_CSystem_Minstance"
    %12 = call %ulong @"_Pshadow_Pstandard_CSystem_MnanoTime"(%"_Pshadow_Pstandard_CSystem"* %11)
    %13 = load %"_P_CSortTest"** %this
    %14 = getelementptr inbounds %"_P_CSortTest"* %13, i32 0, i32 2
    %15 = load %ulong* %14
    %16 = sub %ulong %12, %15
    %17 = uitofp %ulong %16 to %double
    %18 = fdiv %double %17, 1.0E9
    ret %double %18
}

define void @"_P_CSortTest_Mstart"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_Pshadow_Pstandard_CSystem"** @"_Pshadow_Pstandard_CSystem_Minstance"
    %3 = icmp eq %"_Pshadow_Pstandard_CSystem"* %2, null
...
_label94:
    ...
    %13 = load %"_P_CSortTest"** %this
    %14 = getelementptr inbounds %"_P_CSortTest"* %13, i32 0, i32 2
    store %ulong %12, %ulong* %14
    ret void
}

define %int @"_P_CSortTest_MgetArrayEnd"(%"_P_CSortTest"*) {
    %this = alloca %"_P_CSortTest"*
    store %"_P_CSortTest"* %0, %"_P_CSortTest"** %this
    %2 = load %"_P_CSortTest"** %this
    %3 = getelementptr inbounds %"_P_CSortTest"* %2, i32 0, i32 1
...
@_array0 = private unnamed_addr constant [16 x %ubyte] c"default@SortTest"
...
@_string1 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([4 x %ubyte]* @_array1, i32 0, i32 0), [1 x %int] [%int 4] }, %boolean true }
@_array2 = private unnamed_addr constant [3 x %ubyte] c":\09\09"
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([3 x %ubyte]* @_array2, i32 0, i32 0), [1 x %int] [%int 3] }, %boolean true }
@_array3 = private unnamed_addr constant [8 x %ubyte] c" seconds"
@_string3 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([8 x %ubyte]* @_array3, i32 0, i32 0), [1 x %int] [%int 8] }, %boolean true }
@_array4 = private unnamed_addr constant [15 x %ubyte] c"Array length:\09\09"
@_string4 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([15 x %ubyte]* @_array4, i32 0, i32 0), [1 x %int] [%int 15] }, %boolean true }
@_array5 = private unnamed_addr constant [9 x %ubyte] c"Quicksort"
@_string5 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([9 x %ubyte]* @_array5, i32 0, i32 0), [1 x %int] [%int 9] }, %boolean true }
@_array6 = private unnamed_addr constant [9 x %ubyte] c"Heap Sort"
@_string6 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([9 x %ubyte]* @_array6, i32 0, i32 0), [1 x %int] [%int 9] }, %boolean true }
@_array7 = private unnamed_addr constant [10 x %ubyte] c"Merge Sort"
@_string7 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([10 x %ubyte]* @_array7, i32 0, i32 0), [1 x %int] [%int 10] }, %boolean true }
@_array8 = private unnamed_addr constant [11 x %ubyte] c"Bucket Sort"
@_string8 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([11 x %ubyte]* @_array8, i32 0, i32 0), [1 x %int] [%int 11] }, %boolean true }
