...
define void @"_Pshadow_Ptest_CArrayTest_Mmain_Pshadow_Pstandard_CArray"(%"_Pshadow_Ptest_CArrayTest"*, %"_Pshadow_Pstandard_CArray"*) {
    ...
    %4 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %5 = bitcast %"_Pshadow_Pstandard_CObject"*%4 to %"_Pshadow_Pstandard_Cint"*
    %6 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%5, i32 0, i32 1
    store %int 0, %int* %6
    %7 = getelementptr %"_Pshadow_Pstandard_CArray"* %3, i32 0, i32 0
    %8 = load %"_Pshadow_Pstandard_CArray_Mclass"** %7
    %9 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %8, i32 0, i32 11
    %10 = load void (%"_Pshadow_Pstandard_CArray"*, %int, %"_Pshadow_Pstandard_CObject"*)** %9
    call void %10(%"_Pshadow_Pstandard_CArray"* %3, %int 0, %"_Pshadow_Pstandard_CObject"* %4)
    ret void
}
