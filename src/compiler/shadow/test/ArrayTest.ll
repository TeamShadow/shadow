...
%"_Pshadow_Ptest_CArrayTest_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Ptest_CArrayTest"* (%"_Pshadow_Ptest_CArrayTest"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, void (%"_Pshadow_Ptest_CArrayTest"*, %"_Pshadow_Pstandard_CArray"*)* }
...
define void @"_Pshadow_Ptest_CArrayTest_Mmain_Pshadow_Pstandard_CArray"(%"_Pshadow_Ptest_CArrayTest"*, %"_Pshadow_Pstandard_CArray"*) {
    ...
    %10 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %9, i32 0, i32 11
