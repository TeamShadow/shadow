...
%"_Pshadow_Ptest_CArrayTest_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Ptest_CArrayTest"* (%"_Pshadow_Ptest_CArrayTest"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, void (%"_Pshadow_Ptest_CArrayTest"*, %"_Pshadow_Pstandard_CArray"*)* }
...
@"_Pshadow_Ptest_CArrayTest_Mclass" = global %"_Pshadow_Ptest_CArrayTest_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } zeroinitializer, %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Ptest_CArrayTest"* getelementptr (%"_Pshadow_Ptest_CArrayTest"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Ptest_CArrayTest"** getelementptr (%"_Pshadow_Ptest_CArrayTest"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Ptest_CArrayTest"* (%"_Pshadow_Ptest_CArrayTest"*)* @"_Pshadow_Ptest_CArrayTest_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MreferenceEquals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", void (%"_Pshadow_Ptest_CArrayTest"*, %"_Pshadow_Pstandard_CArray"*)* @"_Pshadow_Ptest_CArrayTest_Mmain_Pshadow_Pstandard_CArray" }
...
define %"_Pshadow_Ptest_CArrayTest"* @"_Pshadow_Ptest_CArrayTest_Mcreate"(%"_Pshadow_Ptest_CArrayTest"*) {
    ...
    %2 = getelementptr inbounds %"_Pshadow_Ptest_CArrayTest"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CArrayTest_Mclass"* @"_Pshadow_Ptest_CArrayTest_Mclass", %"_Pshadow_Ptest_CArrayTest_Mclass"** %2
    store %"_Pshadow_Ptest_CArrayTest"* %0, %"_Pshadow_Ptest_CArrayTest"** %this
    ret %"_Pshadow_Ptest_CArrayTest"* %0
}

define void @"_Pshadow_Ptest_CArrayTest_Mmain_Pshadow_Pstandard_CArray"(%"_Pshadow_Ptest_CArrayTest"*, %"_Pshadow_Pstandard_CArray"*) {
    %this = alloca %"_Pshadow_Ptest_CArrayTest"*
    %array = alloca %"_Pshadow_Pstandard_CArray"*
    store %"_Pshadow_Ptest_CArrayTest"* %0, %"_Pshadow_Ptest_CArrayTest"** %this
    store %"_Pshadow_Pstandard_CArray"* %1, %"_Pshadow_Pstandard_CArray"** %array
    %3 = load %"_Pshadow_Pstandard_CArray"** %array
    %4 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", i32 0, i32 0))
    %5 = bitcast %"_Pshadow_Pstandard_CObject"*%4 to %"_Pshadow_Pstandard_Cint"*
    %6 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"*%5, i32 0, i32 0
    store %"_Pshadow_Pstandard_Cint_Mclass"* @"_Pshadow_Pstandard_Cint_Mclass", %"_Pshadow_Pstandard_Cint_Mclass"** %6
    %7 = getelementptr inbounds %"_Pshadow_Pstandard_Cint"* %5, i32 0, i32 1
    store %int 0, %int* %7
    %8 = getelementptr %"_Pshadow_Pstandard_CArray"* %3, i32 0, i32 0
    %9 = load %"_Pshadow_Pstandard_CArray_Mclass"** %8
    %10 = getelementptr %"_Pshadow_Pstandard_CArray_Mclass"* %9, i32 0, i32 12
    %11 = load void (%"_Pshadow_Pstandard_CArray"*, %int, %"_Pshadow_Pstandard_CObject"*)** %10
    call void %11(%"_Pshadow_Pstandard_CArray"* %3, %int 0, %"_Pshadow_Pstandard_CObject"* %4)
    ret void
}
