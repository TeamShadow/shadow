...
%"_Pshadow_Ptest_CExceptionC_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Ptest_CExceptionC"* (%"_Pshadow_Ptest_CExceptionC"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CException"* (%"_Pshadow_Pstandard_CException"*, %"_Pshadow_Pstandard_CString"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CException"*)*, void (%"_Pshadow_Pstandard_CException"*)* }
...
define %"_Pshadow_Ptest_CExceptionC"* @"_Pshadow_Ptest_CExceptionC_Mcreate"(%"_Pshadow_Ptest_CExceptionC"*) {
    %this = alloca %"_Pshadow_Ptest_CExceptionC"*
    store %"_Pshadow_Ptest_CExceptionC"* %0, %"_Pshadow_Ptest_CExceptionC"** %this
    %2 = load %"_Pshadow_Ptest_CExceptionC"** %this
    %3 = bitcast %"_Pshadow_Ptest_CExceptionC"* %2 to %"_Pshadow_Pstandard_CException"*
    %4 = call %"_Pshadow_Pstandard_CException"* @"_Pshadow_Pstandard_CException_Mcreate"(%"_Pshadow_Pstandard_CException"* %3)
    %5 = getelementptr inbounds %"_Pshadow_Ptest_CExceptionC"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CExceptionC_Mclass"* @"_Pshadow_Ptest_CExceptionC_Mclass", %"_Pshadow_Ptest_CExceptionC_Mclass"** %5
    ret %"_Pshadow_Ptest_CExceptionC"* %0
}
...
@_array0 = private unnamed_addr constant [22 x %ubyte] c"shadow.test@ExceptionC"
