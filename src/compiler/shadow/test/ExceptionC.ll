...
define %"_Pshadow_Ptest_CExceptionC"* @"_Pshadow_Ptest_CExceptionC_Mcreate"(%"_Pshadow_Ptest_CExceptionC"*) {
    ...
    %2 = getelementptr inbounds %"_Pshadow_Ptest_CExceptionC"* %0, i32 0, i32 0
    store %"_Pshadow_Ptest_CExceptionC_Mclass"* @"_Pshadow_Ptest_CExceptionC_Mclass", %"_Pshadow_Ptest_CExceptionC_Mclass"** %2
