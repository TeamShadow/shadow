...
define %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_MprintLine"(%"_Pshadow_Pio_CConsole"*) {
    ...
    %3 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_Mprint_Pshadow_Pstandard_CString"(%"_Pshadow_Pio_CConsole"* %2, %"_Pshadow_Pstandard_CString"* @_string1)
    ret %"_Pshadow_Pio_CConsole"* %3
}
...
_label0:
    ...
    br label %_label2
_label1:
    %6 = bitcast %"_Pshadow_Pstandard_CString"* @_string2 to %"_Pshadow_Pstandard_CObject"*
...
_label2:
    ...
    %13 = load %"_Pshadow_Pio_CConsole"** %this
    %14 = call %"_Pshadow_Pio_CConsole"* @"_Pshadow_Pio_CConsole_Mprint_Pshadow_Pstandard_CString"(%"_Pshadow_Pio_CConsole"* %13, %"_Pshadow_Pstandard_CString"* %12)
    ret %"_Pshadow_Pio_CConsole"* %14
}
...
@_array1 = private unnamed_addr constant [1 x %ubyte] c"\0a"
@_string1 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([1 x %ubyte]* @_array1, i32 0, i32 0), [1 x %int] [%int 1] } }
@_array2 = private unnamed_addr constant [4 x %ubyte] c"null"
@_string2 = private unnamed_addr constant %"_Pshadow_Pstandard_CString" { %"_Pshadow_Pstandard_CString_Mclass"* @"_Pshadow_Pstandard_CString_Mclass", { %ubyte*, [1 x %int] } { %ubyte* getelementptr inbounds ([4 x %ubyte]* @_array2, i32 0, i32 0), [1 x %int] [%int 4] } }
