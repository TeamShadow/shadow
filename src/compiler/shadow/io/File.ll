...
%"_Pshadow_Pio_CFile_Mclass" = type { %"_Pshadow_Pstandard_CClass", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)*, void (%"_Pshadow_Pio_CFile"*)*, %"_Pshadow_Pio_CFile"* (%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pstandard_CString"*)*, %"_Pshadow_Pio_CFile"* (%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pio_CPath"*)*, void (%"_Pshadow_Pio_CFile"*)*, %"_Pshadow_Pio_CPath"* (%"_Pshadow_Pio_CFile"*)*, %ulong (%"_Pshadow_Pio_CFile"*)*, void (%"_Pshadow_Pio_CFile"*, %ulong)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })*, %ulong (%"_Pshadow_Pio_CFile"*)*, void (%"_Pshadow_Pio_CFile"*, %ulong)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* }
...
%"_Pshadow_Pstandard_CException" = type { %"_Pshadow_Pstandard_CException_Mclass"*, %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pio_CPath"* }
%"_Pshadow_Pstandard_CCanHash_Mclass" = type { %int (%"_Pshadow_Pstandard_CObject"*)* }
%"_Pshadow_Pio_CInputStream_Mclass" = type { void (%"_Pshadow_Pstandard_CObject"*)*, %int (%"_Pshadow_Pstandard_CObject"*, { %byte*, [1 x %int] })* }
...
%"_Pshadow_Pio_CPath" = type { %"_Pshadow_Pio_CPath_Mclass"*, %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pio_CPath"* }
%"_Pshadow_Pio_COutputStream_Mclass" = type { void (%"_Pshadow_Pstandard_CObject"*)*, %int (%"_Pshadow_Pstandard_CObject"*, { %byte*, [1 x %int] })* }
...
%"_Pshadow_Pstandard_CObject" = type { %"_Pshadow_Pstandard_CObject_Mclass"*, %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pio_CPath"* }
...
%"_Pshadow_Pio_CCanClose_Mclass" = type { void (%"_Pshadow_Pstandard_CObject"*)* }
...
%"_Pshadow_Pstandard_CString_IStringIterator" = type { %"_Pshadow_Pstandard_CString_IStringIterator_Mclass"*, %"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pio_CPath"* }
...
@_class0 = private unnamed_addr constant { void (%"_Pshadow_Pio_CFile"*)* } { void (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mclose" }
@_class1 = private unnamed_addr constant { void (%"_Pshadow_Pio_CFile"*)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* } { void (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mclose", %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* @"_Pshadow_Pio_CFile_Mread_Pshadow_Pstandard_Cbyte_A1" }
@_class2 = private unnamed_addr constant { void (%"_Pshadow_Pio_CFile"*)* } { void (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mclose" }
@_class3 = private unnamed_addr constant { void (%"_Pshadow_Pio_CFile"*)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* } { void (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mclose", %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* @"_Pshadow_Pio_CFile_Mwrite_Pshadow_Pstandard_Cbyte_A1" }
@_interfaceData = private unnamed_addr constant [4 x %"_Pshadow_Pstandard_CObject"*] [%"_Pshadow_Pstandard_CObject"* bitcast ({ void (%"_Pshadow_Pio_CFile"*)* }* @_class0 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ void (%"_Pshadow_Pio_CFile"*)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* }* @_class1 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ void (%"_Pshadow_Pio_CFile"*)* }* @_class2 to %"_Pshadow_Pstandard_CObject"*), %"_Pshadow_Pstandard_CObject"* bitcast ({ void (%"_Pshadow_Pio_CFile"*)*, %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* }* @_class3 to %"_Pshadow_Pstandard_CObject"*)]
@_interfaces = private unnamed_addr constant [4 x %"_Pshadow_Pstandard_CClass"*] [%"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pio_CCanClose_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pio_CInputStream_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pio_CCanClose_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pio_COutputStream_Mclass"]
@"_Pshadow_Pio_CFile_Mclass" = constant %"_Pshadow_Pio_CFile_Mclass" { %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } { %"_Pshadow_Pstandard_CObject"** getelementptr inbounds ([4 x %"_Pshadow_Pstandard_CObject"*]* @_interfaceData, i32 0, i32 0), [1 x %int] [%int 4] }, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([4 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 4] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* getelementptr inbounds (%"_Pshadow_Pstandard_CObject_Mclass"* @"_Pshadow_Pstandard_CObject_Mclass", i32 0, i32 0), %int 0, %int ptrtoint (%"_Pshadow_Pio_CFile"* getelementptr (%"_Pshadow_Pio_CFile"* null, i32 1) to i32), %int ptrtoint (%"_Pshadow_Pio_CFile"** getelementptr (%"_Pshadow_Pio_CFile"** null, i32 1) to i32) }, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcopy", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mcreate", %boolean (%"_Pshadow_Pstandard_CObject"*, %"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mequals_Pshadow_Pstandard_CObject", %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_Mfreeze", %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MgetClass", %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CObject"*)* @"_Pshadow_Pstandard_CObject_MtoString", void (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mclose", %"_Pshadow_Pio_CFile"* (%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pstandard_CString"*)* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pstandard_CString", %"_Pshadow_Pio_CFile"* (%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pio_CPath"*)* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pio_CPath", void (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mdestroy", %"_Pshadow_Pio_CPath"* (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mpath", %ulong (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Mposition", void (%"_Pshadow_Pio_CFile"*, %ulong)* @"_Pshadow_Pio_CFile_Mposition_Pshadow_Pstandard_Culong", %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* @"_Pshadow_Pio_CFile_Mread_Pshadow_Pstandard_Cbyte_A1", %ulong (%"_Pshadow_Pio_CFile"*)* @"_Pshadow_Pio_CFile_Msize", void (%"_Pshadow_Pio_CFile"*, %ulong)* @"_Pshadow_Pio_CFile_Msize_Pshadow_Pstandard_Culong", %int (%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })* @"_Pshadow_Pio_CFile_Mwrite_Pshadow_Pstandard_Cbyte_A1" }
...
@"_Pshadow_Pio_CInputStream_Mclass" = external constant %"_Pshadow_Pstandard_CClass"
...
@"_Pshadow_Pio_CPath_Mclass" = external constant %"_Pshadow_Pio_CPath_Mclass"
@"_Pshadow_Pio_COutputStream_Mclass" = external constant %"_Pshadow_Pstandard_CClass"
...
@"_Pshadow_Pio_CCanClose_Mclass" = external constant %"_Pshadow_Pstandard_CClass"
...
declare %ulong @"_Pshadow_Pio_CFile_Mposition"(%"_Pshadow_Pio_CFile"*)

declare void @"_Pshadow_Pio_CFile_Mposition_Pshadow_Pstandard_Culong"(%"_Pshadow_Pio_CFile"*, %ulong)

define void @"_Pshadow_Pio_CFile_Mdestroy"(%"_Pshadow_Pio_CFile"*) {
    %this = alloca %"_Pshadow_Pio_CFile"*
    store %"_Pshadow_Pio_CFile"* %0, %"_Pshadow_Pio_CFile"** %this
    %2 = load %"_Pshadow_Pio_CFile"** %this
    %3 = getelementptr %"_Pshadow_Pio_CFile"* %2, i32 0, i32 0
    %4 = load %"_Pshadow_Pio_CFile_Mclass"** %3
    %5 = getelementptr %"_Pshadow_Pio_CFile_Mclass"* %4, i32 0, i32 7
    %6 = load void (%"_Pshadow_Pio_CFile"*)** %5
    %7 = load %"_Pshadow_Pio_CFile"** %this
    call void %6(%"_Pshadow_Pio_CFile"* %7)
    ret void
}

define %"_Pshadow_Pio_CPath"* @"_Pshadow_Pio_CFile_Mpath"(%"_Pshadow_Pio_CFile"*) {
    %this = alloca %"_Pshadow_Pio_CFile"*
    store %"_Pshadow_Pio_CFile"* %0, %"_Pshadow_Pio_CFile"** %this
    %2 = load %"_Pshadow_Pio_CFile"** %this
    %3 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %2, i32 0, i32 2
    %4 = load %"_Pshadow_Pio_CPath"** %3
    ret %"_Pshadow_Pio_CPath"* %4
}

declare %int @"_Pshadow_Pio_CFile_Mwrite_Pshadow_Pstandard_Cbyte_A1"(%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })

declare %int @"_Pshadow_Pio_CFile_Mread_Pshadow_Pstandard_Cbyte_A1"(%"_Pshadow_Pio_CFile"*, { %byte*, [1 x %int] })

define %"_Pshadow_Pio_CFile"* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pstandard_CObject"(%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pstandard_CObject"*) {
    %this = alloca %"_Pshadow_Pio_CFile"*
    %data = alloca %"_Pshadow_Pstandard_CObject"*
    store %"_Pshadow_Pio_CFile"* %0, %"_Pshadow_Pio_CFile"** %this
    store %"_Pshadow_Pstandard_CObject"* %1, %"_Pshadow_Pstandard_CObject"** %data
    %3 = load %"_Pshadow_Pio_CFile"** %this
    %4 = bitcast %"_Pshadow_Pio_CFile"* %3 to %"_Pshadow_Pstandard_CObject"*
    %5 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %4)
    %6 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %0, i32 0, i32 0
    store %"_Pshadow_Pio_CFile_Mclass"* @"_Pshadow_Pio_CFile_Mclass", %"_Pshadow_Pio_CFile_Mclass"** %6
    %7 = load %"_Pshadow_Pio_CFile"** %this
    %8 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %7, i32 0, i32 2
    %9 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pio_CPath_Mclass"* @"_Pshadow_Pio_CPath_Mclass", i32 0, i32 0))
    %10 = bitcast %"_Pshadow_Pstandard_CObject"* %9 to %"_Pshadow_Pio_CPath"*
    %11 = call %"_Pshadow_Pio_CPath"* @"_Pshadow_Pio_CPath_Mcreate"(%"_Pshadow_Pio_CPath"* %10)
    store %"_Pshadow_Pio_CPath"* %10, %"_Pshadow_Pio_CPath"** %8
    %12 = load %"_Pshadow_Pio_CFile"** %this
    %13 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %12, i32 0, i32 1
    store %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CObject"** %13
    %14 = load %"_Pshadow_Pio_CFile"** %this
    %15 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %14, i32 0, i32 1
    %16 = load %"_Pshadow_Pstandard_CObject"** %data
    store %"_Pshadow_Pstandard_CObject"* %16, %"_Pshadow_Pstandard_CObject"** %15
    ret %"_Pshadow_Pio_CFile"* %0
}

define %"_Pshadow_Pio_CFile"* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pstandard_CString"(%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pstandard_CString"*) {
    %this = alloca %"_Pshadow_Pio_CFile"*
    ...
    %13 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %12, i32 0, i32 1
    store %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CObject"** %13
    %14 = call noalias %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CClass_Mallocate"(%"_Pshadow_Pstandard_CClass"* getelementptr (%"_Pshadow_Pio_CPath_Mclass"* @"_Pshadow_Pio_CPath_Mclass", i32 0, i32 0))
    %15 = bitcast %"_Pshadow_Pstandard_CObject"* %14 to %"_Pshadow_Pio_CPath"*
    %16 = load %"_Pshadow_Pstandard_CString"** %path
    %17 = call %"_Pshadow_Pio_CPath"* @"_Pshadow_Pio_CPath_Mcreate_Pshadow_Pstandard_CString"(%"_Pshadow_Pio_CPath"* %15, %"_Pshadow_Pstandard_CString"* %16)
    %18 = load %"_Pshadow_Pio_CFile"** %this
    %19 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %18, i32 0, i32 2
    store %"_Pshadow_Pio_CPath"* %15, %"_Pshadow_Pio_CPath"** %19
    ret %"_Pshadow_Pio_CFile"* %0
}

define %"_Pshadow_Pio_CFile"* @"_Pshadow_Pio_CFile_Mcreate_Pshadow_Pio_CPath"(%"_Pshadow_Pio_CFile"*, %"_Pshadow_Pio_CPath"*) {
    %this = alloca %"_Pshadow_Pio_CFile"*
    %path = alloca %"_Pshadow_Pio_CPath"*
    store %"_Pshadow_Pio_CFile"* %0, %"_Pshadow_Pio_CFile"** %this
    store %"_Pshadow_Pio_CPath"* %1, %"_Pshadow_Pio_CPath"** %path
    %3 = load %"_Pshadow_Pio_CFile"** %this
    %4 = bitcast %"_Pshadow_Pio_CFile"* %3 to %"_Pshadow_Pstandard_CObject"*
    %5 = call %"_Pshadow_Pstandard_CObject"* @"_Pshadow_Pstandard_CObject_Mcreate"(%"_Pshadow_Pstandard_CObject"* %4)
    %6 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %0, i32 0, i32 0
    ...
    store %"_Pshadow_Pstandard_CObject"* null, %"_Pshadow_Pstandard_CObject"** %13
    %14 = load %"_Pshadow_Pio_CFile"** %this
    %15 = getelementptr inbounds %"_Pshadow_Pio_CFile"* %14, i32 0, i32 2
    %16 = load %"_Pshadow_Pio_CPath"** %path
    store %"_Pshadow_Pio_CPath"* %16, %"_Pshadow_Pio_CPath"** %15
    ret %"_Pshadow_Pio_CFile"* %0
}

declare void @"_Pshadow_Pio_CFile_Mclose"(%"_Pshadow_Pio_CFile"*)

declare %ulong @"_Pshadow_Pio_CFile_Msize"(%"_Pshadow_Pio_CFile"*)

declare void @"_Pshadow_Pio_CFile_Msize_Pshadow_Pstandard_Culong"(%"_Pshadow_Pio_CFile"*, %ulong)
...
declare %"_Pshadow_Pstandard_CString"* @"_Pshadow_Pio_CPath_MtoString"(%"_Pshadow_Pio_CPath"*)
declare %"_Pshadow_Pio_CPath"* @"_Pshadow_Pio_CPath_Mcreate"(%"_Pshadow_Pio_CPath"*)
declare %"_Pshadow_Pio_CPath"* @"_Pshadow_Pio_CPath_Mcreate_Pshadow_Pstandard_CString"(%"_Pshadow_Pio_CPath"*, %"_Pshadow_Pstandard_CString"*)
...
@_array0 = private unnamed_addr constant [14 x %ubyte] c"shadow.io@File"
