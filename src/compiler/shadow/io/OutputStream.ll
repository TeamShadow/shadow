...
@_interfaces = private unnamed_addr constant [2 x %"_Pshadow_Pstandard_CClass"*] [%"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pio_CCanClose_Mclass", %"_Pshadow_Pstandard_CClass"* @"_Pshadow_Pio_COutputStream_Mclass"]
@"_Pshadow_Pio_COutputStream_Mclass" = constant %"_Pshadow_Pstandard_CClass" { %"_Pshadow_Pstandard_CClass_Mclass"* @"_Pshadow_Pstandard_CClass_Mclass", { %"_Pshadow_Pstandard_CObject"**, [1 x %int] } zeroinitializer, { %"_Pshadow_Pstandard_CClass"**, [1 x %int] } { %"_Pshadow_Pstandard_CClass"** getelementptr inbounds ([2 x %"_Pshadow_Pstandard_CClass"*]* @_interfaces, i32 0, i32 0), [1 x %int] [%int 2] }, %"_Pshadow_Pstandard_CString"* @_string0, %"_Pshadow_Pstandard_CClass"* null, %int 1, %int -1, %int ptrtoint ({ %"_Pshadow_Pio_COutputStream_Mclass"*, %"_Pshadow_Pstandard_CObject"* }* getelementptr ({ %"_Pshadow_Pio_COutputStream_Mclass"*, %"_Pshadow_Pstandard_CObject"* }* null, i32 1) to i32) }
...
@_array0 = private unnamed_addr constant [22 x %ubyte] c"shadow.io@OutputStream"
