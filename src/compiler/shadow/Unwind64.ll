...
%"_Pshadow_Pstandard_COutOfMemoryException_methods" = type { %"_Pshadow_Pstandard_CException_methods"*, %"_Pshadow_Pstandard_CObject"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CClass"* (%"_Pshadow_Pstandard_CObject"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CException"*)*, %"_Pshadow_Pstandard_CString"* (%"_Pshadow_Pstandard_CException"*)* }
...
aligned:
	...
	%p.up = add i64 %p.int, sub (i64 ptrtoint (i1** getelementptr (i1** null, i32 1) to i64), i64 1)
	%p.round = and i64 %p.up, sub (i64 0, i64 ptrtoint (i1** getelementptr (i1** null, i32 1) to i64))
...
ttype.read:
	...
	%ttype.offset = load %_Unwind_Word* %temp, align 4
	%ttype.int_offset = ptrtoint %_Unwind_Word %ttype.offset to i64
	%ttype.value = getelementptr i8* %p.4, i64 %ttype.int_offset
	br label %ttype.done
ttype.done:
	...
	%action_table.offset = load %_Unwind_Word* %temp, align 4
	%action_table.int_offset = ptrtoint %_Unwind_Word %action_table.offset to i64
	%action_table.base = getelementptr i8* %p.7, i64 %action_table.int_offset
...
find.action.loop:
	...
	%action_record.offset = load %_Unwind_Word* %temp, align 4
	%code_section.start.int_offset = ptrtoint %_Unwind_Ptr %code_section.start.offset to i64
	%code_section.start = getelementptr %_Unwind_Ptr %start, i64 %code_section.start.int_offset
...
find.action.check:
	...
	%code_section.end = getelementptr %_Unwind_Ptr %code_section.start, i64 %code_section.end.int_offset
...
landing_pad.valid:
	...
	%landing_pad = getelementptr %_Unwind_Ptr %landing_pad.start, i64 %landing_pad.int_offset
...
action_record.valid:
	...
	%action_record = getelementptr i8* %action_table, i64 %action_record.int_offset
...
thrown.class.get:
	...
	%thrown.class.value = load %_Pshadow_Pstandard_CClass** %thrown.class.pointer
...
find.catch:
	...
	%filter.value = load %_Unwind_Sword* %temp, align 4
...
find.catch.next:
	...
	%action_record.next = load %_Unwind_Sword* %temp, align 4
...
entry:
	%1 = tail call noalias i8* @malloc(i64 add (i64 ptrtoint (%struct._Unwind_Exception* getelementptr (%struct._Unwind_Exception* null, i64 1) to i64), i64 ptrtoint (i1** getelementptr (i1** null, i64 1) to i64))) nounwind
	...
	%4 = getelementptr %struct._Unwind_Exception* %2, i64 0, i32 0
	store %_Unwind_Exception_Class %3, %_Unwind_Exception_Class* %4
	%5 = getelementptr %struct._Unwind_Exception* %2, i64 0, i32 1
	store %_Unwind_Exception_Cleanup_Fn @shadow.exception.cleanup, %_Unwind_Exception_Cleanup_Fn* %5
	%6 = getelementptr %struct._Unwind_Exception* %2, i64 1
