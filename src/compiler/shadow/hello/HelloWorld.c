...
struct _Pshadow_Pstandard_CObject *_Pshadow_Phello_CHelloWorld_MgetSelfObject(struct _Pshadow_Phello_CHelloWorld *this) {
	...
	_Itemp0 = (struct _Pshadow_Pstandard_CObject *)this->self;
	return _Itemp0;
}
...
void _Pshadow_Phello_CHelloWorld_Mmain_R_Pshadow_Pstandard_CString_A1(struct _Pshadow_Pstandard_CArray *args) {
	...
	struct _Pshadow_Pstandard_CObject *_Itemp30;
	boolean_shadow_t _Itemp31;
	struct _Pshadow_Pstandard_CObject *_Itemp32;
	...
	struct _Pshadow_Pstandard_CObject *_Itemp39;
	struct _Pshadow_Pstandard_CString *_Itemp40;
	struct _Pshadow_Pstandard_CString *_Itemp41;
	struct _Pshadow_Pstandard_CString *_Itemp42;
	struct _Pshadow_Pstandard_CString *_Itemp43;
	struct _Pshadow_Pstandard_CObject *_Itemp44;
	struct _Pshadow_Pstandard_CString *_Itemp45;
	struct _Pshadow_Pstandard_CObject *_Itemp46;
	struct _Pshadow_Pstandard_CString *_Itemp47;
	boolean_shadow_t _Itemp48;
	struct _Pshadow_Pstandard_CObject *_Itemp49;
	struct _Pshadow_Pstandard_CString *_Itemp50;
	boolean_shadow_t _Itemp51;
	boolean_shadow_t _Itemp52;
	struct _Pshadow_Pstandard_CObject *_Itemp53;
	struct _Pshadow_Pstandard_CString *_Itemp54;
...
label6: (void)0;
	...
	_Itemp21 = malloc(sizeof(struct _Pshadow_Phello_CHelloWorld));
	_Pshadow_Phello_CHelloWorld_Mconstructor_Ruint(_Itemp21, ((uint_shadow_t)10));
	hello2 = _Itemp21;
	...
	_Pshadow_Phello_CHelloWorld_Mconstructor_R_Pshadow_Pstandard_CString(_Itemp22, &_Istring21);
	hello3 = _Itemp22;
	...
	_Pshadow_Phello_CHelloWorld_Mconstructor_Ruint_R_Pshadow_Pstandard_CString(_Itemp23, ((uint_shadow_t)15), &_Istring22);
	hello4 = _Itemp23;
	hello1->_Imethods->_Mdoit(hello1);
	_Itemp24 = hello2->self != ((void *)0);
	if ( _Itemp24 )
		goto label7;
	else
		goto label22;
label7: (void)0;
	...
	_Itemp25 = hello3->self != ((void *)0);
	if ( _Itemp25 )
		goto label8;
	else
		goto label22;
label8: (void)0;
	_Itemp26 = hello3->self->self != ((void *)0);
	if ( _Itemp26 )
		goto label9;
	else
		goto label22;
label9: (void)0;
	...
	_Itemp27 = hello4->self != ((void *)0);
	if ( _Itemp27 )
		goto label10;
	else
		goto label22;
label10: (void)0;
	_Itemp28 = hello4->self->self != ((void *)0);
	if ( _Itemp28 )
		goto label11;
	else
		goto label22;
label11: (void)0;
	_Itemp29 = hello4->self->self->self != ((void *)0);
	if ( _Itemp29 )
		goto label12;
	else
		goto label22;
label12: (void)0;
	...
	_Itemp30 = (struct _Pshadow_Pstandard_CObject *)hello1;
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CObject(_Itemp30);
	_Itemp31 = hello2->self != ((void *)0);
	if ( _Itemp31 )
		goto label13;
	else
		goto label22;
label13: (void)0;
	_Itemp32 = (struct _Pshadow_Pstandard_CObject *)hello2->self;
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CObject(_Itemp32);
	_Itemp33 = hello3->self != ((void *)0);
	if ( _Itemp33 )
		goto label14;
	else
		goto label22;
label14: (void)0;
	_Itemp34 = hello3->self->self != ((void *)0);
	if ( _Itemp34 )
		goto label15;
	else
		goto label22;
label15: (void)0;
	_Itemp35 = (struct _Pshadow_Pstandard_CObject *)hello3->self->self;
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CObject(_Itemp35);
	_Itemp36 = hello4->self != ((void *)0);
	if ( _Itemp36 )
		goto label16;
	else
		goto label22;
label16: (void)0;
	_Itemp37 = hello4->self->self != ((void *)0);
	if ( _Itemp37 )
		goto label17;
	else
		goto label22;
label17: (void)0;
	_Itemp38 = hello4->self->self->self != ((void *)0);
	if ( _Itemp38 )
		goto label18;
	else
		goto label22;
label18: (void)0;
	_Itemp39 = (struct _Pshadow_Pstandard_CObject *)hello4->self->self->self;
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CObject(_Itemp39);
	_Pshadow_Pio_CConsole_MprintLine();
	_Itemp40 = hello1->_Imethods->_MgetMessage(hello1);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp40);
	_Itemp41 = hello2->_Imethods->_MgetMessage(hello2);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp41);
	_Itemp42 = hello3->_Imethods->_MgetMessage(hello3);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp42);
	_Itemp43 = hello4->_Imethods->_MgetMessage(hello4);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp43);
	_Pshadow_Pio_CConsole_MprintLine();
	_Itemp44 = (struct _Pshadow_Pstandard_CObject *)hello1;
	_Itemp45 = _Itemp44->_Imethods->_MtoString(_Itemp44);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp45);
	_Itemp46 = (struct _Pshadow_Pstandard_CObject *)hello2;
	_Itemp47 = _Itemp46->_Imethods->_MtoString(_Itemp46);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp47);
	_Itemp48 = hello3->self != ((void *)0);
	if ( _Itemp48 )
		goto label19;
	else
		goto label22;
label19: (void)0;
	_Itemp49 = (struct _Pshadow_Pstandard_CObject *)hello3->self;
	_Itemp50 = _Itemp49->_Imethods->_MtoString(_Itemp49);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp50);
	_Itemp51 = hello4->self != ((void *)0);
	if ( _Itemp51 )
		goto label20;
	else
		goto label22;
label20: (void)0;
	_Itemp52 = hello4->self->self != ((void *)0);
	if ( _Itemp52 )
		goto label21;
	else
		goto label22;
label21: (void)0;
	_Itemp53 = (struct _Pshadow_Pstandard_CObject *)hello4->self->self;
	_Itemp54 = _Itemp53->_Imethods->_MtoString(_Itemp53);
	_Pshadow_Pio_CConsole_MprintLine_R_Pshadow_Pstandard_CString(_Itemp54);
	_Pshadow_Pio_CConsole_MprintLine();
	goto label23;
label22: (void)0;
