...
static struct _Pshadow_Pstandard_CArray _Iarray0 = {
	&_Pshadow_Pstandard_CArray_Imethods, (void *)"shadow.hello@OldHelloWorld", (int_shadow_t)1, {(int_shadow_t)26}
};
...
void _Pshadow_Phello_COldHelloWorld_Mmain_R_Pshadow_Pstandard_CString_A1(struct _Pshadow_Pstandard_CArray * args) {
...
void _Pshadow_Phello_COldHelloWorld_Mconstructor(struct _Pshadow_Phello_COldHelloWorld * this) {
	...
	static struct _Pshadow_Pstandard_CArray _Iarray3 = {
		&_Pshadow_Pstandard_CArray_Imethods, (void *)"object Hello World initialized with no arguments.", (int_shadow_t)1, {(int_shadow_t)49}
	};
...
void _Pshadow_Phello_COldHelloWorld_Mconstructor_Rint(struct _Pshadow_Phello_COldHelloWorld * this, int_shadow_t  a) {
	...
	static struct _Pshadow_Pstandard_CArray _Iarray4 = {
		&_Pshadow_Pstandard_CArray_Imethods, (void *)"object Hello World initialized with one argument: ", (int_shadow_t)1, {(int_shadow_t)50}
	};
	...
	static struct _Pshadow_Pstandard_CArray _Iarray5 = {
		&_Pshadow_Pstandard_CArray_Imethods, (void *)".", (int_shadow_t)1, {(int_shadow_t)1}
	};
...
void _Pshadow_Phello_COldHelloWorld_Mconstructor_Rint_Rint(struct _Pshadow_Phello_COldHelloWorld * this, int_shadow_t  a, int_shadow_t  b) {
	...
	static struct _Pshadow_Pstandard_CArray _Iarray6 = {
		&_Pshadow_Pstandard_CArray_Imethods, (void *)"object Hello World initialized with two arguments: ", (int_shadow_t)1, {(int_shadow_t)51}
	};
	...
	static struct _Pshadow_Pstandard_CArray _Iarray7 = {
		&_Pshadow_Pstandard_CArray_Imethods, (void *)" and ", (int_shadow_t)1, {(int_shadow_t)5}
	};
