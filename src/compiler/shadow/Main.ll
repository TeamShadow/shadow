...
define i32 @main(i32, i8**) {
	...
	%28 = invoke i32 @_Pshadow_Ptest_CTest_Mmain_Pshadow_Pstandard_CString_A1(%_Pshadow_Ptest_CTest* %25, { %_Pshadow_Pstandard_CString**, [1 x i32] } %27)
			to label %29 unwind label %30
	ret i32 0
	%31 = landingpad { i8*, i32 } personality i32 (...)* @__shadow_personality_v0
            catch %"_Pshadow_Pstandard_CClass"* @_Pshadow_Pstandard_CException_class
	%32 = extractvalue { i8*, i32 } %31, 0
	%33 = call %_Pshadow_Pstandard_CException* @__shadow_catch(i8* nocapture %32) nounwind
	%34 = load %_Pshadow_Pio_CConsole** @_Pshadow_Pio_CConsole_instance
	%35 = icmp eq %_Pshadow_Pio_CConsole* %34, null
	br i1 %35, label %36, label %41
	%37 = call noalias %_Pshadow_Pstandard_CObject* @_Pshadow_Pstandard_CClass_Mallocate(%_Pshadow_Pstandard_CClass* @_Pshadow_Pio_CConsole_class)
	%38 = getelementptr inbounds %_Pshadow_Pstandard_CObject* %37, i32 0, i32 0
	store %_Pshadow_Pstandard_CClass* @_Pshadow_Pio_CConsole_class, %_Pshadow_Pstandard_CClass** %38
	%39 = getelementptr inbounds %_Pshadow_Pstandard_CObject* %37, i32 0, i32 1
	store %_Pshadow_Pstandard_CObject_methods* bitcast(%_Pshadow_Pio_CConsole_methods* @_Pshadow_Pio_CConsole_methods to %_Pshadow_Pstandard_CObject_methods*), %_Pshadow_Pstandard_CObject_methods** %39
	%40 = call %_Pshadow_Pio_CConsole* @_Pshadow_Pio_CConsole_Mcreate(%_Pshadow_Pstandard_CObject* %37)
	store %_Pshadow_Pio_CConsole* %40, %_Pshadow_Pio_CConsole** @_Pshadow_Pio_CConsole_instance
	br label %41
	%42 = load %"_Pshadow_Pio_CConsole"** @"_Pshadow_Pio_CConsole_instance"
	%43 = bitcast %_Pshadow_Pstandard_CException* %33 to %_Pshadow_Pstandard_CObject*	
	%44 = call %_Pshadow_Pio_CConsole* @_Pshadow_Pio_CConsole_MprintErrorLine_Pshadow_Pstandard_CObject(%_Pshadow_Pio_CConsole* %42, %_Pshadow_Pstandard_CObject* %43 )
	ret i32 1
}