...
%_Pshadow_Ptest_CExceptionTest = type opaque
%_Pshadow_Ptest_CExceptionTest_Mclass = type { %_Pshadow_Pstandard_CClass }
@_Pshadow_Ptest_CExceptionTest_Mclass = external constant %_Pshadow_Ptest_CExceptionTest_Mclass
declare %_Pshadow_Ptest_CExceptionTest* @_Pshadow_Ptest_CExceptionTest_Mcreate(%_Pshadow_Ptest_CExceptionTest*)
declare i32 @_Pshadow_Ptest_CExceptionTest_Mmain_Pshadow_Pstandard_CString_A1(%_Pshadow_Ptest_CExceptionTest*, { %_Pshadow_Pstandard_CString**, [1 x i32] })
...
define i32 @main(i32, i8**) {
	...
	%20 = call %_Pshadow_Pstandard_CObject* @_Pshadow_Pstandard_CClass_Mallocate(%_Pshadow_Pstandard_CClass* getelementptr inbounds (%_Pshadow_Ptest_CExceptionTest_Mclass* @_Pshadow_Ptest_CExceptionTest_Mclass, i32 0, i32 0))
	%21 = bitcast %_Pshadow_Pstandard_CObject* %20 to %_Pshadow_Ptest_CExceptionTest*
	%22 = call %_Pshadow_Ptest_CExceptionTest* @_Pshadow_Ptest_CExceptionTest_Mcreate(%_Pshadow_Ptest_CExceptionTest* %21)
	...
	%25 = tail call i32 @_Pshadow_Ptest_CExceptionTest_Mmain_Pshadow_Pstandard_CString_A1(%_Pshadow_Ptest_CExceptionTest* %22, { %_Pshadow_Pstandard_CString**, [1 x i32] } %24)
	ret i32 %25
}
